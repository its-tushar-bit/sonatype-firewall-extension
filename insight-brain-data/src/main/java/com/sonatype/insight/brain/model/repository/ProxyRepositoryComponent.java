...
/**
 * Firewall's proxy-repo component persistence (quarantine lifecycle). Not written by hosted-repo
 * scanning; see {@code HostedRepositoryComponent} for hosted-repo artifacts.
 *
 * @since 1.17
 */
@Entity
@Table(name = "proxy_repository_component")
public class ProxyRepositoryComponent
    extends HasComponentId
    implements HasStringId, RepositoryComponent
{
  @Id
  ...
  public String toString() {
    return "ProxyRepositoryComponent [id=" + id + ", repositoryId=" + repositoryId + ", time=" + time + ", hash=" + hash
