...
/**
 * Kept in the {@code com.sonatype.insight.brain.security} package because {@link CurrentUser#XFF_HEADER} is
 * package-private.
 */
@IqH2Test
class IqH2ClientIPAddressFilterTest
{
  ...
  private final TestLogOutput logOutput = new TestLogOutput(ClientIPAddressFilter.class);
  ...
  private com.sonatype.insight.brain.HttpRequest restRequest() {
    return ctx.restRequest().path(REST_PATH).anon();
  }

  @Test
  void testClientIPAddressFilter_AccessAllowedWhenListIsNull() throws Exception {
  ...
  @Test
  void testClientIPAddressFilter_AccessAllowedWhenListIsEmpty() throws Exception {
  ...
  @Test
  void testClientIPAddressFilter_AccessIsAllowedWhenIPv4IsInXFFHeader() throws Exception {
  ...
  @Test
  void testClientIPAddressFilter_AccessIsDeniedWhenIPv4IsNotMatched() throws Exception {
    setAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_AccessIsAllowedWhenIPv6IsInXFFHeader() throws Exception {
    setAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_AccessIsAllowedWhenIPv6LiteralIsInXFFHeader() throws Exception {
    setAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_AccessIsDeniedWhenIPv6IsNotMatched() throws Exception {
    setAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_AccessIsAllowedWhenIPv4IsInRange() throws Exception {
    setAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_AccessIsDeniedWhenIPv4IsNotInRange() throws Exception {
    setAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_AccessIsAllowedWhenIPv6IsInRange() throws Exception {
    setAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_AccessIsDeniedWhenIPv6IsNotInRange() throws Exception {
    setAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_AccessIsAllowedWhenIPIsMatchedInSystemAllowlist() throws Exception {
    setAllowlist(null);
  ...
  @Test
  void testClientIPAddressFilter_AccessIsDeniedWhenIPIsNotMatchedInSystemAllowlist() throws Exception {
    setAllowlist(null);
    setSystemAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_AccessIsAllowedFromLocalhost() throws Exception {
    setAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_AccessIsAllowedWithRemoteAddrIPv4() throws Exception {
    setAllowlist(getTestAccessAllowlist());
    ...
    ctx.lookup(ClientIPAddressFilter.class)
  ...
  @Test
  void testClientIPAddressFilter_AccessIsDeniedWithRemoteAddrIPv4() throws Exception {
    setAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_AccessIsAllowedWithRemoteAddrIPv6() throws Exception {
    setAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_AccessIsDeniedWithRemoteAddrIPv6() throws Exception {
    setAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_AccessIsAllowedWithoutLicensedFeatureIP_ALLOWLIST() throws Exception {
    // Remove the PRODUCT_LIFECYCLE_CLOUD feature flag LicensedFeature.IP_ALLOWLIST
    ctx.setFeatures(LicensedFeature.DASHBOARD);
    setSystemAllowlist(getTestAccessAllowlist());
  ...
  @Test
  void testClientIPAddressFilter_FilterHandlesInvalidIPsInAllowlist() throws Exception {
    setAllowlist(getTestAccessAllowlist());
  ...
  private void setAccessAllowlist(List<Map<String, String>> allowList) {
  ...
  private void setSystemAllowlist(List<AllowedIp> allowlist) {
    ctx.lookup(InsightConfig.class).setSystemAllowlist(allowlist);
  }
  ...
  private void assertAccessIsAllowed(HttpResponse response) {
    ...
    ctx.assertResponseStatus(HttpServletResponse.SC_NOT_FOUND, response);
  }
