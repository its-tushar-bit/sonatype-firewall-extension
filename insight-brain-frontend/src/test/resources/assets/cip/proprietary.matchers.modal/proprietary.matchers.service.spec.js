describe('proprietary.matchers.service.spec', function() {
  ...
  describe('addComponentMatchers()', function() {
    ...
    it('returns response json', function() {
      ...
      proprietaryMatchersService.addComponentMatchers('testApp123', ['foo', 'bar'], '(testRegex)').then(function(config) {
    ...
    it('rejects with error message in case of failure', function() {
      ...
      proprietaryMatchersService.addComponentMatchers('testApp123', ['foo', 'bar'], '(testRegex)').catch(function(message) {
        result = message;
      });
      $httpBackend.flush();
