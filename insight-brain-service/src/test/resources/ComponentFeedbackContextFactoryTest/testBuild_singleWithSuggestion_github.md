...
**Bumping to version 2.15.0** will resolve all policy violations for this component (as of _Jul 05, 2023_)
...
| --- | --- | --- |
| Threat level: 7<br>CVSS Score: 6.7<br><img title="Sonatype Deep Dive" alt="Sonatype Deep Dive" src="https://cdn.sonatype.com/iq-for-scm/1.0/DeepDive.svg" /> | [SONATYPE-123-01] The is a description of SONATYPE-123-01 | [View Details](https://iq.example.com/assets/index.html#/violation/pv1?type=violation&sidebarReference=filter) |
| Threat level: 7<br>CVSS Score: 5.6<br><img title="Sonatype Fast Track" alt="Sonatype Fast Track" src="https://cdn.sonatype.com/iq-for-scm/1.0/FastTrack.svg" /> | [CVE-123-01] The is a description of CVE-123-01 | [View Details](https://iq.example.com/assets/index.html#/violation/pv1?type=violation&sidebarReference=filter) |
