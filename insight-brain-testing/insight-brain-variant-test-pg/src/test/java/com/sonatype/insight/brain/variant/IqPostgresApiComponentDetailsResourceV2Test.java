...
/**
 * IQ Server on PostgreSQL — {@code POST} component-details evaluation, converted from
 * {@code ApiComponentDetailsResourceV2Test}.
 */
@IqPostgresTest
class IqPostgresApiComponentDetailsResourceV2Test
{
  ...
  @Test
  void testGetComponentDetails_Purl() throws Exception {
      ...
      final String expectedPackageUrl) throws Exception
  {
    ...
    HttpResponse response = ctx.restRequest().path(PublicApiPaths.COMPONENT_DETAILS_PATH_V2).body(request).post();
