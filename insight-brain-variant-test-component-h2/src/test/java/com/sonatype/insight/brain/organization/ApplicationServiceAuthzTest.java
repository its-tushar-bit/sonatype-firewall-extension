    ...
    extends AbstractComponentH2AuthzTest
{
  ...
  public void testAddApplication_Unauthenticated() {
    ...
    assertThrows(UnauthenticatedException.class, () -> applicationService.addApplication(application));
  }

  @Test
  public void testAddApplication_Unauthorized() {
    grantWritePermission(app.getId());
    assertThrows(UnauthorizedException.class, () -> applicationService.addApplication(new Application()));
  }
  ...
  public void testValidateApplicationPublicId_Unauthorized() {
    login();
    assertThrows(UnauthorizedException.class, () -> applicationService.validateApplicationPublicId(app.getPublicId()));
  }
  ...
  public void testUpdateApplication_Unauthenticated() {
    ...
    assertThrows(UnauthenticatedException.class, () -> applicationService.updateApplication(app));
  }
