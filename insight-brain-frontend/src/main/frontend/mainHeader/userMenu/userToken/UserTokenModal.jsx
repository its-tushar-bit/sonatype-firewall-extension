...
export default function UserTokenModal(props) {
  ...
  const showPrimaryAction = typeof userToken === 'boolean' &&
      !checkUserTokenLoading && !generateUserTokenLoading && !deleteUserTokenLoading &&
      !checkUserTokenError && !generateUserTokenError && !deleteUserTokenError;
    ...
    <NxModal variant="narrow"
      ...
      <div className="nx-modal-content">
        ...
        { (generateUserTokenLoading != null) &&
          <NxSubmitMask message="Generating…" success={generateUserTokenLoading} />
        }
        <LoadWrapper loading={checkUserTokenLoading}
          ...
          <p className="iq-user-token-modal__info-paragraph">
            ...
            user token and create a new one. To learn more about User Tokens please see the{' '}
          ...
          { userToken === true &&
            <NxWarningAlert id="user-token-modal-token-exists-alert">
              A user token already exists for this user.<br />
