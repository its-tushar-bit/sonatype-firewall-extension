...
export default {
  getConditionValueTypeUrl: function() {
    return [
      ...
      {'id': 'CoordinatesValueType', 'dataType': 'String', 'availableValues': null, 'allowMultiple': false},
      {'id': 'FloatValueType', 'dataType': 'Float', 'availableValues': null, 'allowMultiple': false},
      {'id': 'IntegerValueType', 'dataType': 'Integer', 'availableValues': null, 'allowMultiple': false}, {
        'id': 'IdentificationSourceValueType',
        'dataType': 'IdentificationSource',
        'availableValues': [{'id': 'Sonatype', 'name': 'Sonatype'}, {'id': 'Manual', 'name': 'Manual'}],
        'allowMultiple': false
      }, {
        'id': 'LabelValueType',
        'dataType': 'Label',
        ...
        'availableValues': [
          {'id': 'OPEN', 'name': 'Open'}, {'id': 'ACKNOWLEDGED', 'name': 'Acknowledged'},
          {'id': 'OVERRIDDEN', 'name': 'Overridden'}, {'id': 'SELECTED', 'name': 'Selected'},
        ...
        'dataType': 'MatchState',
        'availableValues': [
          {'id': 'exact', 'name': 'Exact'}, {'id': 'similar', 'name': 'Similar'}, {'id': 'unknown', 'name': 'Unknown'}
        ],
        'allowMultiple': false
      }, {'id': 'PercentageValueType', 'dataType': 'Integer', 'availableValues': null, 'allowMultiple': false}, {
        'id': 'SecurityVulnerabilityStatusValueType',
        'dataType': 'SecurityVulnerabilityStatus',
        'availableValues': [
          {'id': 'OPEN', 'name': 'Open'}, {'id': 'ACKNOWLEDGED', 'name': 'Acknowledged'},
          {'id': 'NOT_APPLICABLE', 'name': 'Not Applicable'}, {'id': 'CONFIRMED', 'name': 'Confirmed'}
        ],
        'allowMultiple': false
      }
    ];
