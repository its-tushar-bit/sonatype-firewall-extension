...
(function() {
  ...
  function applicationRiskTable($scope, $filter) {
    ...
    $scope.$watch(function() {
      return $scope.sortVm.sortFields[0];
    }, updateApplications);
  ...
  applicationRiskTable.$inject = ['$scope', '$filter'];

  angular //
      .module('dashboard.utils') //
      .controller('application.risk.table', applicationRiskTable);
