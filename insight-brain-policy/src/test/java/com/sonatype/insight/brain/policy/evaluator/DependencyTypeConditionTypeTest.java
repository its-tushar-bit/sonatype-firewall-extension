    ...
    extends AbstractPolicyEvaluationTest
{
  ...
  public void testEvaluateIs() {
    ...
    assertContainsPolicyAlert(component1, policy, constraint, FailActionType.ID, DependencyTypeConditionType.ID,
        policyAlerts);
    ...
    assertThat(actualReason).isEqualTo("Dependency type was Direct");
  }
  ...
  public void testEvaluateIsNot() {
    ...
    String actualReason = policyAlerts.get(0).getTrigger().getComponentFacts().get(0).getConstraintFacts().get(0)
        .getConditionFacts().get(0).getReason();
    assertThat(actualReason).isEqualTo("Dependency type was Direct, not Transitive");
  }
