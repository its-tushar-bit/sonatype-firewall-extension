...
export const SYSTEM_NOTICE_CONFIGURATION_LOAD_FAILED = 'SYSTEM_NOTICE_CONFIGURATION_LOAD_FAILED';
...
const loadFailed = payloadParamActionCreator(SYSTEM_NOTICE_CONFIGURATION_LOAD_FAILED);
