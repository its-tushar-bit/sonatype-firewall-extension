...
(function() {
  ...
  function startAngularApp(hash, appId) {
  ...
  function panelLoadHandler(event, data) {
    ...
    // outside of angular
    $('button[data-target="#componentExistingWaiverModal"]')
            .bind(
                    'click',
                    function() {
                      $('body')
                      ...
                      startAngularApp(data.gav.hash, applicationId);
                    });
  }
  ...
  $(document).ready(function() {
    if (angular) {
      ...
      setTimeout(buildAngularApp,100);
    }    
