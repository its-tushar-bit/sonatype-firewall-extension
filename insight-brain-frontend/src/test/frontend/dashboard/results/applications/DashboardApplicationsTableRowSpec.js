...
import DashboardApplicationsTableRow
  from '../../../../../main/frontend/dashboard/results/applications/DashboardApplicationsTableRow';
import DashboardApplicationsTableStageRiskRow
  from '../../../../../main/frontend/dashboard/results/applications/DashboardApplicationsTableStageRiskRow';
...
describe('DashboardApplicationsTableRow', function() {
  ...
  it('renders an NxTableRow for the app information and an NxTableRow for each stage risk', function() {
    ...
    expect(stageRiskRows.at(0)).toHaveProp('stageRisk', { stageTypeName: 'build', scanId: 'scan1' });
    ...
    expect(stageRiskRows.at(1)).toHaveProp('stageRisk', { stageTypeName: 'release', scanId: 'scan2' });
