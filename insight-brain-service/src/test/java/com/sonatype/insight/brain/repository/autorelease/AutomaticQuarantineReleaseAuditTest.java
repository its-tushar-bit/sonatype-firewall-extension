...
public class AutomaticQuarantineReleaseAuditTest
    extends AbstractAuditTest
{
  ...
  @Before
  public void setup() {
    automaticQuarantineRelease = getCLMServer().getInstance(AutomaticQuarantineRelease.class);
    repository = tempEntity.newRepository();
    component = tempEntity.newRepositoryComponent(repository.getId(), MatchState.EXACT, "pathname1",
  ...
  @Test
  public void testAutomaticQuarantineRelease() {
  ...
  @Test
  public void testAutomaticQuarantineRelease_RepositoryWithAutoUnquarantineDisabled() {
    Condition condition = new Condition(IntegrityRatingConditionType.ID, "is", "2");
    Constraint constraint = new Constraint("c1", "constraint1", LogicalOperator.OR);
    constraint.addCondition(condition);
    Policy policy = createPolicy("policy", new Stage(ProxyStageType.ID), constraint);
  ...
  @Test
  public void testAutomaticQuarantineRelease_RepositoryWithNoComponents() {
    automaticQuarantineRelease.run();
  ...
  @Test
  public void testAutomaticQuarantineRelease_WithNoRepositories() {
    automaticQuarantineRelease.run();
