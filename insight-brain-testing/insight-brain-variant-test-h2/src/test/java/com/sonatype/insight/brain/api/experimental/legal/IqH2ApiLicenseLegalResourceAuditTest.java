...
/**
 * Kept in the {@code com.sonatype.insight.brain.api.experimental.legal} package (not the default
 * {@code com.sonatype.insight.brain.variant} package) because it calls
 * {@link ComponentLegalService#NOT_IMPLEMENTED}, which is package-private. Reproduces the
 * {@code AbstractAuditTest} scaffolding (log capture + unauthorized-user helper) that the legacy
 * {@code ApiLicenseLegalResourceAuditTest} inherited from its base class.
 */
@IqH2Test
class IqH2ApiLicenseLegalResourceAuditTest
    implements AuditTestSupport
{
  ...
  @Test
  void testSaveNewComponentCopyright() throws Exception {
  ...
  @Test
  void testSaveExistingComponentCopyright() throws Exception {
    Application app = ctx.tempEntity().newApplicationWithParent();
    ComponentIdentifier componentIdentifier = ComponentIdentifier.createMavenCoordinates("g1", "a1", "v1");
    ComponentCopyright componentCopyright =
        ctx.tempEntity().newComponentCopyright(componentIdentifier, app.getId(), "legalContentHash");
    CopyrightOverrideDTO copyrightOverrideDTO = CopyrightOverrideDTO.fromCopyrightOverride(
        ctx.tempEntity()
            .newCopyrightOverride("original", "hash", "content", ComponentLegalPartStatus.ENABLED,
  ...
  @Test
  void testSaveComponentCopyright_Unauthorized() throws Exception {
    Application app = ctx.tempEntity().newApplicationWithParent();
    ComponentIdentifier componentIdentifier = ComponentIdentifier.createMavenCoordinates("g1", "a1", "v1");
    ComponentCopyright componentCopyright =
        ctx.tempEntity().newComponentCopyright(componentIdentifier, app.getPublicId(), "legalContentHash1");
  ...
  @Test
  void testSaveComponentLegalFile_Notices() throws Exception {
    Application app = ctx.tempEntity().newApplicationWithParent();
  ...
  @Test
  void testSaveComponentLegalFile_Licenses() throws Exception {
    Application app = ctx.tempEntity().newApplicationWithParent();
    ComponentIdentifier componentIdentifier = ComponentIdentifier.createMavenCoordinates("g", "a", "v");
    ComponentLegalFileDTO componentLegalFileDTO = new ComponentLegalFileDTO();
  ...
  @Test
  void testSaveComponentLegalFile_Unauthorized() throws Exception {
    Application app = ctx.tempEntity().newApplicationWithParent();
    ComponentIdentifier componentIdentifier = ComponentIdentifier.createMavenCoordinates("g", "a", "v");
    ComponentLegalFile componentLegalFile =
        ctx.tempEntity()
            .newComponentLegalFile(componentIdentifier, app.getId(), LegalFileType.NOTICE,
                "legalContentHash");
  ...
  @Test
  void testSaveComponentObligationAttribution_Create() throws Exception {
  ...
  @Test
  void testSaveComponentObligationAttribution_Create_Unauthorized() throws Exception {
    Application application = ctx.tempEntity().newApplicationWithParent();
    ComponentObligationAttributionDTO bodyDto = new ComponentObligationAttributionDTO();
    bodyDto.setComponentIdentifier(
        ApiComponentIdentifierDTOV2.fromComponentIdentifier(ComponentIdentifier.createMavenCoordinates("g", "a", "v")));
  ...
  @Test
  void testSaveComponentObligationAttribution_Update() throws Exception {
    ComponentIdentifier componentIdentifier = ComponentIdentifier.createMavenCoordinates("g1", "a1", "v1");
    ...
    ComponentObligationAttribution oldComponentObligationAttribution = ctx.tempEntity()
  ...
  @Test
  void testSaveComponentObligationAttribution_Update_Unauthorized() throws Exception {
    ComponentIdentifier componentIdentifier = ComponentIdentifier.createMavenCoordinates("g1", "a1", "v1");
    Organization organization = ctx.tempEntity().newOrganization();
    Application application = ctx.tempEntity().newApplication(organization.getId());
    String obligationName = "obligationName1";
  ...
  @Test
  void testDeleteComponentObligationAttribution_Unauthorized() throws Exception {
    Application application = ctx.tempEntity().newApplicationWithParent();
    ComponentObligationAttribution componentObligationAttribution = ctx.tempEntity()
        .newComponentObligationAttribution(
            ComponentIdentifier.createMavenCoordinates("g", "a", "v"), application.getId(), "obligationName", "content",
  ...
  @Test
  void testSaveComponentObligation_Create() throws Exception {
    Application application = ctx.tempEntity().newApplicationWithParent();
  ...
  @Test
  void testSaveComponentObligation_Create_Unauthorized() throws Exception {
    Application application = ctx.tempEntity().newApplicationWithParent();
    ApiLicenseLegalObligationDTO bodyDto = new ApiLicenseLegalObligationDTO();
    bodyDto.setComponentIdentifier(ApiComponentIdentifierDTOV2.fromComponentIdentifier(
        ComponentIdentifier.createMavenCoordinates("g", "a", "v")));
  ...
  @Test
  void testSaveComponentObligation_Update() throws Exception {
    Application application = ctx.tempEntity().newApplicationWithParent();
  ...
  @Test
  void testSaveComponentObligation_Update_Unauthorized() throws Exception {
    Application application = ctx.tempEntity().newApplicationWithParent();
    ComponentObligation componentObligation = ctx.tempEntity()
        .newComponentObligation(
            ComponentIdentifier.createMavenCoordinates("g", "a", "v"), application.getId(), "obligationName", null,
  ...
  @Test
  void testDeleteComponentObligation_Unauthorized() throws Exception {
    Application application = ctx.tempEntity().newApplicationWithParent();
    ComponentObligation componentObligation = ctx.tempEntity()
        .newComponentObligation(
            ComponentIdentifier.createMavenCoordinates("g", "a", "v"), application.getId(), "obligationName", null,
