...
public class DefaultRepositoryIdentifiedComponentResource
    implements ApiRepositoryIdentifiedComponentResourceV2
{
  private final ApiRepositoryIdentifiedComponentService repositoryIdentifiedComponentService;

  @Inject
  public DefaultRepositoryIdentifiedComponentResource(
