...
@Named
@Timed
@Path(DevelopmentPrioritiesApiResource.RESOURCE_PATH)
public class DevelopmentPrioritiesApiResource
{
  static final String DEFAULT_PAGE = "1";

  static final String DEFAULT_PAGE_SIZE = "10";

  static final String RESOURCE_PATH = "api/experimental/priorities/{applicationId}/{scanId}";

  private final DevelopmentPrioritiesService developmentPrioritiesService;

  @Inject
  DevelopmentPrioritiesApiResource(final DevelopmentPrioritiesService developmentPrioritiesService) {
