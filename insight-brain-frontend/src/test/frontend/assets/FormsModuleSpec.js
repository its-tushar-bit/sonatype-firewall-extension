...
describe('Forms module', function () {
  ...
  describe('clmInput', function () {
    ...
    it('Requires that the input have a "name" set', function () {
      expect(function () {
        compile(
          '<form name="form"><input clm-input type="text" ng-model="field"></form>'
        )(scope);
    ...
    it('Requires that the form have a "name" set', function () {
      expect(function () {
        compile(
          '<form><input name="test" clm-input type="text" ng-model="field"></form>'
        )(scope);
    ...
    it('Will reject a "messages" attr that is not an Object', function () {
      expect(function () {
        compile(
          '<form><input messages="foo" name="test" clm-input type="text" ng-model="field"></form>'
        )(scope);
    ...
    describe('Popover validation messages', function () {
      ...
      describe('Popover triggers', function () {
        beforeEach(function () {
          element = compile(
            '<form name="form"><input clm-input name="test" type="text" ng-model="field" ' +
              'required></form>'
          )(scope);
      ...
      describe('Popover specific messages', function () {
        var testCases = [
          {
            input:
              '<input clm-input name="test" type="number" ng-model="field">',
            newValue: 'a',
          ...
          {
            input:
              '<input ng-minlength="2" clm-input name="test" type="text" ng-model="field">',
            newValue: 'a',
          ...
          {
            input:
              '<input ng-maxlength="2" clm-input name="test" type="text" ng-model="field">',
            newValue: 'abc',
          ...
          {
            input:
              '<input ng-pattern="/^\\s*\\w*\\s*$/" clm-input name="test" type="text" ng-model="field">',
            newValue: 'a b',
          ...
          {
            input:
              '<input min="1" clm-input name="test" type="number" ng-model="field">',
            newValue: '0',
          ...
          {
            input:
              '<input max="1" clm-input name="test" type="number" ng-model="field">',
            newValue: '2',
        ...
        function triggerValidationError(testCase) {
          it(
            ...
            function () {
              element = compile(
                '<form name="form">' + testCase.input + '</form>'
              )(scope);
              input = element.find('input');
