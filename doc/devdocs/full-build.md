...
specific [feature snapshot you're working on](https://jenkins.ci.sonatype.dev/job/insight/job/insight-brain/job/feature-snapshots/) and then select the first checkbox.
...
automatic pipeline that runs everytime you commit, but doesn't have the first option checked
(`functionalTestsEnabled`).
