...
void runBuildAndParallelSteps(Map<String, ?> mavenCommon, String keystoreCredId, boolean deployToRepo, boolean useInstall4J) {
  cache(defaultBranch: 'main', skipSave: isDeployBranch(env, 'main'),
    caches:
