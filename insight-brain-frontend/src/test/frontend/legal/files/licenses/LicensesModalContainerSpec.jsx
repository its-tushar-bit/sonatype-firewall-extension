...
describe('LicensesModalContainer', function () {
  ...
  it('correctly maps the action creators to the LicensesModalContainer props', function () {
    const wrapper = shallow(vdom).dive();
    expect(wrapper.prop('cancelLicensesModal')()).toEqual({
      type: 'cancelLicensesModalSpy',
    });
    expect(wrapper.prop('setLicenseContent')()).toEqual({
      type: 'setLicenseContentSpy',
    });
    expect(wrapper.prop('setLicenseStatus')()).toEqual({
      type: 'setLicenseStatusSpy',
    });
    expect(wrapper.prop('addLicense')()).toEqual({ type: 'addLicenseSpy' });
    expect(wrapper.prop('setLicensesScope')()).toEqual({
