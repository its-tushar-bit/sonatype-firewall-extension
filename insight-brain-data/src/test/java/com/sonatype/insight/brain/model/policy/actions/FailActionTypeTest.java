...
public class FailActionTypeTest
{
  private ActionType actionType = ActionTypes.getById(FailActionType.ID);
  ...
  public void testValidateAction_TypeWithTarget() {
    ...
    assertValidationResultHasErrors(result, "Invalid action 'Fail': This action does not support targets");
  ...
  public void testValidateAction_WithTargetType() {
    ...
    ValidationResult result = actionType.validateAction(action);
    assertValidationResultHasErrors(result, "Invalid action 'Fail': This action does not support target types");
