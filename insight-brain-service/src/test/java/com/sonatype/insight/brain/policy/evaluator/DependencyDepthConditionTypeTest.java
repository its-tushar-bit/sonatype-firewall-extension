...
import com.sonatype.insight.brain.model.policy.conditions.DependencyDepthConditionType;
    ...
    extends AbstractPolicyEvaluationTest
{
    ...
    public void testEvaluate()
    {
        ...
        component1.addDependencyDepth( 1 );
        components.add( component1 );
        Component component2 = new Component( "g2", "a2", "v2" );
        component2.addDependencyDepth( 2 );
        component2.addDependencyDepth( 5 );
