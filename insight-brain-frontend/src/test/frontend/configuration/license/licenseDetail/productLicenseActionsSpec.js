...
} from '../../../../../../src/main/frontend/configuration/license/productLicenseActions';
...
describe('productLicenseActions', () => {
  ...
  describe('load', () => {
    ...
    describe('fail', () => {
      beforeEach(() => {
        checkPermissionsSpy.and.returnValue(Promise.reject({ response: {} }));
      });
  ...
  describe('updateLicense', () => {
    ...
    describe('fail', () => {
      ...
      it(`dispatches a ${PRODUCT_LICENSE_UPDATE_LICENSE_FAILED} action because of insufficient permissions`, () => {
        checkPermissionsSpy.and.returnValue(Promise.reject());
        store.dispatch(updateLicense()).then(() => {
          const [, { type }] = store.getActions();
