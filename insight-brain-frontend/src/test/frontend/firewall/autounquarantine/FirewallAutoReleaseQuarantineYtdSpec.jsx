...
describe('FirewallAutoReleaseQuarantineYtd', function () {
  let minimalProps, FirewallAutoReleaseQuarantineYtd, getShallowComponent;

  beforeEach(function () {
    FirewallAutoReleaseQuarantineYtd = require('inject-loader!../../../../main/frontend/firewall/autounquarantine/FirewallAutoReleaseQuarantineYtd')()
      .default;
