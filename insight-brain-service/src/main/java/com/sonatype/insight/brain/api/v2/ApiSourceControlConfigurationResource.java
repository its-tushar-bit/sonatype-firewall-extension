...
@Tag(name = "Config Source Control",
    description = "Use this REST API to manage the configuration of IQ Server with your Source Control Management (SCM) "
        +
        "system (e.g. GitHub).")
...
public class ApiSourceControlConfigurationResource
{
  ...
  public void setConfiguration(
      @RequestBody(description = "Provide the settings for the SCM configuration as below: " +
          ...
          "</ul>",
          content = @Content(
              schema = @Schema(implementation = ApiSourceControlConfigurationDTO.class))) JsonNode jsonNode)
  {
