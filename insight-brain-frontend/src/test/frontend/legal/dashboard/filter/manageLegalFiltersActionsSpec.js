...
describe('manageLegalFilterActions', function () {
  ...
  beforeEach(function () {
    const module = require('inject-loader!../../../../../main/frontend/legal/dashboard/filter/manageLegalFiltersActions')(
      {
  ...
  describe('fetchSavedFilters', function () {
    ...
    it('gets the saved filters from the backend and then dispatches LEGAL_DASHBOARD_FETCH_SAVE_FILTERS_FULFILLED', function (done) {
      mockAxiosCalls({
        get: {
  ...
  describe('saveFilter', function () {
    ...
    it('dispatches LEGAL_DASHBOARD_SAVE_FILTER_REQUESTED action if filter name is not duplicate and not overwriting', (done) => {
      mockAxiosCalls({
        get: {
    ...
    it('dispatches LEGAL_DASHBOARD_SAVE_DUPLICATE_FILTER_REQUESTED if name is duplicate, not overwriting and warning', function () {
    ...
    it('dispatches LEGAL_DASHBOARD_SAVE_DUPLICATE_FILTER_REQUESTED if name is duplicate ignoring space', function () {
    ...
    it('dispatches LEGAL_DASHBOARD_SAVE_DUPLICATE_FILTER_REQUESTED if name is duplicate ignoring case', function () {
      store.dispatch(saveFilter({ name: 'bAr', isOverwriting: false }));
    ...
    it('PUTs the filter to the server, dispatches LEGAL_DASHBOARD_SAVE_FILTER_FULFILLED and fetches the saved filters', function (done) {
  ...
  describe('deleteFilter', function () {
    ...
    it(
      'DELETES to deleteSavedFilter with its parameter and then dispatches ' +
        'LEGAL_DASHBOARD_DELETE_FILTER_FULFILLED after that completes',
      function (done) {
        mockAxiosCalls({
          del: {
            [deleteFiltersUrl]: Promise.resolve({}),
    ...
    it('rejects if fetching the saved filters fails but does not dispatch LEGAL_DASHBOARD_DELETE_FILTER_FAILED', function (done) {
      mockAxiosCalls({
        del: {
          [deleteFiltersUrl]: Promise.resolve({}),
        },
