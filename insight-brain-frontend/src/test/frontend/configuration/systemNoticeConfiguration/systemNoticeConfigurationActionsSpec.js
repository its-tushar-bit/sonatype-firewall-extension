...
describe('systemNoticeConfigurationActions', function () {
  ...
  describe('loadConfiguration', function () {
    ...
    describe('after a failed GET call', function () {
      it('dispatches an SYSTEM_NOTICE_CONFIGURATION_LOAD_FAILED action', function (done) {
        mockAxiosCalls({
          get: {
        ...
        store.dispatch(loadConfiguration()).then(() => {
          actions = store.getActions();
          expect(actions.length).toBe(2);
          expect(actions[1].type).toBe('SYSTEM_NOTICE_CONFIGURATION_LOAD_FAILED');
  ...
  describe('load', function () {
    ...
    describe('after a successful PUT permission call', function () {
      it('dispatches an SYSTEM_NOTICE_CONFIGURATION_LOAD_FULFILLED action', function (done) {
        mockAxiosCalls({
          put: {
    ...
    describe('after a failed PUT permission call', function () {
      it('dispatches an SYSTEM_NOTICE_CONFIGURATION_LOAD_FAILED action', function (done) {
        ...
        store.dispatch(load()).then(() => {
          actions = store.getActions();
          expect(actions.length).toBe(1);
          expect(actions[0].type).toBe('SYSTEM_NOTICE_CONFIGURATION_LOAD_FAILED');
