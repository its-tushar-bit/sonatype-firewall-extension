    ...
    extends AbstractComponentTest
{
  ...
  public void testUnquarantineComponent_WasQuarantined() throws Exception {
    ...
    getRepositoryService().unquarantineComponent(repository.getId(), pathname, null);
  ...
  public void testGetPolicyThreats() {
    ...
    RepositoryPolicyThreatDTO repositoryPolicyThreatDTO = getRepositoryService()
    ...
    repositoryViolationDTO = getRepositoryService().getPolicyThreats(repository.getId(), "path4").activePolicyViolations
        .get(0);
  ...
  public void testGetPolicyThreats_RepositoryComponentDoesNotExist() {
    ...
    assertThatExceptionOfType(NotFoundException.class).isThrownBy(() -> {
      getRepositoryService().getPolicyThreats(repository.getId(), "pathDoesNotExist");
    }).withMessage(
  ...
  public void testGetPolicyThreats_RepositoryDoesNotExist() {
    assertThatExceptionOfType(NotFoundException.class).isThrownBy(() -> {
      getRepositoryService().getPolicyThreats("RepositoryIdDoesNotExist", null);
  ...
  public void testGetReportSummary() {
    ...
    RepositoryReportSummary summary = getRepositoryService().getReportSummary(repo.getId());
  ...
  public void testTHREAT_LEVEL_DESC_PATHNAME_ASC() throws Exception {
    ...
    assertThat(AbstractRepositoryService.THREAT_LEVEL_DESC_PATHNAME_ASC.compare(detail1, detail2))
    ...
    final RepositoryReportDetail detail3 = RepositoryReportDetail
        .create(new RepositoryComponent(null, "a", null, null, null, null, null, null),
            new RepositoryPolicyViolation(null, null, null, null, null, 0, null, null, null,
                "[]" /* constraintFacts */), false);
    assertThat(AbstractRepositoryService.THREAT_LEVEL_DESC_PATHNAME_ASC.compare(detail1, detail3))
    ...
    final RepositoryReportDetail detail4 = RepositoryReportDetail
        .create(new RepositoryComponent(null, "z", null, null, null, null, null, null),
            new RepositoryPolicyViolation(null, null, null, null, null, 0, null, null, null,
                "[]" /* constraintFacts */), false);
    assertThat(AbstractRepositoryService.THREAT_LEVEL_DESC_PATHNAME_ASC.compare(detail1, detail4))
  ...
  public void testGetReportDetails() throws Exception {
    ...
    final List<RepositoryReportDetail> reportDetails = getRepositoryService()
  ...
  public void testGetRepositoryById() {
    ...
    RepositoryDTO actual = getRepositoryService().getRepositoryById(repository.getId());
  ...
  public void testGetRepositoryById_UnknownId() throws Exception {
    assertThatExceptionOfType(NotFoundException.class).isThrownBy(() -> {
      getRepositoryService().getRepositoryById("foobar");
  ...
  public void testReevaluateRepository() throws Exception {
    ...
    getRepositoryService().reevaluateRepository(repository.getId());
  ...
  public void testReevaluateRepository_UnknownId() throws Exception {
    assertThatExceptionOfType(NotFoundException.class).isThrownBy(() -> {
      getRepositoryService().reevaluateRepository("foobar");
    }).withMessage("Cannot find a repository with ID foobar.");
  }
  ...
  public void testDeleteRepository() throws Exception {
    Repository repository = tempEntity.newRepository();
    getRepositoryService().deleteRepository(repository.getId());
  ...
  public void testDeleteRepository_UnknownId() throws Exception {
    assertThatExceptionOfType(NotFoundException.class).isThrownBy(() -> {
      getRepositoryService().deleteRepository("foobar");
    }).withMessage("Cannot find a repository with ID foobar.");
  }
  ...
  public void testReevaluateComponent() throws Exception {
    ...
    getRepositoryService().reevaluateComponent(repository.getId(), repositoryComponent.getHash(), null);
  ...
  public void testReevaluateComponent_UnknownHash() throws Exception {
    ...
    assertThatExceptionOfType(NotFoundException.class).isThrownBy(() -> {
      getRepositoryService().reevaluateComponent(repo.getId(), "missing-hash", null);
