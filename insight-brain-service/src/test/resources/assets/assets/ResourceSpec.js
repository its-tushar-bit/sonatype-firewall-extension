describe('Resource', function () {
	...
	it('Gets with relational collection', inject(function(CLMResource, $httpBackend) {
		...
		$httpBackend.expectGET(storeUrl).respond([{ id : 'foo' }, { id : 'bar' }]);
		$httpBackend.expectGET(relatedStoreUrl({ id : 'foo' })).respond([{ relatedId : 'relatedFoo' }, { relatedId : 'relatedFooTwo' }]);
	...
	it('Creates related', inject(function (CLMResource, $httpBackend) {
		...
		$httpBackend.expectPOST(storeUrl).respond({ data : ['foo'], id : 'bar' });
		$httpBackend.expectPUT(relatedStoreUrl({ id : 'bar' })).respond([{ relatedId : 'relatedBar', relatedData: ['relatedFoo'] }]);
