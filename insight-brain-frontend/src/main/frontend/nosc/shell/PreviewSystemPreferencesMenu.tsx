...
export default function PreviewSystemPreferencesMenu(): JSX.Element {
  ...
  // License, Automatic SCM Configuration, Advanced Search, Atlassian Crowd, Proxy, Waived Components, LDAP, User Tokens, SAML, Webhooks, Roles, Email) intentionally omit `prefix` —
  ...
  const items: ItemSpec[] = [
    ...
    },
    {
      ...
      // No prefix: automaticSourceControlConfiguration is embedded in NOUX, not a Classic firewall-prefixed state.
