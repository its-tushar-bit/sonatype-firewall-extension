...
export const ADVANCED_SEARCH_SET_EASY_QUERY_FIELD = 'ADVANCED_SEARCH_SET_EASY_QUERY_FIELD';
export const setEasyQueryField = payloadParamActionCreator(ADVANCED_SEARCH_SET_EASY_QUERY_FIELD);

export const ADVANCED_SEARCH_SET_EASY_QUERY_VALUE = 'ADVANCED_SEARCH_SET_EASY_QUERY_VALUE';
export const setEasyQueryValue = payloadParamActionCreator(ADVANCED_SEARCH_SET_EASY_QUERY_VALUE);

export const ADVANCED_SEARCH_REMOVE_SEARCH_ITEM = 'ADVANCED_SEARCH_REMOVE_SEARCH_ITEM';
export const removeSearchItem = payloadParamActionCreator(ADVANCED_SEARCH_REMOVE_SEARCH_ITEM);

export const ADVANCED_SEARCH_ADD_SEARCH_ITEM = 'ADVANCED_SEARCH_ADD_SEARCH_ITEM';
export const addSearchItem = noPayloadActionCreator(ADVANCED_SEARCH_ADD_SEARCH_ITEM);
