...
ALTER TABLE last_policy_evaluation DROP CONSTRAINT last_policy_evaluation_eval_fk;
...
ALTER TABLE source_control_pull_request_comment DROP CONSTRAINT source_control_pull_request_source_policy_eval_fk;
...
ALTER TABLE source_control_pull_request_comment DROP CONSTRAINT source_control_pull_request_target_policy_eval_fk;
...
ALTER TABLE source_control_default_branch_commit_history DROP CONSTRAINT source_control_default_branch_commit_history_policy_eval_fk;
...
ALTER TABLE source_control_event DROP CONSTRAINT source_control_event_policy_evaluation_fk;
