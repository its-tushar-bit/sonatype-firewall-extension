...
(() => {
  ...
  async function runScan() {
    ...
    if (!m) return;
    const host = document.querySelector('[class*="package-tab"] h2')?.parentElement || document.querySelector("#top main") || document.querySelector("main") || document.body;
  ...
  void runScan();
  async function readVersionFromDom() {
