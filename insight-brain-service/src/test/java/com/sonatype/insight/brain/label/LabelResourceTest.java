    ...
    extends AbstractResourceTest
{
        ...
        throws Exception
    {
        ...
        Assert.assertEquals( "Cannot delete a label used in a policy condition", response.getResponseBody() );
        ...
        assertLabel( application.getId(), "My label", Color.blue, labels[0] );
    }
        ...
        throws Exception
    {
        ...
        Assert.assertNotNull( labels );
        Assert.assertEquals( 1, labels.length );
        assertLabel( application1.getId(), "My label", Color.blue, labels[0] );
    }
