...
/**
 * Filter sidebar for the Ana Waivers list (CLM-43204). Confluence V1 filter set:
 * threat range, expiry status, auto vs manual, organizations, applications, policies.
