...
export const COPYRIGHT_OVERRIDE_SAVE_REQUESTED =
  'COPYRIGHT_OVERRIDE_SAVE_REQUESTED';
export const COPYRIGHT_OVERRIDE_SAVE_FULFILLED =
  'COPYRIGHT_OVERRIDE_SAVE_FULFILLED';
export const COPYRIGHT_OVERRIDE_FAILED = 'COPYRIGHT_OVERRIDE_FAILED';
export const COPYRIGHT_OVERRIDE_SUBMIT_MASK_DONE =
  'COPYRIGHT_OVERRIDE_SUBMIT_MASK_DONE';
export const SET_DISPLAY_COPYRIGHT_OVERRIDE_MODAL =
  ...
  return function (dispatch, getState) {
    if (isCopyrightsDirty) {
      ...
      const existingComponentCopyrightScopeOwnerId =
        advancedLegalState.component.component.licenseLegalData
      ...
      const matchingScope = availableScopes.values.find(
        (s) => s.id === scopeOwnerId
      );
            ...
            .then((getResponsePayload) => {
              const descriptiveResponse = {
                ...
                componentCopyrightLastUpdatedAt:
                  getResponsePayload.data.componentCopyrightDTO.lastUpdatedAt,
              };
...
const saveFulfilled = payloadParamActionCreator(
  COPYRIGHT_OVERRIDE_SAVE_FULFILLED
);
const saveFailed = payloadParamActionCreator(COPYRIGHT_OVERRIDE_FAILED);
export const setDisplayCopyrightOverrideModal = payloadParamActionCreator(
  SET_DISPLAY_COPYRIGHT_OVERRIDE_MODAL
);
