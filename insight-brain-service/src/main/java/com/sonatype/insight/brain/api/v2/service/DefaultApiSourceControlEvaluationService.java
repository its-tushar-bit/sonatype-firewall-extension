 ...
 */
@Named
public class DefaultApiSourceControlEvaluationService
    extends AbstractApiApplicationEvaluationService implements ApiSourceControlEvaluationService
{
  private static final Logger log = LoggerFactory.getLogger(DefaultApiSourceControlEvaluationService.class);
  ...
  @Inject
  public DefaultApiSourceControlEvaluationService(
