...
class IqH2OnPremJwtTokenTest
{
  ...
  @Test
  void testValidJWT_WithExactMatchClaims() throws Exception {
    final String sub = "bob";
    final String issuer = "https://an-idp.com";
    final String username = "bob-the-ruler";
    final String firstName = "Bob";
  ...
  @Test
  void testValidJWT_WithExactMatchClaims_WrongClaimValue() throws Exception {
    final String sub = "bob";
    final String issuer = "https://an-idp.com";
    final String username = "bob-the-ruler";
    final String firstName = "Bob";
