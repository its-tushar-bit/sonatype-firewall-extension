...
public class SuccessMetricsConfigurationPageAssertions
{
  private final SuccessMetricsConfigurationPage page;

  public SuccessMetricsConfigurationPageAssertions(SuccessMetricsConfigurationPage page) {
    this.page = page;
  }
