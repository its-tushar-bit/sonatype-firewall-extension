...
describe('AngularCommon', function () {
  ...
  it('validates valid name characters controls', function () {
    var element = compile(
      '<ng-form id="form" name="form"><input id="control" name="control" type="text" ' +
        'ng-model="alpha" valid-name-characters /></ng-form>'
    )(scope);
    scope.$digest();
  ...
  describe('agoLastDay filter', function () {
    var filter,
      filteredAnswer = 'Less than a day ago';
    beforeEach(inject(function ($filter) {
