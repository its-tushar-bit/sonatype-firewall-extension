...
@IqH2Test
class IqH2ApplicationSummaryResourceTest
{
  ...
  private HttpRequest restRequest() {
    return ctx.restRequest().path(ApplicationSummaryResource.RESOURCE_PATH);
  }
  ...
  @Test
  void testGetApplications_EvaluateApplication() throws Exception {
  ...
  @Test
  void testGetApplications_EvaluateComponent() throws Exception {
    Application application = ctx.tempEntity().newApplicationWithParent();
  ...
  @Test
  void testGetApplications_NoGoalSpecified() throws Exception {
    Application application = ctx.tempEntity().newApplicationWithParent();
  ...
  @Test
  void testGetApplicationsByOrganization_EvaluateApplication() throws Exception {
    Application application = ctx.tempEntity().newApplicationWithParent();
  ...
  @Test
  void testGetApplicationsByOrganization_EvaluateComponent() throws Exception {
    Application application = ctx.tempEntity().newApplicationWithParent();
  ...
  @Test
  void testGetApplicationsByOrganization_NoGoalSpecified() throws Exception {
    Application application = ctx.tempEntity().newApplicationWithParent();
  ...
  @Test
  void testVerifyOrCreateApplication_EvaluateApplication() throws Exception {
  ...
  @Test
  void testVerifyOrCreateApplicationForContainerImageFirewall_success() throws Exception {
    SystemConfigurationPropertyFeature.CONTAINER_IMAGES_EVAL_ENABLED.setEnabled(true);

    RepositoryManager repositoryManager = ctx.tempEntity().newRepositoryManager("instance1");
    repositoryManager.setBaseUrl("baseUrl1");
    repositoryManagerDAO.update(repositoryManager);

    Repository repository =
        ctx.tempEntity().newRepository(repositoryManager, "proxy-docker-repository", RepositoryType.proxy, "docker");
  ...
  @Test
  void testVerifyOrCreateApplicationForContainerImageFirewall_defaultsQuarantineToTrueWhenMissing() throws Exception {
    SystemConfigurationPropertyFeature.CONTAINER_IMAGES_EVAL_ENABLED.setEnabled(true);
  ...
  @Test
  void testVerifyOrCreateApplicationForContainerImageFirewall_honorsExplicitFalseQuarantine() throws Exception {
    SystemConfigurationPropertyFeature.CONTAINER_IMAGES_EVAL_ENABLED.setEnabled(true);
  ...
  @Test
  void testVerifyOrCreateApplicationForContainerImageFirewall_FeatureFlagDisabled() throws Exception {
  ...
  @Test
  void testVerifyOrCreateApplicationForContainerImage_MissingLicenseFeature() throws Exception {
  ...
  @Test
  void testVerifyOrCreateApplicationForContainerImageFirewall_NoRepositoryExist() throws Exception {
    SystemConfigurationPropertyFeature.CONTAINER_IMAGES_EVAL_ENABLED.setEnabled(true);
    RepositoryManager repositoryManager = ctx.tempEntity().newRepositoryManager("instance1");
    repositoryManager.setBaseUrl("baseUrl1");
    repositoryManagerDAO.update(repositoryManager);

    Organization org = ctx.tempEntity().newOrganization("Firewall For Docker");
    Organization org1 = ctx.tempEntity().newOrganization("baseUrl1");
