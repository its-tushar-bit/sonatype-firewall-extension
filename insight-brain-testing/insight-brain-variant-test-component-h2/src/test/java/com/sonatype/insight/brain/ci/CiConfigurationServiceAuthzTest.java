    ...
    extends AbstractComponentH2AuthzTest
{
  ...
  public void testGetConfiguration_Unauthenticated() throws Exception {
    ...
    try {
      ...
      assertThrows(UnauthenticatedException.class, () -> service.getConfiguration(ORGANIZATION, org.getId(), true));
    }
    finally {
  ...
  public void testGetConfiguration_Unauthorized() throws Exception {
    ...
    try {
      ...
      assertThrows(UnauthorizedException.class, () -> service.getConfiguration(ORGANIZATION, org.getId(), true));
    }
    finally {
      // Cleanup even if an exception is thrown
      ciConfigDao.delete(ORGANIZATION.toString(), org.getId());
  ...
  public void testSetConfiguration_Unauthenticated() {
    ...
    // Then: Throws UnauthenticatedException
    assertThrows(UnauthenticatedException.class, () -> service.setConfiguration(ORGANIZATION, org.getId(), config));
  }
  ...
  public void testSetConfiguration_Unauthorized() {
    ...
    // Then: Throws UnauthorizedException
    assertThrows(UnauthorizedException.class, () -> service.setConfiguration(ORGANIZATION, org.getId(), config));
  }
  ...
  public void testDeleteConfiguration_Unauthenticated() throws Exception {
    ...
    try {
      ...
      // Then: Throws UnauthenticatedException
      assertThrows(UnauthenticatedException.class, () -> service.deleteConfiguration(ORGANIZATION, org.getId()));
    }
    finally {
      // Cleanup even if an exception is thrown
      ciConfigDao.delete(ORGANIZATION.toString(), org.getId());
  ...
  public void testDeleteConfiguration_Unauthorized() throws Exception {
    ...
    try {
      ...
      // Then: Throws UnauthorizedException
      assertThrows(UnauthorizedException.class, () -> service.deleteConfiguration(ORGANIZATION, org.getId()));
    }
    finally {
      // Cleanup even if an exception is thrown
      ciConfigDao.delete(ORGANIZATION.toString(), org.getId());
