# ADR 1. Architecture decision record template 
...
___
 _For further guidance see [Documenting Architecture Decisions](http://thinkrelevance.com/blog/2011/11/15/documenting-architecture-decisions)._
 _This template is compatible with [adr-tools](https://github.com/npryce/adr-tools)._    
