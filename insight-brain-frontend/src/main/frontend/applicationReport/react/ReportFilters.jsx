...
export default function ReportFilters(props) {
  ...
  const derivedSelectedProprietaryOptions =
      new Set([...proprietary].map(option => option ? 'proprietary' : 'nonProprietary'));

  const violationStateCheckedIds =
      new Set(reject(equals('waived+grandfathered'), setToArray(derivedViolationState)));
    ...
    <nav className="filters-nav">
      ...
      <div className="report-filter-container">
        ...
        <div className="report-filters">
          ...
          <NxStatefulTreeViewMultiSelect options={matchStateFilterOptions}
          ...
          <NxStatefulTreeViewMultiSelect options={violationStateFilterOptions}
          ...
          <NxStatefulTreeViewMultiSelect options={dependencyTypeFilterOptions}
