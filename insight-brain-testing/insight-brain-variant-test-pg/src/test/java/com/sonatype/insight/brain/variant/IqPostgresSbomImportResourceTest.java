...
/**
 * PostgreSQL variant of {@code SbomImportResourceTest} (legacy {@code AbstractResourceTest}).
 */
@IqPostgresTest
class IqPostgresSbomImportResourceTest
{
  ...
  private HttpRequest restRequest() {
    return ctx.restRequest().path(SbomImportResource.RESOURCE_PATH);
  }

  @Test
  void testDetectSbom_ValidCycloneDxSbom() throws Exception {
    URL resource =
        IqPostgresSbomImportResourceTest.class.getResource("/SbomImportResourceTest/valid-cyclonedx-bom.xml");
  ...
  @Test
  void testDetectSbom_ValidSpdxSbom() throws Exception {
    URL resource = IqPostgresSbomImportResourceTest.class.getResource("/SbomImportResourceTest/valid-spdx-bom.json");
    File sbom = new File(Objects.requireNonNull(resource).getFile());
    HttpResponse response = restRequest()
        .parameter(application.getId())
        .part("file", sbom.getName(), Files.readAllBytes(sbom.toPath()))
  ...
  @Test
  void testDetectBinary() throws Exception {
    SystemConfigurationPropertyFeature.SBOM_BINARY_SCANNING.setEnabled(true);
    URL resource = IqPostgresSbomImportResourceTest.class.getResource("/SbomImportResourceTest/binary.jar");
    File sbom = new File(Objects.requireNonNull(resource).getFile());
    HttpResponse response = restRequest()
        .parameter(application.getId())
        .part("file", sbom.getName(), Files.readAllBytes(sbom.toPath()))
  ...
  @Test
  void testDetectSbom_InvalidCycloneDxSbom() throws Exception {
    URL resource =
        IqPostgresSbomImportResourceTest.class.getResource("/SbomImportResourceTest/invalid-cyclonedx-bom.xml");
    File sbom = new File(Objects.requireNonNull(resource).getFile());
    HttpResponse response = restRequest()
        .parameter(application.getId())
  ...
  @Test
  void testDetectSbom_InvalidSpdxSbom() throws Exception {
    URL resource = IqPostgresSbomImportResourceTest.class.getResource("/SbomImportResourceTest/invalid-spdx-bom.json");
    File sbom = new File(Objects.requireNonNull(resource).getFile());
    HttpResponse response = restRequest()
        .parameter(application.getId())
        .query("ignoreValidationError", false)
  ...
  @Test
  void testDetectSbom_InvalidCycloneDxSbomStructure() throws Exception {
    URL resource =
        IqPostgresSbomImportResourceTest.class
            .getResource("/SbomImportResourceTest/invalid-cyclonedx-bom-structure.xml");
    File sbom = new File(Objects.requireNonNull(resource).getFile());
    HttpResponse response = restRequest()
        .parameter(application.getId())
  ...
  @Test
  void testDetectSbom_InvalidSpdxSbomStructure() throws Exception {
    URL resource =
        IqPostgresSbomImportResourceTest.class.getResource("/SbomImportResourceTest/invalid-spdx-bom-structure.json");
    File sbom = new File(Objects.requireNonNull(resource).getFile());
    HttpResponse response = restRequest()
        .parameter(application.getId())
        .query("ignoreValidationError", true)
  ...
  @Test
  void testDetectSbom_InvalidCycloneDxSbom_IgnoreValidationError() throws Exception {
    URL resource =
        IqPostgresSbomImportResourceTest.class.getResource("/SbomImportResourceTest/invalid-cyclonedx-bom.xml");
    File sbom = new File(Objects.requireNonNull(resource).getFile());
    HttpResponse response = restRequest()
  ...
  @Test
  void testDetectSbom_InvalidSpdxSbom_IgnoreValidationError() throws Exception {
    URL resource = IqPostgresSbomImportResourceTest.class.getResource("/SbomImportResourceTest/invalid-spdx-bom.json");
    File sbom = new File(Objects.requireNonNull(resource).getFile());
    HttpResponse response = restRequest()
        .parameter(application.getId())
  ...
  @Test
  void testDetectSbom_InvalidApplicationId() throws Exception {
    HttpResponse response = restRequest()
  ...
  @Test
  void testImportDetectedSbom_InvalidApplicationId() throws Exception {
    HttpResponse response = restRequest()
  ...
  @Test
  void testImportDetectedSbom_InvalidApplicationVersion() throws Exception {
    ...
    ctx.assertResponseStatus(404, importResponse);
  }

  @Test
  void testImportDetectedSbom_BINARY_Success() throws Exception {
    testImportDetectedSbom_Success("binary.jar", false, null);
  }

  @Test
  void testImportDetectedSbom_SBOM_Success() throws Exception {
    testImportDetectedSbom_Success("valid-spdx-bom.json", false, "a140fd3c3ded4bb0a640dc31e2904dc9");
  }

  @Test
  void testImportDetectedSbom_SkipSpdxSbomValidation_Success() throws Exception {
    testImportDetectedSbom_Success("invalid-spdx-bom.json", true, null);
  }

  @Test
  void testImportDetectedSbom_SkipCycloneDxSbomValidation_Success() throws Exception {
    testImportDetectedSbom_Success("invalid-cyclonedx-bom.xml", true, "a140fd3c3ded4bb0a640dc31e2904dc9");
  }

  @Test
  void testImportDetectedSbom_ApplicationVersionOverride() throws Exception {
    mockHdsReportDownload();
  ...
  @Test
  void testImportDetectedSbom_ApplicationVersionOverride_Blank() throws Exception {
    URL resource = IqPostgresSbomImportResourceTest.class.getResource("/SbomImportResourceTest/valid-spdx-bom.json");
    File sbom = new File(Objects.requireNonNull(resource).getFile());
    HttpResponse responseDetect = restRequest()
        .parameter(application.getId())
    ...
    ctx.assertResponseStatus(400, responseCommit);
  }

  @Test
  void testImportDetectedSbom_ApplicationVersionOverride_Conflict() throws Exception {
    URL resource = IqPostgresSbomImportResourceTest.class.getResource("/SbomImportResourceTest/valid-spdx-bom.json");
    File sbom = new File(Objects.requireNonNull(resource).getFile());
    ...
    ctx.assertResponseStatus(409, responseCommit2);
  }

  @Test
  void testImportDetectedSbom_FailureAfterVersionOverride_ShouldRollback() throws Exception {
    SbomDetectionResultDTO detectionResult;
    try (InputStream sbomStream =
        IqPostgresSbomImportResourceTest.class.getResourceAsStream("/SbomImportResourceTest/valid-cyclonedx-bom.xml"))
    {
      HttpResponse responseDetect = restRequest()
          .parameter(application.getId())
      ...
      ctx.assertResponseStatus(200, responseDetect);
    }
    ...
    ctx.assertResponseStatus(500, responseCommit);
      ...
      String expectedVersion) throws Exception
  {
    ...
    URL resource = IqPostgresSbomImportResourceTest.class.getResource("/SbomImportResourceTest/" + fileName);
    File sbom = new File(Objects.requireNonNull(resource).getFile());
    HttpResponse responseDetect = restRequest()
        .parameter(application.getId())
  ...
  private void mockHdsReportDownload() {
    URL resourceUrl = ReportHelper.zipReport("/ReportServiceTest/report-with-dependencies", ctx.tempFolder());
    ctx.hdsRespondWith(resourceUrl).atUri("rest/application/analysis/SCAN-ID");
  }
