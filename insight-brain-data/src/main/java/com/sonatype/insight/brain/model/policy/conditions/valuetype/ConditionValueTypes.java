...
public class ConditionValueTypes
{
  ...
  public static Collection<ConditionValueType<?>> getAll(String ownerId, final Set<LicensedFeature> features) {
    ...
    allConditionValueTypes.add(new LicenseThreatGroupValueType(ownerId, licenseThreatGroupDAO));
    ...
    allConditionValueTypes.add(new VulnerabilityGroupValueType(ownerId, vulnerabilityGroupDAO));
