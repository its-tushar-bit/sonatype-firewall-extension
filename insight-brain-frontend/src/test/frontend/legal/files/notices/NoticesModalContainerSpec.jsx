...
describe('NoticesModalContainer', function() {
  ...
  beforeEach(function() {
    ...
    NoticesModalContainer =
        require('inject-loader!../../../../../main/frontend/legal/files/notices/NoticesModalContainer')({
  ...
  it('correctly maps the action creators to the NoticesModalContainer props', function() {
    const wrapper = shallow(vdom).dive();
    expect(wrapper.prop('cancelNoticesModal')()).toEqual({ type: 'cancelNoticesModalSpy' });
    expect(wrapper.prop('setNoticeContent')()).toEqual({ type: 'setNoticeContentSpy' });
    expect(wrapper.prop('setNoticeStatus')()).toEqual({ type: 'setNoticeStatusSpy' });
    expect(wrapper.prop('addNotice')()).toEqual({ type: 'addNoticeSpy' });
    expect(wrapper.prop('setNoticesScope')()).toEqual({ type: 'setNoticesScopeSpy' });
