...
@IqH2Test
class IqH2ApiApplicationResourceV2AuditTest
    implements AuditTestSupport
{
  ...
  void before() {
    ...
    ctx.tempEntity().newUser("appContactName");
    organization = ctx.tempEntity().newOrganization();
    application = ctx.tempEntity().newApplication("appName", "appPubId", organization.getId(), "appContactName");
    targetOrganization = ctx.tempEntity().newOrganization();
  }
  ...
  @Test
  void testAddApplication_WithCategories() throws Exception {
    Tag tag1 = ctx.tempEntity().newTag(organization.getId(), "Tag1", Color.dark_red);
    Tag tag2 = ctx.tempEntity().newTag(organization.getId(), "Tag2", Color.dark_red);
  ...
  @Test
  void testAddApplication_EmptyCategories() throws Exception {
  ...
  @Test
  void testUpdateApplication_WithCategories() throws Exception {
    Tag tag1 = ctx.tempEntity().newTag(organization.getId(), "Tag1", Color.dark_red);
    Tag tag2 = ctx.tempEntity().newTag(organization.getId(), "Tag2", Color.dark_blue);
  ...
  @Test
  void testUpdateApplication_EmptyCategories() throws Exception {
  ...
  private ApiApplicationDTO applicationDTO(final String name, final String applicationPublicId, final Tag... tags) {
    ...
    User contactUser = ctx.tempEntity().newUser("aContact");
  ...
  @Test
  void testCloneApplication_Unauthorized() throws Exception {
  ...
  @Test
  void testMoveApplication_UnauthorizedWrite() throws Exception {
  ...
  @Test
  void testMoveApplication_UnauthorizedAddApplication() throws Exception {
    ctx.tempEntity().newMembershipMapping(application.getId(), Role.OWNER_ROLE_ID, getUnauthorizedUsername());
