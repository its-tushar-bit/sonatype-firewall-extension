...
describe('notificationService', () => {
  ...
  beforeEach(() => {
    /**
     * Doing `spyOn('window`, Notification).and.returnValue(mockNotification)` does not work.
    ...
    mockNotification = jasmine.createSpy('NotificationConstructor');
    mockNotification.permission = 'default';
    mockNotification.requestPermission = jasmine.createSpy('requestNotificationPermission');
