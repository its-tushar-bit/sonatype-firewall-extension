									...
									<td>
										<table cellpadding="0" cellspacing="0" border="0" bordercolor="#FFFFFF" style="border-collapse: collapse;">
											<tr>
												...
												<td width="60" height="30"
													style="color: #FFFFFF; width: 60px; height: 30px; text-align: center; background-image: url(${cdnUrl}clm/policy/1.3/alert_dark_blue.gif); background-size: cover; background-color: #0047B2; background-repeat: no-repeat;"><span
