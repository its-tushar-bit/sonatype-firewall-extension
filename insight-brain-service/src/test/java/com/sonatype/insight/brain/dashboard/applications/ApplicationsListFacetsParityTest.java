...
public class ApplicationsListFacetsParityTest
{
  ...
  public void setUp() {
    builder = new ApplicationsListFacetsBuilder(
        searchIndexClient, stageTypeService, organizationDAO, applicationDAO);
  ...
  public void omitsZeroCountOrg() {
    ...
    ApplicationsListFacetsDTO facets = builder.buildFacets(session, query, query, 2);
  ...
  public void fiveHundredFirstCap_matchesLegacy() {
    ...
    ApplicationsListFacetsDTO facets = builder.buildFacets(session, query, query, 501);
