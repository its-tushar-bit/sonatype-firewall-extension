...
@IqH2Test
class IqH2RoiConfigurationResourceTest
{
  ...
  void setup() {
    ...
    roiConfigurationDAO = ctx.lookup(RoiConfigurationDAO.class);
  ...
  @Test
  void testGetCurrentAndMinimumValuesByCurrencyType() throws Exception {
    ctx.tempEntity()
  ...
  @Test
  void testGetCurrentAndMinimumValuesByCurrencyType_Unlicensed() throws Exception {
