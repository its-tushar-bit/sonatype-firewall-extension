...
import com.sonatype.insight.brain.api.experimental.resultsview.RepositoryResultsDetailsResponseDto;
import com.sonatype.insight.brain.api.experimental.resultsview.RepositoryResultsDetailsDto;
...
@IqH2Test
class IqH2RepositoryResultsResourceTest
{
  ...
  void testGetDetails() throws Exception {
    ...
    final RepositoryManager repositoryManager1 = ctx.tempEntity().newRepositoryManager();
    final Repository repository1 = ctx.tempEntity().newRepository(repositoryManager1, "repository1");
    final ProxyRepositoryComponent repositoryComponent1 =
        ctx.tempEntity().newRepositoryComponent(repository1.getId(), "pathname1", now.minusDays(2).toDate(), null);
    final ProxyRepositoryPolicyViolation policyViolation1 =
        ctx.tempEntity().newRepositoryPolicyViolation(repository1.getId(), repositoryComponent1.getPathname());
    final RepositoryManager repositoryManager2 = ctx.tempEntity().newRepositoryManager();
    final Repository repository2 = ctx.tempEntity().newRepository(repositoryManager2, "repository2");
    final ProxyRepositoryComponent repositoryComponent2 =
        ctx.tempEntity().newRepositoryComponent(repository2.getId(), "pathname2", now.minusDays(1).toDate(), null);
    final ProxyRepositoryPolicyViolation policyViolation2 =
        ctx.tempEntity().newRepositoryPolicyViolation(repository2.getId(), repositoryComponent2.getPathname());
    final Repository repository3 = ctx.tempEntity().newRepository(repositoryManager2, "repository3");
    final ProxyRepositoryComponent repositoryComponent3 =
        ctx.tempEntity().newRepositoryComponent(repository3.getId(), "pathname3", now.toDate(), null);
    final ProxyRepositoryPolicyViolation policyViolation3 =
        ctx.tempEntity().newRepositoryPolicyViolation(repository3.getId(), repositoryComponent3.getPathname());
