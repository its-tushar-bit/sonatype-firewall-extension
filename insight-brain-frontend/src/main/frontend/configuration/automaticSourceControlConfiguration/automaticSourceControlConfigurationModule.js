...
const automaticSourceControlConfigurationModule = angular.module('automaticSourceControlConfigurationModule',
    ['ui.router', permissionServiceModule.name, storesModule.name, CLMLocationModule.name])
