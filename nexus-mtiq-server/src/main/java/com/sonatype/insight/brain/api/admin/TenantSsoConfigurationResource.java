...
public class TenantSsoConfigurationResource
{
  ...
  public SsoConfigurationDTO getSsoConfiguration(@PathParam("tenantSlug") String tenantSlug) {
    return tenantSsoConfigurationService.getSsoConfiguration(tenantSlug);
  }
