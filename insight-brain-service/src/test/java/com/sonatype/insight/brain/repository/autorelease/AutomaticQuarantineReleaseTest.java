    ...
    extends AbstractBrainServiceIntegrationTest
{
  ...
  @Test
  public void testAutomaticQuarantineRelease_Licensed() throws Exception {
  ...
  @Test
  public void testAutomaticQuarantineRelease_WithComponentsQuarantinedBeyondMaxDays() {
    Condition condition = new Condition(IntegrityRatingConditionType.ID, "is", "2");
    Constraint constraint = new Constraint("c1", "constraint1", LogicalOperator.OR);
    constraint.addCondition(condition);
    Policy policy = createPolicy("policy", new Stage(ProxyStageType.ID), FailActionType.ID, constraint);
  ...
  @Test
  public void testAutomaticQuarantineRelease_NotSupportedAutoUnquarantineEnabledConditionType() {
  ...
  @Test
  public void testAutomaticQuarantineRelease_WithoutFirewallAutoUnquarantineFeature() throws Exception {
  ...
  @Test
  public void testAutomaticQuarantineRelease_WithoutReleaseIntegrityFeature() throws Exception {
  ...
  @Test
  public void testAutomaticQuarantineRelease_AutoUnquarantineNotEnabled() {
    Condition condition = new Condition(IntegrityRatingConditionType.ID, "is", "2");
    Constraint constraint = new Constraint("c1", "constraint1", LogicalOperator.OR);
    constraint.addCondition(condition);
    Policy policy = createPolicy("policy", new Stage(ProxyStageType.ID), FailActionType.ID, constraint);
  ...
  @Test
  public void testAutomaticQuarantineRelease_AutoUnquarantineDataNotChanged() {
    tempEntity.newAutoUnquarantinePolicyConditionType(IntegrityRatingConditionType.ID);
  ...
  @Test
  public void testAutomaticQuarantineRelease_AutoUnquarantineDataChanged() {
    tempEntity.newAutoUnquarantinePolicyConditionType(IntegrityRatingConditionType.ID);
  ...
  @Test
  public void testAutomaticQuarantineRelease_AutoUnquarantineDataChangedWithOtherFailViolation() {
    tempEntity.newAutoUnquarantinePolicyConditionType(IntegrityRatingConditionType.ID);
  ...
  @Test
  public void testAutomaticQuarantineRelease_AutoUnquarantineDataChangedWithOtherNonFailViolation() {
    tempEntity.newAutoUnquarantinePolicyConditionType(IntegrityRatingConditionType.ID);
  ...
  @Test
  public void testAutomaticQuarantineRelease_AutoUnquarantineDataChangedWithViolationNotQuarantined() {
    tempEntity.newAutoUnquarantinePolicyConditionType(IntegrityRatingConditionType.ID);
  ...
  @Test
  public void testAutomaticQuarantineRelease_RootOrgAndNonProxyStage() {
