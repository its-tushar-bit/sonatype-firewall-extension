...
public class MoveOrganizationSuccessModal
    extends BasicElement<MoveOrganizationSuccessModal>
{
  public MoveOrganizationSuccessModal() {
    super("#success-move-org-modal");
  }
