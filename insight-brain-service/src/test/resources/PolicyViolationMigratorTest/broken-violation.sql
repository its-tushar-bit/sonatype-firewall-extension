...
INSERT INTO policy_violation (policy_violation_id, policy_evaluation_id, time, waived, policy_id, policy_name, threat_level, threat_category, hash, component_id_format, component_id_coordinates_json, pathnames, action_type_id, constraint_facts_json)
  VALUES ('eval-0-vio-0', 'eval-0', '2018-02-01 01:23:45', false, 'policy-0', 'Policy 0', 5, 'security', 'hash-0', 'npm', '{"invalid-json"', 'test-1.0.tgz', 'fail', 'constraints-0');

INSERT INTO policy_violation (policy_violation_id, policy_evaluation_id, time, waived, policy_id, policy_name, threat_level, threat_category, hash, component_id_format, component_id_coordinates_json, pathnames, action_type_id, constraint_facts_json)
  VALUES ('eval-0-vio-1', 'eval-0', '2018-02-01 01:23:45', false, 'policy-0', 'Policy 0', 5, 'security', 'hash-0', NULL, NULL, 'test-1.0.tgz', 'fail', 'constraints-0');
