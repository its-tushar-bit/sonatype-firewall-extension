...
public class ApiOrganizationResourceV2Test
{
  ...
  public void testGetOrganizations() throws Exception {
    Tag tag = ctx.tempEntity().newTag(organization.getId());
  ...
  public void testMoveOrganization_BadRequest() throws Exception {
    ...
    Tag tag = ctx.tempEntity().newTag(organizations.get(1).getId());
    ...
    MoveOrganizationResponseDTO moveOrganizationResponseDTO = response.getBody(MoveOrganizationResponseDTO.class);
    ctx.assertResponseStatus(HttpStatus.SC_CONFLICT, response);
  ...
  public void testDeleteOrganization() throws Exception {
    Organization organization = ctx.tempEntity().newOrganization();
    Organization otherOrganization = ctx.tempEntity().newOrganization();
