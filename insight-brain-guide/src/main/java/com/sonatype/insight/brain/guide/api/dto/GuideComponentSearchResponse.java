...
public record GuideComponentSearchResponse(
    @JsonDeserialize(contentAs = GuideComponentDocument.class) List<ComponentDocument> hits,
    long total,
    int offset,
    int limit,
    Map<String, Map<String, Long>> aggregations)
    implements ApiSearchResponse<ComponentDocument>
{
  public GuideComponentSearchResponse {
