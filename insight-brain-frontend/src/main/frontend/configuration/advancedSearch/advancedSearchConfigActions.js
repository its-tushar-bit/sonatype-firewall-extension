...
export const ADVANCED_SEARCH_CONFIG_LOAD_REQUESTED =
  'ADVANCED_SEARCH_CONFIG_LOAD_REQUESTED';
export const ADVANCED_SEARCH_CONFIG_LOAD_FULFILLED =
  'ADVANCED_SEARCH_CONFIG_LOAD_FULFILLED';
export const ADVANCED_SEARCH_CONFIG_LOAD_FAILED =
  'ADVANCED_SEARCH_CONFIG_LOAD_FAILED';

const loadRequested = noPayloadActionCreator(
  ADVANCED_SEARCH_CONFIG_LOAD_REQUESTED
);
const loadFulfilled = payloadParamActionCreator(
  ADVANCED_SEARCH_CONFIG_LOAD_FULFILLED
);
const loadFailed = payloadParamActionCreator(
  ADVANCED_SEARCH_CONFIG_LOAD_FAILED
);

export const ADVANCED_SEARCH_UPDATE_CURRENTLY_POLLING =
  'ADVANCED_SEARCH_UPDATE_CURRENTLY_POLLING';
const updateCurrentlyPolling = payloadParamActionCreator(
  ADVANCED_SEARCH_UPDATE_CURRENTLY_POLLING
);
...
function waitAndPollIfNeeded(dispatch, getState, currentlyPolling) {
  ...
  if (currentlyPolling) {
    setTimeout(
      pollState(dispatch, getState),
      ADVANCED_SEARCH_POLLING_INTERVAL_MS
    );
  }
}
    ...
    return axios
      ...
      .then(({ data }) => {
        ...
        waitAndPollIfNeeded(
          dispatch,
          getState,
          data.isFullIndexTriggered &&
            !getState().advancedSearchConfig.currentlyPolling
        );
      })
      .catch((error) => {
...
export const ADVANCED_SEARCH_CONFIG_SAVE_REQUESTED =
  'ADVANCED_SEARCH_CONFIG_SAVE_REQUESTED';
export const ADVANCED_SEARCH_CONFIG_SAVE_FULFILLED =
  'ADVANCED_SEARCH_CONFIG_SAVE_FULFILLED';
export const ADVANCED_SEARCH_CONFIG_SAVE_FAILED =
  'ADVANCED_SEARCH_CONFIG_SAVE_FAILED';
export const ADVANCED_SEARCH_CONFIG_SAVE_SUBMIT_MASK_TIMER_DONE =
  'ADVANCED_SEARCH_CONFIG_SAVE_SUBMIT_MASK_TIMER_DONE';

const saveRequested = noPayloadActionCreator(
  ADVANCED_SEARCH_CONFIG_SAVE_REQUESTED
);
const saveFulfilled = noPayloadActionCreator(
  ADVANCED_SEARCH_CONFIG_SAVE_FULFILLED
);
const saveFailed = payloadParamActionCreator(
  ADVANCED_SEARCH_CONFIG_SAVE_FAILED
);
...
export function save() {
  return function (dispatch, getState) {
    ...
    return axios
      .put(
        getAdvancedSearchConfigUrl(),
        getState().advancedSearchConfig.formState
      )
      .then(() => {
...
export const setIsEnabled = payloadParamActionCreator(
  ADVANCED_SEARCH_SET_IS_ENABLED
);

// Actions related to re-indexing
export const ADVANCED_SEARCH_TRIGGER_RE_INDEX =
...
export const ADVANCED_SEARCH_RE_INDEX_FAILED =
  'ADVANCED_SEARCH_RE_INDEX_FAILED';
const advancedSearchReindexFailed = payloadParamActionCreator(
  ADVANCED_SEARCH_RE_INDEX_FAILED
);

export const ADVANCED_SEARCH_POLL_STATE_SUCCESS =
  'ADVANCED_SEARCH_POLL_STATE_SUCCESS';
const pollStateSuccess = payloadParamActionCreator(
  ADVANCED_SEARCH_POLL_STATE_SUCCESS
);
export const ADVANCED_SEARCH_POLL_STATE_FAILED =
  'ADVANCED_SEARCH_POLL_STATE_FAILED';
const pollStateFailed = payloadParamActionCreator(
  ADVANCED_SEARCH_POLL_STATE_FAILED
);
