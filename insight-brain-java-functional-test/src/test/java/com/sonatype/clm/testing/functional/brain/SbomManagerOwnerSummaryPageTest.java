    ...
    extends AbstractFunctionalTest
{
      ...
      int organizationAmount)
  {
    ...
    isSbomManagerPage();
    orgsAndPoliciesSidebar.getApplicationList().children().shouldHaveSize(applicationAmount);
    orgsAndPoliciesSidebar.getOrganizationList().children().shouldHaveSize(organizationAmount);
  }
}
