...
-- version, and then manually modified to make changes on the order of the columns for
-- the table repository_manager, so we can exercise the test to ensure we can detect differences between schemas.
--
-- To be more precise, this dump was created from a tenant where we had the next schema versions for the different data stores.
--  | Data Store                      | Version |
--  | insight_brain_third_party_scans | 13      |
--  | insight_brain_aggregation       | 13      |
--  | insight_brain_ods               | 306     |
--
-- -- IMPORTANT NOTES:
...
CREATE TABLE t_TENANT.repository_manager (
                                             ...
                                             name_lowercase_no_whitespace character varying(200) DEFAULT NULL::character varying,
...
--
-- Name: repository_manager repository_manager_name_uk; Type: CONSTRAINT; Schema: t_TENANT; Owner: testuser
--

ALTER TABLE ONLY t_TENANT.repository_manager
    ADD CONSTRAINT repository_manager_name_uk UNIQUE (name_lowercase_no_whitespace);
...
INSERT INTO t_TENANT.schema_version (data_store_id, schema_version) VALUES ('insight_brain_ods', 306);
