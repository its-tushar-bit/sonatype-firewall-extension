...
describe('ComponentWaiversPopover', function () {
  ...
  it('renders a ComponentWaiversTableRow per each waiver', () => {
    ...
    expect(cellsRow1.length).toBe(6);
    ...
    assertDeleteWaiverBtn(cellsRow1.at(5), minimalProps.waivers[0]);

    const row2 = rows.at(1).dive().find(NxTableRow);
    const cellsRow2 = row2.find(NxTableCell);
    expect(cellsRow2.length).toBe(6);
    ...
    expect(cellsRow2.at(4).dive()).toHaveText('Some comment');
    assertDeleteWaiverBtn(cellsRow2.at(5), minimalProps.waivers[1]);

    const row3 = rows.at(2).dive().find(NxTableRow);
    const cellsRow3 = row3.find(NxTableCell);
    expect(cellsRow3.length).toBe(6);
    ...
    expect(cellsRow3.at(4).dive()).toHaveText('- -');
    assertDeleteWaiverBtn(cellsRow3.at(5), minimalProps.waivers[2]);
  });
});
