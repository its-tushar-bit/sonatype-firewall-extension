...
export const LEGAL_DASHBOARD_FETCH_SAVE_FILTERS_FULFILLED =
  'LEGAL_DASHBOARD_FETCH_SAVE_FILTERS_FULFILLED';
export const LEGAL_DASHBOARD_FETCH_SAVED_FILTERS_FAILED =
  'LEGAL_DASHBOARD_FETCH_SAVED_FILTERS_FAILED';
export const LEGAL_DASHBOARD_SAVE_FILTER_REQUESTED =
  'LEGAL_DASHBOARD_SAVE_FILTER_REQUESTED';
export const LEGAL_DASHBOARD_SAVE_FILTER_FULFILLED =
  'LEGAL_DASHBOARD_SAVE_FILTER_FULFILLED';
export const LEGAL_DASHBOARD_SAVE_FILTER_FAILED =
  'LEGAL_DASHBOARD_SAVE_FILTER_FAILED';
export const LEGAL_DASHBOARD_SELECT_FILTER_TO_DELETE =
  'LEGAL_DASHBOARD_SELECT_FILTER_TO_DELETE';
export const LEGAL_DASHBOARD_HIDE_DELETE_FILTER_MODAL =
  'LEGAL_DASHBOARD_HIDE_DELETE_FILTER_MODAL';
export const LEGAL_DASHBOARD_DELETE_FILTER_REQUESTED =
  'LEGAL_DASHBOARD_DELETE_FILTER_REQUESTED';
export const LEGAL_DASHBOARD_DELETE_FILTER_FULFILLED =
  'LEGAL_DASHBOARD_DELETE_FILTER_FULFILLED';
export const LEGAL_DASHBOARD_DELETE_FILTER_FAILED =
  'LEGAL_DASHBOARD_DELETE_FILTER_FAILED';
export const LEGAL_DASHBOARD_TOGGLE_FILTERS_DROPDOWN =
  'LEGAL_DASHBOARD_TOGGLE_FILTERS_DROPDOWN';
export const LEGAL_DASHBOARD_DOCUMENT_CLICKED =
  'LEGAL_DASHBOARD_DOCUMENT_CLICKED';
export const LEGAL_DASHBOARD_SAVE_FILTER_OVERWRITE_REQUESTED =
  'LEGAL_DASHBOARD_SAVE_FILTER_OVERWRITE_REQUESTED';
export const LEGAL_DASHBOARD_SAVE_DUPLICATE_FILTER_REQUESTED =
  'LEGAL_DASHBOARD_SAVE_DUPLICATE_FILTER_REQUESTED';
export const LEGAL_DASHBOARD_SAVE_CONFIRM_CANCELLED =
...
export const toggleFiltersDropdown = payloadParamActionCreator(
  LEGAL_DASHBOARD_TOGGLE_FILTERS_DROPDOWN
);
export const handleDocumentClick = noPayloadActionCreator(
  LEGAL_DASHBOARD_DOCUMENT_CLICKED
);
