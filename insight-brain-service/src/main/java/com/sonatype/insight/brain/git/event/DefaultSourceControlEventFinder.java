...
@Named
@Singleton
public class DefaultSourceControlEventFinder implements SourceControlEventFinder
{
  private final SourceControlEventDAO sourceControlEventDAO;

  @Inject
  public DefaultSourceControlEventFinder(SourceControlEventDAO sourceControlEventDAO) {
