...
public class DataStoreTest
{
  ...
  public void testStoreObject() throws IOException {
    final String data = "{ \"license\" : \"EPL\", \"coords\" : { \"groupId\" : \"some\", \"artifactId\" : \"example\", \"version\" : \"0.1\" } }";
  ...
  @Test
  public void testStoreArray() throws IOException {
  ...
  @Test
  public void testAugmentData() throws IOException {
    final String table = "[ { \"id\" : \"one\" }, { \"id\" : \"two\" }, { \"id\" : \"three\" } ]";

    final String additions = "[ { \"data\" : [ { \"modified\" : \"true\", \"id\" : \"three\" } ] }, { \"data\" : [ { \"id\" : \"one\", \"count\" : 42 } ] } ]";

    final String result = "[ { \"id\" : \"one\", \"count\" : 42 }, { \"id\" : \"two\" }, { \"id\" : \"three\", \"modified\" : \"true\" } ]";

    JsonUtils.write(file, JsonUtils.parse(additions.getBytes("UTF-8")));

    final byte[] buf = JsonUtils.generate(store.augment(JsonUtils.parse(table.getBytes("UTF-8")), file.getName()));

    assertThat(new String(buf, "UTF-8"), equalToIgnoringWhiteSpace(result));
  }

  @Test
  public void testAugmentAAData() throws IOException {
    final String table = "{ \"aaData\" : [ { \"id\" : \"one\" }, { \"id\" : \"two\" }, { \"id\" : \"three\" } ] }";

    final String additions = "[ { \"data\" : [ { \"modified\" : \"true\", \"id\" : \"three\" } ] }, { \"data\" : [ { \"id\" : \"one\", \"count\" : 42 } ] } ]";

    final String result = "{ \"aaData\" : [ { \"id\" : \"one\", \"count\" : 42 }, { \"id\" : \"two\" }, { \"id\" : \"three\", \"modified\" : \"true\" } ] }";
  ...
  @Test
  public void testAugmentNestedData() throws IOException {
    final String table = "[ { \"outer\" : { \"inner\" : { \"A\" : \"1\", \"B\" : \"2\" } } } ]";

    final String additions = "[ { \"data\" : [ { \"outer\" : { \"inner\" : { \"B\" : \"2\", \"level\" : 3 }, \"level\" : 2 }, \"level\" : 1 } ] } ]";

    final String result = "[ { \"outer\" : { \"inner\" : { \"A\" : \"1\", \"B\" : \"2\", \"level\" : 3 }, \"level\" : 2 }, \"level\" : 1 } ]";
  ...
  @Test
  public void testAugmentDataOnlyAppliedToFirstMatchingRow() throws IOException {
