...
describe('repository.policy.violations.service', function () {
  beforeEach(angular.mock.module('component.information.panel', function($provide) {
    var component = {
      componentIdentifier: {
        groupId: 'tomcat',
        artifactId: 'catalina',
  ...
  it('success', inject(function ($httpBackend, PolicyViolations, SelectedComponent) {
    ...
    $httpBackend.expectGET(SpecUtil.toRegExp(window.CLM.path + 'rest/repositories/repository-id/report/policyThreat/'
