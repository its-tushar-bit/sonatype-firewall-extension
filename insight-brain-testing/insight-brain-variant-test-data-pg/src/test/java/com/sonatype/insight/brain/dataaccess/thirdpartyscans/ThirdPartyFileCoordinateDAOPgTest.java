...
/**
 * PostgreSQL-backed tests relocated from {@link ThirdPartyFileCoordinateDAOTest} (CLM-45228).
 */
@PostgresTest
public class ThirdPartyFileCoordinateDAOPgTest
    extends AbstractDbDAOTest
{
  ...
  private void testDeleteByThirdPartyFileId() {
  ...
  private void testDelete_Cascade() {
    final ThirdPartyFile thirdPartyFile = tempEntity.newThirdPartyFile();
  ...
  private void testInsertBatch_generatesIdsAndDisplayNames() {
    final ThirdPartyFile thirdPartyFile = tempEntity.newThirdPartyFile();
  ...
  private void testInsertBatch_normalizesBlankOccurrencesAndFilenamesColumnsToNull() {
    final ThirdPartyFile thirdPartyFile = tempEntity.newThirdPartyFile();
