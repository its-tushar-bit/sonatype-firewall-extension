...
(function() {
    ...
    return {
      create: function() {
        ...
        brew.colorSchemes.SonatypeBlues = {
          ...
          6: ['rgb(218,231,241)', 'rgb(181,205,223)', 'rgb(142,179,208)', 'rgb(100,151,190)', 'rgb(67,117,155)', 'rgb(43,74,98)'],
          7: ['rgb(222,233,242)', 'rgb(190,212,228)', 'rgb(157,189,214)', 'rgb(121,165,198)', 'rgb(83,139,183)', 'rgb(63,108,143)', 'rgb(40,69,91)'],
  ...
  angular.module('dashboard.utils').factory('ClassyBrew', ClassyBrew);
}());
