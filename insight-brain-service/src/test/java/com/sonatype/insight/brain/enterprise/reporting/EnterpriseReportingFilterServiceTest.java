    ...
    extends AbstractComponentTest
{
  ...
  @Test
  public void testUpsertFilterForCurrentUser__createFilter() {
  ...
  @Test
  public void testUpsertFilterForCurrentUser__createFilterAndDefault() {
    String userId = getUserId();  
    assertThat(enterpriseReportingDefaultFilterDAO.getDefaultFilterByUserId(userId)).isNull();
  ...
  @Test
  public void testUpsertFilterForCurrentUser__updateFilter() {
    String userId = getUserId();
    var request = new EnterpriseReportingDashboardFilterDTO(null, "My Filter", "{\"k\":1}", false);
    var expectedFilter = enterpriseReportingFilterService.upsertFilterForCurrentUser(request);
  ...
  @Test
  public void testUpsertFilterForCurrentUser__updateFilterAndDefault() {
    var request = new EnterpriseReportingDashboardFilterDTO(null, "My Filter", "{\"k\":1}", false);
    var expectedFilter = enterpriseReportingFilterService.upsertFilterForCurrentUser(request);
  ...
  @Test
  public void testGetFiltersForCurrentUser() {
  ...
  @Test
  public void testDeleteFilterForCurrentUser() {
    String userId = getUserId();
  ...
  @Test
  public void testGetDefaultFilterForCurrentUser() {
  ...
  @Test
  public void testSetDefaultFilterForCurrentUser__createDefault() {
  ...
  @Test
  public void testSetDefaultFilterForCurrentUser__updatesDefault() {
  ...
  @Test
  public void testSetDefaultFilterForCurrentUser__sameIdTwiceWithNoError() {
    var filter = enterpriseReportingFilterService.upsertFilterForCurrentUser(
  ...
  @Test
  public void testDeleteDefaultFilter() {
    var filter = enterpriseReportingFilterService.upsertFilterForCurrentUser(
        new EnterpriseReportingDashboardFilterDTO(null, "Filter 1", "{\"a\":1}", true));
    String userId = getUserId();
  ...
  @Test
  public void testDeleteDefaultFilter__removedByCascade() {
    var filter = enterpriseReportingFilterService.upsertFilterForCurrentUser(
            new EnterpriseReportingDashboardFilterDTO(null, "Filter 1", "{\"a\":1}", true));
    String userId = getUserId();
  ...
  private String getUserId() {
    return userDAO.getByUsernameNotNull(USERNAME).getId();
  }
