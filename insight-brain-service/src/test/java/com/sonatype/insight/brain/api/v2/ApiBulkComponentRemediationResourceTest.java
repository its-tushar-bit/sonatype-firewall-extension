...
public class ApiBulkComponentRemediationResourceTest
    extends AbstractResourceTest
{
  ...
  @Test
  public void testBulk_HappyPath_TwoComponents_TwoResults() throws Exception {
  ...
  @Test
  public void testBulk_PartialSuccess_OneBadComponentDoesNotFailTheBatch() throws Exception {
    mockComponentSummary(MAVEN_COORDINATES_V1, ComponentSummary.create(true));
    mockGetDependencies(new ComponentDependenciesDTO(new HashMap<>(), new HashMap<>()));
    createPolicyWithSecurityVulnerabilityConstraint(app.getId());
  ...
  @Test
  public void testBulk_EmptyRequest_ReturnsBadRequest() throws Exception {
    ApiBulkComponentRemediationRequestDTO request = new ApiBulkComponentRemediationRequestDTO();
  ...
  @Test
  public void testBulk_InvalidStageId_FailsWholeBatch() throws Exception {
  ...
  @Test
  public void testBulk_RepositoryOwnerWithScanIdAndNoStageId_ReturnsBadRequest() throws Exception {
  ...
  @Test
  public void testBulk_NullComponentsField_ReturnsBadRequest() throws Exception {
  ...
  @Test
  public void testBulk_NullElementInComponentsList_ReportedAsPerItemError() throws Exception {
  ...
  @Test
  public void testBulk_ExceedsMaxBatchSize_ReturnsBadRequest() throws Exception {
  ...
  @Test
  public void testBulk_MultipleBadItemsScattered_ResultsInOrder() throws Exception {
  ...
  @Test
  public void testBulk_PurlOnlyComponent_Works() throws Exception {
    mockComponentSummary(MAVEN_COORDINATES_V1, ComponentSummary.create(true));
    mockGetDependencies(new ComponentDependenciesDTO(new HashMap<>(), new HashMap<>()));
    createPolicyWithSecurityVulnerabilityConstraint(app.getId());
