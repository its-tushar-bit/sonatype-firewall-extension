...
/**
 * H2 port of {@code ArtifactoryRepositoryResourceAuditTest} plus every {@code @Test} inherited (via
 * {@code AbstractRepositoryResourceAuditTest}) from the legacy JUnit4 base classes.
 */
@IqH2Test
class IqH2ArtifactoryRepositoryResourceAuditTest
