...
describe('source.control.tile.spec', function() {
  ...
  beforeEach(inject(function(_$rootScope_, $injector, _$componentController_, _$q_) {
    ...
    mockSourceControlService.getProviderTypesMap.and.returnValue({'github': 'GitHub'});
  ...
  describe('load root organization', function() {
    ...
    it('sets the source control and does not report an error for the sub organization', function() {
      getByIdDeferred.resolve({name: 'rootOrganizationName', id: ROOT_ORGANIZATION_ID});
      loadProductFeaturesDefer.resolve({});
      getSourceControlDeferred.resolve({provider: 'github', token: {value: 'TOKEN'}});
    ...
    it('reloads on broadcasted owner summary reload event', function() {
      ...
      getByIdDeferred.resolve({name: 'organizationNameUpdated', id: ROOT_ORGANIZATION_ID});
  ...
  describe('load sub organization', function() {
    ...
    it('loads source control and provides correct text if provider is defined and nothing to inherit', function() {
      getByIdDeferred.resolve({name: 'subOrganizationName', id: SUB_ORGANIZATION_ID});
      loadProductFeaturesDefer.resolve({});
      getSourceControlDeferred.resolve({provider: 'github', token: {value: null, parentName: null, parentValue: null}});
    ...
    it('loads source control and provides correct text if provider is defined and inherited value', function() {
      ...
      getSourceControlDeferred.resolve(
          {provider: 'github', token: {value: null, parentName: 'Root Organization', parentValue: 'token'}});
    ...
    it('loads source control and provides correct text if provider is defined and token specified', function() {
      ...
      loadProductFeaturesDefer.resolve({});
      getSourceControlDeferred.resolve(
          {provider: 'github', token: {value: 'token', parentName: 'Root Organization', parentValue: 'token'}});
  ...
  describe('load application', function() {
    ...
    it('loads source control and provides correct text if provider is defined and has url', function() {
      ...
      loadProductFeaturesDefer.resolve({});
      getSourceControlDeferred.resolve(
          {provider: 'github', token: {value: null, parentName: null, parentValue: null}, repositoryUrl: 'url'});
