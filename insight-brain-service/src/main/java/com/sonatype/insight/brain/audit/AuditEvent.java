...
public enum AuditEvent
{
  ...
  ADD_ACTIONS_OVERRIDE(Domain.GOVERNANCE_POLICY_ACTIONS_OVERRIDES, Type.ADD),
  REMOVE_ACTIONS_OVERRIDE(Domain.GOVERNANCE_POLICY_ACTIONS_OVERRIDES, Type.REMOVE),
  ...
  interface Domain
  {
    ...
    String GOVERNANCE_POLICY_ACTIONS_OVERRIDES = join(GOVERNANCE_POLICY, "actions-overrides");
