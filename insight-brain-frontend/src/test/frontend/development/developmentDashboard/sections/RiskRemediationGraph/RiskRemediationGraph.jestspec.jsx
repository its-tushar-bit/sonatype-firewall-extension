...
import RiskRemediationGraph from 'MainRoot/development/developmentDashboard/sections/Graphs/RiskRemediationGraph';
...
describe('RiskRemediationGraph', () => {
  ...
  it('should render a graph', async () => {
    ...
    expect(screen.getByRole('heading', { name: /risk and remediation/i })).toBeInTheDocument();
