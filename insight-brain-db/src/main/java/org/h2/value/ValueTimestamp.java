...
// patched version from H2 1.4.196 that fixes https://github.com/h2database/h2database/issues/551
    ...
    extends Value
{
  ...
  public static ValueTimestamp fromMillisNanos(long ms, int nanos) {
    long dateValue = DateTimeUtils.dateValueFromDate(ms);
    // BEGIN PATCH
    long timeNanos = nanos % 1_000_000 + DateTimeUtils.nanosFromDate(ms);
    // END PATCH
