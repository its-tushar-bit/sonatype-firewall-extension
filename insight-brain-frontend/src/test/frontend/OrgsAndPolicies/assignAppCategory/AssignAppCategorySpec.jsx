...
describe('Assign Application Categories Component', () => {
  ...
  beforeEach(() => {
    assignApplicableCategoriesLoadingSpy = spyOn(
      assignAppCategoriesSelectors,
      'selectLoadingApplicableCategories'
    ).and.returnValue(false);
    assignApplicableCategoriesLoadErrorSpy = spyOn(
      assignAppCategoriesSelectors,
    ...
    selectCategoriesSpy = spyOn(assignAppCategoriesSelectors, 'selectCategories').and.returnValue([
      {
        color: 'dark-red',
    ...
    assignAppCategoriesUpdateSpy = spyOn(actions, 'updateAppliedCategories').and.callThrough();
    assignAppCategoriesSaveSpy = spyOn(actions, 'saveAppliedCategories').and.callThrough();
    saveMaskTimerDoneSpy = spyOn(actions, 'saveMaskTimerDone').and.callThrough();
    loadApplicableCategoriesSpy = spyOn(actions, 'loadApplicableCategories').and.returnValue({
  ...
  it('renders loading indicator', () => {
    assignApplicableCategoriesLoadingSpy.and.returnValue(true);
    assignApplicableCategoriesLoadErrorSpy.and.returnValue(null);
    renderComponent();
    expect(screen.getByText('Loading…')).toBeVisible();
  });

  it('renders error message', () => {
    assignApplicableCategoriesLoadingSpy.and.returnValue(null);
    assignApplicableCategoriesLoadErrorSpy.and.returnValue(true);
    renderComponent();
  ...
  it('updates categories when clicked', () => {
    selectCategoriesSpy.and.returnValue([
      {
        color: 'dark-red',
