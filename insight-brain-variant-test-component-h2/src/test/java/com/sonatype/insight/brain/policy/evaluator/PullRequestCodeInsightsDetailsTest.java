    ...
    extends AbstractComponentH2Test
{
  ...
  private static Stream<String> repositoryUrls() {
    ...
    return Stream.of(bitbucketCloudRepoUrl, bitbucketServerRepoUrl);
  }
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_addedOnly(String repositoryUrl) throws Exception {
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_addedOnly_OutcomePass(String repositoryUrl) throws Exception {
    this.repositoryUrl = repositoryUrl;
    // setup test data
    setupTestData();
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_addedOnly_SourceLocationUnknown(String repositoryUrl) throws Exception {
    this.repositoryUrl = repositoryUrl;
    setupTestData();
    createTestData_Policies(false);
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_clearedOnly(String repositoryUrl) throws Exception {
    this.repositoryUrl = repositoryUrl;
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_addedAndCleared(String repositoryUrl) throws Exception {
    this.repositoryUrl = repositoryUrl;
    setupTestData();
    createTestData_Policies(true);
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_noAddedOrCleared(String repositoryUrl) throws Exception {
    this.repositoryUrl = repositoryUrl;
    // setup test data
    setupTestData();
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_singlePolicyViolationPlurality(
      String repositoryUrl) throws IOException, URISyntaxException
  {
    this.repositoryUrl = repositoryUrl;
    // setup test data
    setupTestData();
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_singleClearedViolationPlurality(
      String repositoryUrl) throws IOException, URISyntaxException
  {
    this.repositoryUrl = repositoryUrl;
    setupTestData();
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_emptyBomData(String repositoryUrl) throws IOException, URISyntaxException {
    this.repositoryUrl = repositoryUrl;
    // setup test data
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_nullBom(String repositoryUrl) throws IOException, URISyntaxException {
    this.repositoryUrl = repositoryUrl;
    setupTestData();
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_nullDiff(String repositoryUrl) throws IOException, URISyntaxException {
    this.repositoryUrl = repositoryUrl;
    setupTestData();
    assertThatExceptionOfType(NullPointerException.class).isThrownBy(() -> new PullRequestCodeInsightsDetails(
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_nullApp(String repositoryUrl) throws URISyntaxException, IOException {
    this.repositoryUrl = repositoryUrl;
    setupTestData();
    assertThatExceptionOfType(NullPointerException.class).isThrownBy(() -> new PullRequestCodeInsightsDetails(
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_nullRepoUrl(String repositoryUrl) throws URISyntaxException, IOException {
    this.repositoryUrl = repositoryUrl;
    setupTestData();
    assertThatExceptionOfType(NullPointerException.class).isThrownBy(() -> new PullRequestCodeInsightsDetails(
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_nullFeatureBranchEvaluation(
      String repositoryUrl) throws IOException, URISyntaxException
  {
    this.repositoryUrl = repositoryUrl;
    setupTestData();
  ...
  @ParameterizedTest(name = "repositoryUrl={0}")
  @MethodSource("repositoryUrls")
  public void testPullRequestCodeInsights_nullBaseUrl(String repositoryUrl) throws IOException, URISyntaxException {
    this.repositoryUrl = repositoryUrl;
    setupTestData();
    assertThatExceptionOfType(NullPointerException.class).isThrownBy(() -> new PullRequestCodeInsightsDetails(
        bitbucketGitRepositoryInfo.normalizedRepositoryUrl, app, componentDetails, featureBranchPolicyEvaluation,
