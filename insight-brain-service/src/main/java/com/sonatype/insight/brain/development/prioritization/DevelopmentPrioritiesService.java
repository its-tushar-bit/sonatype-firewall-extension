...
public class DevelopmentPrioritiesService
{
  ...
  public List<PrioritizedComponent> getPrioritizedFindings(
  ...
  )
  {
    ...
    final PolicyThreats policyThreats =
        developmentPrioritiesReportService.getPolicyThreatsNoAuth(applicationPublicId, scanId);
    ...
    // apply a priority based on position in the sort
    return addPrioritiesToSortedList(sortedComponents);
  }
  ...
  )
  {
    ...
    prioritizedComponents.add(sortedComponents.get(0).toPrioritizedComponent(1));
