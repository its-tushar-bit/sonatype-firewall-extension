...
var dateFormat = (function () {
  var k = /d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,
  ...
  return function (a, c, h) {
    ...
    var b = h ? 'getUTC' : 'get',
      ...
      r = a[b + 'Seconds'](),
      b = a[b + 'Milliseconds'](),
      m = h ? 0 : a.getTimezoneOffset(),
      s = {
        d: g,
        dd: d(g),
        ddd: f.i18n.dayNames[n],
        dddd: f.i18n.dayNames[n + 7],
        m: j + 1,
        mm: d(j + 1),
        mmm: f.i18n.monthNames[j],
        mmmm: f.i18n.monthNames[j + 12],
        yy: String(p).slice(2),
        yyyy: p,
        h: e % 12 || 12,
        hh: d(e % 12 || 12),
...
Date.prototype.format = function (k, l) {
  return dateFormat(this, k, l);
};
