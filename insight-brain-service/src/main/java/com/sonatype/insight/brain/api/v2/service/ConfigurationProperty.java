...
public class ConfigurationProperty
{
  ...
  public static final ConfigurationProperty[] PROPERTIES = new ConfigurationProperty[]{
    ...
    new ConfigurationProperty(SystemConfigurationProperty.HDS_URL, String.class,
        ...
        (p, o) -> ConfigurationUtils.urlValueToString(o)),
    new ConfigurationProperty(SystemConfigurationProperty.RELAY_URL, String.class,
        (p, s) -> ConfigurationUtils.relayUrl(ConfigurationUtils.getParameter(p, InsightConfig.class), s),
        (p, o) -> ConfigurationUtils.urlValueToString(o)),
    ...
    new ConfigurationProperty(SystemConfigurationProperty.FIREWALL_QUARANTINE_HDS_CONNECT_TIMEOUT_IN_SECONDS,
        Integer.class,
        (p, s) -> ConfigurationUtils.getFirewallQuarantineHdsConnectTimeoutInSeconds(s,
            FirewallQuarantineHdsClient.DEFAULT_CONNECT_TIMEOUT_SECONDS),
        (p, o) -> ConfigurationUtils.integerValueToString(o,
    ...
    new ConfigurationProperty(SystemConfigurationProperty.FIREWALL_QUARANTINE_HDS_SOCKET_TIMEOUT_IN_SECONDS,
        Integer.class,
        (p, s) -> ConfigurationUtils.getFirewallQuarantineHdsSocketTimeoutInSeconds(s,
            FirewallQuarantineHdsClient.DEFAULT_SOCKET_TIMEOUT_SECONDS),
        (p, o) -> ConfigurationUtils.integerValueToString(o,
    ...
    new ConfigurationProperty(SystemConfigurationProperty.CONTINUOUS_MONITORING_TICK_BATCH_SIZE, Integer.class,
        (p, s) -> NumberUtils.toInt(s, 8),
        (p, o) -> ConfigurationUtils.integerValueToString(o,
            SystemConfigurationProperty.CONTINUOUS_MONITORING_TICK_BATCH_SIZE, 1, 256)),
    new ConfigurationProperty(SystemConfigurationProperty.CONTINUOUS_MONITORING_IDLE_BACKOFF_MS, Integer.class,
        (p, s) -> NumberUtils.toInt(s, 0),
        (p, o) -> ConfigurationUtils.integerValueToString(o,
            SystemConfigurationProperty.CONTINUOUS_MONITORING_IDLE_BACKOFF_MS, 0, 10_000)),
    ...
    new ConfigurationProperty(SystemConfigurationProperty.CONTAINER_IMAGES_EVAL_ENABLED, Boolean.class,
        (p, s) -> ConfigurationUtils.parseBooleanWithDefault(s, true),
        (p, o) -> Objects.toString(o, null)),
    new ConfigurationProperty(SystemConfigurationProperty.CONSUMPTION_REPORTING_ENABLED, Boolean.class,
        (p, s) -> ConfigurationUtils.parseBooleanWithDefault(s, false),
        (p, o) -> Objects.toString(o, null)),
    ...
    new ConfigurationProperty(SystemConfigurationProperty.WARN_ON_NON_PRIMARY_STORAGE_ACCESS, Boolean.class,
        (p, s) -> ConfigurationUtils.parseBooleanWithDefault(s, false),
        (p, o) -> Objects.toString(o, null)),
    new ConfigurationProperty(SystemConfigurationProperty.SOURCE_CONTROL_CLONE_DIRECTORY_ON_CLUSTER_STORAGE,
        Boolean.class,
        (p, s) -> ConfigurationUtils.parseBooleanWithDefault(s, false),
        (p, o) -> Objects.toString(o, null)),
