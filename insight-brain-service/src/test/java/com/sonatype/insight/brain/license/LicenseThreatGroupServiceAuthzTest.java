    ...
    extends AbstractServiceAuthzTest
{
  ...
  public void testGetLicenseThreatGroupsForApplication_Authorized() throws Exception {
    ...
    licenseThreatGroupService.getLicenseThreatGroups(IdUtils.TYPE_APPLICATION, app.getPublicId());
  }

  @Test
  public void testGetLicenseThreatGroupsForOrganization_Authorized() throws Exception {
    grantReadPermission(org.getId());
    licenseThreatGroupService.getLicenseThreatGroups(IdUtils.TYPE_ORGANIZATION, org.getId());
  }
  ...
  public void testGetApplicableLicenseThreatGroupsForApplication_Authorized() throws Exception {
    grantReadPermission(app.getId());
    licenseThreatGroupService.getApplicableLicenseThreatGroups(IdUtils.TYPE_APPLICATION, app.getPublicId());
  }

  @Test
  public void testGetApplicableLicenseThreatGroupsForOrganization_Authorized() throws Exception {
    grantReadPermission(org.getId());
    licenseThreatGroupService.getApplicableLicenseThreatGroups(IdUtils.TYPE_ORGANIZATION, org.getId());
  }
  ...
  public void testAddLicenseThreatGroupForApplication_Authorized() throws Exception {
    ...
    licenseThreatGroupService.addLicenseThreatGroup(IdUtils.TYPE_APPLICATION, app.getPublicId(),
  ...
  public void testAddLicenseThreatGroupForOrganization_Authorized() throws Exception {
    ...
    licenseThreatGroupService.addLicenseThreatGroup(IdUtils.TYPE_ORGANIZATION, org.getId(),
        new LicenseThreatGroup(null, "Test LTG", 5));
  }

  @Test(expected = UnauthenticatedException.class)
  public void testAddLicenseThreatGroupForApplication_Unauthenticated() throws Exception {
    licenseThreatGroupService.addLicenseThreatGroup(IdUtils.TYPE_APPLICATION,
  ...
  public void testUpdateLicenseThreatGroupForApplication_Authorized() throws Exception {
    ...
    licenseThreatGroupService.updateLicenseThreatGroup(IdUtils.TYPE_APPLICATION, app.getPublicId(), licenseThreatGroup);
  }
  ...
  public void testUpdateLicenseThreatGroupForOrganization_Authorized() throws Exception {
    ...
    licenseThreatGroupService.updateLicenseThreatGroup(IdUtils.TYPE_ORGANIZATION, org.getId(), licenseThreatGroup);
  }

  @Test(expected = UnauthenticatedException.class)
  public void testUpdateLicenseThreatGroupForApplication_Unauthenticated() throws Exception {
    LicenseThreatGroup licenseThreatGroup = tempEntity.newLicenseThreatGroup(app.getId());
    licenseThreatGroupService.updateLicenseThreatGroup(IdUtils.TYPE_APPLICATION, app.getPublicId(),
        licenseThreatGroup);
  }
  ...
  public void testDeleteLicenseThreatGroupForApplication_Authorized() throws Exception {
    ...
    licenseThreatGroupService.deleteLicenseThreatGroup(IdUtils.TYPE_APPLICATION, app.getPublicId(), ltg.getId());
  }
  ...
  public void testDeleteLicenseThreatGroupForOrganization_Authorized() throws Exception {
    ...
    licenseThreatGroupService.deleteLicenseThreatGroup(IdUtils.TYPE_ORGANIZATION, org.getId(), ltg.getId());
  }
