...
@Named
@Singleton
public class DefaultPolicyAlertScmNotifier implements PolicyAlertScmNotifier
{
  private static final Logger log = LoggerFactory.getLogger(DefaultPolicyAlertScmNotifier.class);
   ...
   */
  @Inject
  public DefaultPolicyAlertScmNotifier(
