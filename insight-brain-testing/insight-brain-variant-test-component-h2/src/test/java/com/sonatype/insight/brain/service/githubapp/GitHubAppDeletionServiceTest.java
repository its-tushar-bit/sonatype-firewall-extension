    ...
    extends AbstractComponentH2Test
{
  ...
  private final WireMockServer githubMockServer = new WireMockServer(wireMockConfig().dynamicPort());
  ...
  public void setUp() throws Exception {
    ...
    configureFor(githubMockServer.port());
  ...
  @AfterEach
  public void stopGithubMockServer() {
