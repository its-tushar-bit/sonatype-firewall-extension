...
const createItem = (licenseFile, index) => {
  return <div className="legal-file" key={ index }>
    <span className="legal-file-path">{ licenseFile.relPath }</span>
    <span className="nx-tile__actions">
      <a href="">View More Details <NxFontAwesomeIcon icon={ faChevronRight }/></a>
    </span>
    <blockquote className="legal-file-content">{ licenseFile.content }</blockquote>
  </div>;
};
