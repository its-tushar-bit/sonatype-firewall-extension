...
describe('SidebarNavViolationList', function () {
  let minimalProps, onClickSpy, SidebarNavViolationList, getShallowComponent;

  beforeEach(function () {
    SidebarNavViolationList = require('inject-loader!../../../main/frontend/sidebarNav/SidebarNavViolationList')()
      .default;
