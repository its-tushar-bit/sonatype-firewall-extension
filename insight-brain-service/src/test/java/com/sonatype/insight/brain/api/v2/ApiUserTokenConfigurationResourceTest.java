...
public class ApiUserTokenConfigurationResourceTest
    extends AbstractResourceTest
{
  ...
  protected HttpRequest restRequest() {
    return super.restRequest().path(PublicApiPaths.USER_TOKEN_CONFIG_RESOURCE_PATH_V2);
  }

  @Before
  public void setUp() {
    configService = lookup(ApiConfigurationService.class);
  }
  ...
  @Test
  public void testGetConfiguration_Configured() throws Exception {
  ...
  @Test
  public void testUpdateConfiguration_ValidValue() throws Exception {
  ...
  @Test
  public void testUpdateConfiguration_BelowMinimum() throws Exception {
  ...
  @Test
  public void testUpdateConfiguration_AboveMaximum() throws Exception {
  ...
  @Test
  public void testUpdateConfiguration_NullValue() throws Exception {
  ...
  @Test
  public void testResetConfiguration_ValidProperty() throws Exception {
  ...
  @Test
  public void testResetConfiguration_InvalidProperty() throws Exception {
    HttpResponse response = restRequest()
