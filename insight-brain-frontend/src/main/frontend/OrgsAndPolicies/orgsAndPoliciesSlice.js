...
import automatedWaiversRevocationsSlice from 'MainRoot/OrgsAndPolicies/automatedWaiversRevocationsSlice';
...
export default combineReducers({
  ...
  autoWaiverRevocations: automatedWaiversRevocationsSlice,
});
