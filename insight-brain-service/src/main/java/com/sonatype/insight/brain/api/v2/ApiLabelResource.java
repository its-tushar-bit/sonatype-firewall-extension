...
public class ApiLabelResource
{
  ...
  public List<ApiLabelDTO> getLabels(
      ...
      @Parameter(description = "Set to `true` to retrieve inherited component labels.")
  ...
  @Operation(description = "Use this method to retrieve all component labels that are applicable to the specified " +
      ...
      responses = {
          @ApiResponse(responseCode = "200",
              description =
                  "The response contains descriptions for all component labels that are applicable to the specified " +
  ...
  public ApplicableLabels getApplicableLabels(
      @Parameter(description = "Select the ownerType to retrieve the component label information for.", required = true)
      @PathParam("ownerType") OwnerType ownerType,
      @Parameter(description = "Enter the id for the application, organization or repository", required = true)
      @PathParam("ownerId") String ownerId)
  {
  ...
  public ApplicableContext getApplicableContexts(
      ...
      @PathParam("ownerType") OwnerType ownerType,
      @Parameter(description = "Enter the ownerId")
      @PathParam("ownerId") String ownerId,
      @Parameter(description = "Enter the labelId")
  ...
  public ApiLabelDTO addLabel(
      @Parameter(description = "Select the ownerType to which the label will be assigned.")
      @PathParam("ownerType") OwnerType ownerType,
      @Parameter(description = "Enter the id for the selected ownerType.")
      @PathParam("ownerId") String ownerId,
      @RequestBody(description = "Specify a label name, description and color for the label. Valid values for " +
          ...
          "`dark-blue` , `dark-purple` , `orange` , `yellow`. Do not enter value for the `id` field.")
  ...
  public ApiLabelDTO updateLabel(
      @Parameter(description = "Select the ownerType for which the label will be updated.")
      @PathParam("ownerType") OwnerType ownerType,
      @Parameter(description = "Enter the id for the selected ownerType.")
      @PathParam("ownerId") String ownerId,
  ...
  public void deleteLabel(
      @Parameter(description = "Select the ownerType for which the label will be deleted.")
      @PathParam("ownerType") OwnerType ownerType,
      @Parameter(description = "Enter the id for the selected ownerType.")
      @PathParam("ownerId") String ownerId,
      @Parameter(description = "Enter the id for the label to be deleted.")
      @PathParam("labelId") String labelId)
  {
