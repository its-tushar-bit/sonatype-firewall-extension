...
public enum AuditEvent
{
  ...
  SAVE_VULNERABILITY_CUSTOM_DETAIL(Domain.GOVERNANCE_VULNERABILITY_CUSTOM_DETAIL, Type.SAVE),
  ...
  DELETE_VULNERABILITY_CUSTOM_DETAIL(Domain.GOVERNANCE_VULNERABILITY_CUSTOM_DETAIL, Type.DELETE),
  ...
  interface Domain
  {
    ...
    String GOVERNANCE_VULNERABILITY_CUSTOM_DETAIL = join(GOVERNANCE, "vulnerability-custom-detail");
