describe('ManagementModule', function() {
  ...
  describe('OwnerTreeViewController', function() {
    ...
    function setupRequests(showRepository) {
      inject(function ($timeout) {
        ...
        $httpBackend.expectPUT('/rest/user/permissions/repository_container').respond(showRepository ? ['READ'] : []);
        scope.$digest();
        $httpBackend.flush();
        $timeout.flush();
      });
    ...
    describe('showRepositories', function () {
      it('has read', function () {
        setupRequests(true);
        expect(scope.showRepositories).toBeTruthy();
      });

      it('missing read', function () {
        setupRequests(false);
        expect(scope.showRepositories).toBeFalsy();
      });
    });

    describe('apps & orgs', function () {
      beforeEach(function () {
        setupRequests(true);
      });
