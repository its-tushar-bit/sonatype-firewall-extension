    ...
    extends AbstractComponentTest
{
  ...
  public void testGetPolicyViolations_filteredByPolicyId() {
    ...
    ApiApplicationViolationDTO apiApplicationViolationDTO1 = apiApplicationViolationListDTO.applicationViolations
        .get(0);
    ApiApplicationViolationDTO apiApplicationViolationDTO2 = apiApplicationViolationListDTO.applicationViolations
        .get(1);
  ...
  private void assertPolicyViolation(ApiApplicationViolationDTO apiApplicationViolationDTO, PolicyData appPolicyData) {
    ...
    ApiPolicyViolationDTO apiPolicyViolationDTO2 = apiApplicationViolationDTO.policyViolations.get(1);
      ...
      PolicyEvaluation policyEvaluation, PolicyViolation policyViolation)
  {
    ...
    assertThat(apiPolicyViolationDTO.mavenComponent.groupId, is(policyViolation.getGroupId()));
    assertThat(apiPolicyViolationDTO.mavenComponent.artifactId, is(policyViolation.getArtifactId()));
    assertThat(apiPolicyViolationDTO.mavenComponent.version, is(policyViolation.getVersion()));
