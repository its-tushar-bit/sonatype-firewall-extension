...
describe('DeleteWaiverModalContainer', function() {
  ...
  beforeEach(function() {
    ...
    DeleteWaiverModalContainer =
      require('inject-loader!../../../../main/frontend/waivers/deleteWaiverModal/DeleteWaiverModalContainer')({
        '../waiverActions': {
  ...
  it('renders DeleteWaiverModal component', function() {
    ...
    expect(deleteWaiverModalComponent).toHaveProp('waiverToDelete', { waiverId: 'foo' });
  });
});
