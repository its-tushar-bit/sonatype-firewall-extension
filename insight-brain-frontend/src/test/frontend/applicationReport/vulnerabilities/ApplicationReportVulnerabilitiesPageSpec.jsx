...
import ApplicationReportVulnerabilitiesTable from
  '../../../../main/frontend/applicationReport/vulnerabilities/ApplicationReportVulnerabilitiesTable';
import ApplicationReportVulnerabilitiesPage from
  '../../../../main/frontend/applicationReport/vulnerabilities/ApplicationReportVulnerabilitiesPage';
...
describe('ApplicationReportVulnerabilitiesPage', function() {
  ...
  it('sets the LoadWrapper\'s error if vulnerabilitiesPageEnabled is not true', function() {
    expect(getShallowComponent({ vulnerabilitiesPageEnabled: false }).find(LoadWrapper))
