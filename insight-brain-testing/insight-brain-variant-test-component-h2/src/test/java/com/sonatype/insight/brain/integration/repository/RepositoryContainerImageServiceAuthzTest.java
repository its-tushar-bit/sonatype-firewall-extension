    ...
    extends AbstractComponentH2AuthzTest
{
  ...
  public void testIsContainerImageQuarantined_unauthenticated() {
    assertThrows(UnauthenticatedException.class,
        () -> service.isContainerImageQuarantined(repositoryManager.getInstanceId(), repository.getName(),
            "test-image"));
  }
  ...
  public void testEvaluateContainerImage_unauthenticated() {
    assertThrows(UnauthenticatedException.class,
        () -> service.evaluateContainerImage(repositoryManager.getInstanceId(), repository.getName(), buildTestBom(),
            null));
  }
