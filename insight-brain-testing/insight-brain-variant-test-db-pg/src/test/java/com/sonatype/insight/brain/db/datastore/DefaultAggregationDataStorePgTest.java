...
/**
 * PostgreSQL migration check for the aggregation data store, relocated from {@code DefaultAggregationDataStoreTest}
 * (CLM-45235). The H2 coverage stays in the origin.
 */
public class DefaultAggregationDataStorePgTest
