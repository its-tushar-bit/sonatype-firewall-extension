...
/**
 * H2 port of {@code ConditionValueTypeResourceTest}.
 */
@IqH2Test
class IqH2ConditionValueTypeResourceTest
{
  ...
  private HttpRequest restRequest(OwnerType ownerType, String ownerId) {
    return ctx.restRequest().path(ConditionValueTypeResource.RESOURCE_PATH).parameter(ownerType, ownerId);
  }

  @Test
  void testGetConditionValueTypes_Application() throws Exception {
  ...
  @Test
  void testGetConditionValueTypes_Organization() throws Exception {
    String orgId = ctx.tempEntity().newOrganization("test").getId();
  ...
  @Test
  void testGetConditionValueTypes_RepositoryContainer() throws Exception {
  ...
  @Test
  void testGetConditionValueTypes_RepositoryManager() throws Exception {
    String ownerId = ctx.tempEntity().newRepositoryManager().getId();
  ...
  @Test
  void testGetConditionValueTypes_Repository() throws Exception {
    String ownerId = ctx.tempEntity().newRepository().getId();
  ...
  @Test
  void testGetConditionValueTypes_Application_CpeMatchingLicensed() throws Exception {
  ...
  @Test
  void testGetConditionValueTypes_Organization_CpeMatchingEnabled() throws Exception {
    ctx.setFeatures(LicensedFeature.CPE_MATCHING);
    String orgId = ctx.tempEntity().newOrganization("test").getId();
