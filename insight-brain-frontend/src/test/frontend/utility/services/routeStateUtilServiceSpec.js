...
describe('routeStateUtilService', function() {
  ...
  describe('stateRequiresAuthentication', function() {
    describe('when not passed a parameter', function() {
      ...
      it('returns false when the current state has a data property with authenticationRequired set to false',
          function() {
    ...
    describe('when passed a parameter', function() {
      ...
      it('returns true when the passed state has a data property with authenticationRequired set to true', function() {
        expect(getService().stateRequiresAuthentication({ data: { authenticationRequired: true } })).toBe(true);
      ...
      it('returns false when the passed state has a data property with authenticationRequired set to false',
          function() {
            expect(getService().stateRequiresAuthentication({ data: { authenticationRequired: false } })).toBe(false);
