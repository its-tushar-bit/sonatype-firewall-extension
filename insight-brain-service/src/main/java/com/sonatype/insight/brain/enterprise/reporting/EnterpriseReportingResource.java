...
public class EnterpriseReportingResource
{
  ...
  {
    String hostWithProtocol = StringUtils.substring(uriInfo.getRequestUri().resolve("/").toString(),0,-1);
    return enterpriseReportingService.acquireEmbedSession(dashboardId, hostWithProtocol, clientUserAgent);
  }
