...
describe('ChangeApplicationIdModal', () => {
  ...
  beforeEach(() => {
    changeApplicationIdStateSpy = spyOn(changeApplicationIdSelectors, 'selectChangeApplicationIdSlice').and.returnValue(
      {
        submitError: null,
        isModalOpen: true,
    ...
    newPublicIdSpy = spyOn(actions, 'setNewPublicIdValue').and.callThrough();
  ...
  it('does not render modal without being open', () => {
    changeApplicationIdStateSpy.and.returnValue({
      submitError: null,
      isModalOpen: false,
    });
    renderComponent();
