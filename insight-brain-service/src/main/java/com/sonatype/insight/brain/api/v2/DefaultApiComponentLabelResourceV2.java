...
@Named
@Timed
public class DefaultApiComponentLabelResourceV2 implements ApiComponentLabelResourceV2
{
  private final ApiComponentLabelServiceV2 apiComponentLabelService;

  @Inject
  public DefaultApiComponentLabelResourceV2(final ApiComponentLabelServiceV2 apiComponentLabelService) {
