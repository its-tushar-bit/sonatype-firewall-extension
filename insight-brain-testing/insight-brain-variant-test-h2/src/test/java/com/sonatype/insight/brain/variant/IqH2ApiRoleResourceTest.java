...
class IqH2ApiRoleResourceTest
{
  ...
  void setUp() {
    ...
    rolePermissionDAO = ctx.lookup(RolePermissionDAO.class);
  }
  ...
  void testGetRoleById() throws Exception {
    Role role = ctx.tempEntity().newRole(false, Permission.CLAIM_COMPONENT);
  ...
  @Test
  void testGetTemplateForNewRole() throws Exception {
