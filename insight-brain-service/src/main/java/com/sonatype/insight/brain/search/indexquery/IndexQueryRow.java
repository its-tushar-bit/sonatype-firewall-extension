...
/**
 * One row of an {@link IndexQueryResponse}, discriminated by {@code entityType}, with an open
 * per-type {@code fields} bag.
 */
@JsonPropertyOrder({"entityType", "source", "id", "title", "subtitle", "fields", "href"})
@JsonInclude(Include.NON_NULL)
public final class IndexQueryRow
{
  ...
  private IndexQueryRow(final Builder b) {
  ...
  public static final class Builder
  {
    ...
    public IndexQueryRow build() {
      return new IndexQueryRow(this);
    }
  }
}
