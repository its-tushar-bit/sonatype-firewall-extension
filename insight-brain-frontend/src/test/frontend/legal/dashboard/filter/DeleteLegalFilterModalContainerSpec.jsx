...
describe('DeleteLegalFilterModalContainer', function () {
  let store, DeleteLegalFilterModalContainer, DeleteFilterModalMock;
  ...
  beforeEach(function () {
    ...
    DeleteLegalFilterModalContainer = require('inject-loader!../../../../../main/frontend/legal/dashboard/filter/DeleteLegalFilterModalContainer')(
      {
