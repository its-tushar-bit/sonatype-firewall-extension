...
public class CustomCweIdModal
    extends BasicElement<CustomCweIdModal>
{
  private static final String ROOT = "#custom-cwe-id-modal";

  private static final String SCOPE_SELECT = "#cwe-scope";

  public CustomCweIdModal() {
    super(ROOT);
  }
  ...
  public static SelenideElement cweIdInput() {
    return $(ROOT + " #custom-cwe-id input");
  }

  public static SelenideElement comment() {
    return $(ROOT + " #cwe-audit-comment textarea");
  }
