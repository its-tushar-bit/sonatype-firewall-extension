...
/**
 * JUnit 5 base for the reused-context H2 component tests in {@code insight-brain-variant-test-component-h2}.
 *
 * <p>
 ...
 * exclusions (e.g. {@code SlowTest}) they rely on in CI.
 *
 * <p>
 * Converted component tests extend this instead of {@code AbstractComponentTest} and additionally carry
 * {@code @ComponentH2Test} (the DB/search/entity/Mockito harness + the DirtiesContext-listener opt-out for
 * single-context reuse).
 */
@ExtendWith(SpringExtension.class)
public abstract class AbstractComponentH2Test
