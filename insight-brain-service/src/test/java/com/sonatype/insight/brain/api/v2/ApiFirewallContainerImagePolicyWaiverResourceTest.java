    ...
    extends AbstractResourceTest
{
  ...
  public void setUp() {
    ...
    policyViolation = tempEntity.newPolicyViolation(policyEvaluation, policy, 5, PolicyThreatCategory.SECURITY,
  ...
  public void testAddWaiver() throws Exception {
    PolicyWaiverReason policyWaiverReason = tempEntity.newWaiverReason("type", "reasons");
  ...
  @Test
  public void testDeleteContainerImagePolicyWaiver() throws Exception {
  ...
  @Test
  public void testGetWaivers() throws Exception {
    Organization organization = tempEntity.newOrganization();
  ...
  @Test
  public void testGetWaivers_testPagination() throws Exception {
    Organization organization = tempEntity.newOrganization("org01");
    Policy policy = tempEntity.newPolicy(organization, 10);

    createContainerWaiver(application, policy, null, true, false);
    createContainerWaiver(application, policy, "comp01-hash1", false, true);

    Application application02 = tempEntity.newApplicationWithParent(organization);
  ...
  @Test
  public void testGetWaivers_checkPageValue() throws Exception {
    HttpResponse response = restRequest()
        .path(POLICY_WAIVER)
        .query("page", 0)
        .query("pageSize", 0)
  ...
  @Test
  public void testGetWaivers_checkPageSizeValue() throws Exception {
    HttpResponse response = restRequest()
        .path(POLICY_WAIVER)
        .query("page", 1)
        .query("pageSize", 101)
  ...
  @Test
  public void testGetWaivers_returnsEmptyList() throws Exception {
    HttpResponse response = restRequest()
        .path(POLICY_WAIVER)
        .query("page", 1)
        .query("pageSize", 10)
      ...
      final boolean forceContainerImageComponent)
  {
    ...
    tempEntity.newWaiver(waiverContainerComponent);
  }
