...
public class FirewallMetricsComponentQuarantinedConsolidatorCronJob
    implements InsightJob
{
  private static final Logger log = LoggerFactory
      .getLogger(FirewallMetricsComponentQuarantinedConsolidatorCronJob.class);

  private static final String CONSOLIDATOR_JOB_ERROR = "Error when running the " +
      " consolidation task for " + FirewallMetricsName.COMPONENTS_QUARANTINED +
      " metrics";
  ...
  private final QuarantinedComponentMetricsConsolidator consolidator;
  ...
  public void execute(JobExecutionContext context) {
    execute(this::consolidateQuarantinedComponentsMetrics,
        log, CONSOLIDATOR_JOB_ERROR);
  }

  private void consolidateQuarantinedComponentsMetrics() {
