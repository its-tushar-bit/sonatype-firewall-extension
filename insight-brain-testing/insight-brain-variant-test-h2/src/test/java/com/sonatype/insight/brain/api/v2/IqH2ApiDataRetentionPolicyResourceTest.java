...
/**
 * Kept in the original package because {@link ApiDataRetentionPolicyResource#ORGANIZATION_PATH} and
 * {@link ApiDataRetentionPolicyResource#PARENT_ORGANIZATION_PATH} are package-private.
 */
@IqH2Test
class IqH2ApiDataRetentionPolicyResourceTest
{
  ...
  @BeforeEach
  void setUp() {
    dataRetentionPolicyDAO = ctx.lookup(DataRetentionPolicyDAO.class);
  }
  ...
  @Test
  void testGetDataRetentionPolicies() throws Exception {
  ...
  @Test
  void testGetParentDataRetentionPolicies() throws Exception {
  ...
  @Test
  void testGetParentDataRetentionPolicies_BadRequest() throws Exception {
    HttpResponse response = ctx.restRequest()
        .path(PublicApiPaths.DATA_RETENTION_POLICY_RESOURCE_PATH,
            ApiDataRetentionPolicyResource.PARENT_ORGANIZATION_PATH)
  ...
  @Test
  void testSetDataRetentionPolicies() throws Exception {
