...
/**
 * Postgres variant of {@code EnterpriseReportingResourceTest}. Lives in the original
 * {@code enterprise.reporting} package because
 * {@link EnterpriseReportingService#clearEnterpriseReportingConfigDTOBaseUrlSupplierForTests()}
 * is package-private.
 */
@IqPostgresTest
class IqPostgresEnterpriseReportingResourceTest
{
  ...
  @BeforeEach
  void setup() {
    enterpriseReportingFilterDAO = ctx.lookup(EnterpriseReportingFilterDAO.class);
    enterpriseReportingDefaultFilterDAO = ctx.lookup(EnterpriseReportingDefaultFilterDAO.class);
  ...
  private void cleanupFilters() {
    String userId = userDAO.getByUsernameNotNull(ctx.getUsername()).getId();
  ...
  @Test
  void testGetDashboardMetadata_Success() throws Exception {
    ctx.getHdsServer().respondWith(createDashboardVersionJson()).atUri("rest/enterpriseReporting/currentVersion");
    ctx.getHdsServer().respondWith(createDashboardMetadataJsonList()).atUri("rest/enterpriseReporting/dashboards");
    ctx.getHdsServer().respondWith(new byte[0]).atUri("rest/enterpriseReporting/icons/rolling-recap.svg");
  ...
  @Test
  void testGetDashboardMetadataAdditionalAttribute_Success() throws Exception {
    ctx.getHdsServer().respondWith(createDashboardVersionJson()).atUri("rest/enterpriseReporting/currentVersion");
    ctx.getHdsServer()
        .respondWith(createDashboardMetadataAdditionalAttrJsonList())
  ...
  @Test
  void testGetIcon_Success() throws Exception {
    assertTestGetIcon(200, "rolling-recap.svg");
  }

  @Test
  void testGetIcon_404_NotFound() throws Exception {
    assertTestGetIcon(404, "fake-icon-name.svg");
  }

  @Test
  void testGetIcon_400_BadRequest() throws Exception {
    assertTestGetIcon(400, "..\\fake-icon-name.svg");
  }

  @Test
  void testAcquireEmbedSession_Success() throws Exception {
    ...
    ctx.getHdsServer().respondWith(expectedResponse).atUri("rest/enterpriseReporting/acquireEmbedSession");
    ...
    String requestBody = ctx.getHdsServer().getCapturedRequestBody("rest/enterpriseReporting/acquireEmbedSession");
  ...
  @Test
  void testGetBaseUrl_Success() throws Exception {
    EnterpriseReportingConfigDTO config = new EnterpriseReportingConfigDTO("https://looker.example.com");
    ctx.getHdsServer().respondWith(config).atUri("rest/enterpriseReporting/config");
  ...
  @Test
  void testAcquireEmbedSession_BadRequest_missingParameters() throws Exception {
    EmbedCookielessSessionAcquire expectedResponse =
        new EmbedCookielessSessionAcquire("authTokenResponse", 300, "navTokenResponse", 400, "apiTokenResponse", 500,
            "sessionTokenResponse", 600);
    ctx.getHdsServer().respondWith(expectedResponse).atUri("rest/enterpriseReporting/acquireEmbedSession");
  ...
  @Test
  void testGenerateEmbedTokens_Success() throws Exception {
    EmbedCookielessSessionGenerateTokensResponse expectedResponse =
        new EmbedCookielessSessionGenerateTokensResponse("navToken", 200, "apiToken", 300, "sessionRefTokenResponse",
            400);
    ctx.getHdsServer().respondWith(expectedResponse).atUri("rest/enterpriseReporting/generateEmbedTokens");
  ...
  @Test
  void testGenerateEmbedTokens_BadRequest_MissingParameters() throws Exception {
    EmbedCookielessSessionGenerateTokens tokenRequestDto =
  ...
  private void assertTestGetIcon(int expectedStatus, String iconName) throws Exception {
    ctx.getHdsServer().respondWith(createDashboardVersionJson()).atUri("rest/enterpriseReporting/currentVersion");
    ctx.getHdsServer().respondWith(createDashboardMetadataJsonList()).atUri("rest/enterpriseReporting/dashboards");
    ctx.getHdsServer().respondWith(getBytesFromIconsZip()).atUri("rest/enterpriseReporting/icons");
    ...
    HttpResponse response = restRequest()
        ...
        .parameter(iconName)
        .get();
    ctx.assertResponseStatus(expectedStatus, response);
  }
  ...
  @Test
  void testGetFiltersForCurrentUser() throws Exception {
  ...
  @Test
  void testCreateFilterForCurrentUser() throws Exception {
  ...
  @Test
  void testCreateFilterForCurrentUser__LargePayload() throws Exception {
  ...
  @Test
  void testCreateFilterForCurrentUser__SetDefault() throws Exception {
  ...
  @Test
  void testCreateFilterForCurrentUser__NoName() throws Exception {
  ...
  @Test
  void testUpdateFilterForCurrentUser() throws Exception {
    String userId = getUserId();
  ...
  @Test
  void testUpdateFilterForCurrentUser__UpdatesDefault() throws Exception {
    String userId = getUserId();
    var filter1 = createFilterAndInsert(userId, "Filter 1", "{\"k\":1}");
    var filter2 = createFilterAndInsert(userId, "Filter 2", "{\"k\":2}");
  ...
  @Test
  void testUpdateFilterForCurrentUser__NoName() throws Exception {
  ...
  @Test
  void testDeleteFilterForCurrentUser() throws Exception {
    String userId = getUserId();
    var filter = createFilterAndInsert(userId, "Filter 1", "{\"k\":1}");
  ...
  @Test
  void testDeleteFilterForCurrentUser_InvalidId() throws Exception {
    HttpResponse response = restRequest()
        .path(EnterpriseReportingResource.DELETE_FILTERS_PATH)
  ...
  @Test
  void testDeleteFilterForCurrentUser_UndefinedId() throws Exception {
    HttpResponse response = restRequest()
        .path(EnterpriseReportingResource.DELETE_FILTERS_PATH)
        .parameter("undefined")
        .delete();
  ...
  @Test
  void testDeleteFilterForCurrentUser_NullId() throws Exception {
    HttpResponse response = restRequest()
        .path(EnterpriseReportingResource.DELETE_FILTERS_PATH)
        .parameter("null")
        .delete();
  ...
  @Test
  void testGetDefaultFilterForCurrentUser() throws Exception {
    String userId = getUserId();
    var filter = createFilterAndInsert(userId, "Filter 1", "{\"k\":1}");
  ...
  @Test
  void testGetDefaultFilterForCurrentUser__NoFilter() throws Exception {
    HttpResponse response = restRequest()
        .path(EnterpriseReportingResource.DEFAULT_FILTER_PATH)
        .get();
    ctx.assertResponseStatus(204, response);
  ...
  @Test
  void testInsertDefaultFilterForCurrentUser() throws Exception {
    String userId = getUserId();
    var filter = createFilterAndInsert(userId, "Filter 1", "{\"k\":1}");
  ...
  @Test
  void testInsertDefaultFilterForCurrentUser_InvalidId() throws Exception {
    HttpResponse response = restRequest()
        .path(EnterpriseReportingResource.UPDATE_DEFAULT_FILTERS_PATH)
        .parameter("no-matching-id")
        .put();
  ...
  @Test
  void testInsertDefaultFilterForCurrentUser__UndefinedId() throws Exception {
    HttpResponse response = restRequest()
        .path(EnterpriseReportingResource.UPDATE_DEFAULT_FILTERS_PATH)
        .parameter("undefined")
        .put();
  ...
  @Test
  void testInsertDefaultFilterForCurrentUser__NullId() throws Exception {
    HttpResponse response = restRequest()
        .path(EnterpriseReportingResource.UPDATE_DEFAULT_FILTERS_PATH)
        .parameter("null")
        .put();
  ...
  @Test
  void testUpdateDefaultFilterForCurrentUser() throws Exception {
    String userId = getUserId();
    var filter1 = createFilterAndInsert(userId, "Filter 1", "{\"k\":1}");
    var filter2 = createFilterAndInsert(userId, "Filter 2", "{\"k\":2}");
    createDefaultFilterAndInsert(userId, filter1.getId());
  ...
  @Test
  void testDeleteFilterForCurrentUser__DeletesDefault() throws Exception {
    String userId = getUserId();
    var filter = createFilterAndInsert(userId, "Filter 1", "{\"k\":1}");
  ...
  @Test
  void testDeleteDefaultFilterForCurrentUser() throws Exception {
    String userId = getUserId();
    var filter = createFilterAndInsert(userId, "Filter 1", "{\"k\":1}");
    var defaultFilter = createDefaultFilterAndInsert(userId, filter.getId());
  ...
  @Test
  void testDeleteDefaultFilterForCurrentUser__NonExistentFilter() throws Exception {
    HttpResponse response = restRequest()
        .path(EnterpriseReportingResource.DEFAULT_FILTER_PATH)
        .delete();
    ctx.assertResponseStatus(204, response);
  ...
  private String getUserId() {
    return userDAO.getByUsernameNotNull(ctx.getUsername()).getId();
  }
