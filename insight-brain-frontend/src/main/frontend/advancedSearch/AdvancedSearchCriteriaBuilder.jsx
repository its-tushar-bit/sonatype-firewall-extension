    ...
    <Fragment>
      ...
      { showCriteriaBuilder &&
        <div id="advanced-search-query-builder-container" className="iq-adv-search__query-builder">
          ...
          {queryBuilderGroup('Application Category', 'applicationCategoryId', 'applicationCategoryName',
              'applicationCategoryColor', 'applicationCategoryDescription')}

          {queryBuilderGroup('Component Label', 'componentLabelId', 'componentLabelName', 'componentLabelColor',
              'componentLabelDescription')}

          {queryBuilderGroup('Policy', 'policyId', 'policyName', 'policyThreatCategory', 'policyThreatLevel')}

          {queryBuilderGroup('Security Vulnerability', 'reportId', 'policyEvaluationStage', 'componentHash',
              'componentFormat', 'componentName', 'componentCoordinateGroupId', 'componentCoordinateArtifactId',
              'componentCoordinateVersion', 'componentCoordinateClassifier', 'componentCoordinateExtension',
              'componentCoordinateName', 'componentCoordinateQualifier', 'componentCoordinatePackageId',
              'componentCoordinateArchitecture', 'componentCoordinatePlatform', 'vulnerabilityId',
              'vulnerabilityStatus', 'vulnerabilitySeverity', 'vulnerabilityDescription')}
