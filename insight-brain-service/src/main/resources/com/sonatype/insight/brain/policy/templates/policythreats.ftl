...
<body style="margin: 0; padding: 0;">
	<table width="647" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
		<tr>
			<td colspan="3"><a href="#" title="View Full Report"><img src="../assets/img/header_bg.gif" width="647" height="68" alt="View Full Report"
					border="0" /></a></td>
		</tr>
		<tr>
			<td width="12">&nbsp;</td>
								...
								<tr>
									<td>
										<table cellpadding="0" cellspacing="0" border="0" bordercolor="#FFFFFF" style="border-collapse: collapse;">
											<tr>
												<td width="60" height="30" background="../assets/img/alert_red.gif"
												...
												<td width="60" height="30" background="../assets/img/alert_orange.gif"
												...
												<td width="60" height="30" background="../assets/img/alert_yellow.gif"
												...
												<td width="60" height="30" background="../assets/img/alert_blue.gif"
											...
											<tr>
												...
												<td style="color: #5B80AE; font-size: 8px; text-align: center;"><span
													style="font-family: Helvetica, Arial, sans-serif; color: #5B80AE; font-size: 8px; font-weight: bold;">NEUTRAL</span></td>
											</tr>
										</table>
									</td>
								</tr>
								...
								<table border="0" cellpadding="0" style="font-size: 13px;">
									...
									<tr>
										<td align="left" height="100%">
											...
											<div style="padding-top: 5px; color: #555555;">${condition.reason}</div>
										</td>
									</tr>
									</#list>
								</table>
