...
describe('DashboardViolationsTableRow', function() {
  ...
  beforeEach(() => {
    ...
    DashboardViolationsTableRow =
        require('inject-loader!../../../../main/frontend/dashboard/results/violations/DashboardViolationsTableRow')({
  ...
  describe('row cells', () => {
    it('renders a cell with the threat level', () => {
      ...
      expect(threatLevelCell.find(NxThreatIndicator))
          .toHaveProp('policyThreatLevel', minimalProps.violation.threatLevel);
