...
export const SETTINGS_PAGE_ITEMS: readonly SettingsPageItem[] = [
  ...
  { id: 'ldap', section: 'admin', label: 'LDAP', description: 'Connect corporate directories for user authentication', stateName: 'ldap-list' },
  ...
  { id: 'webhooks', section: 'admin', label: 'Webhooks', description: 'Send notifications to external systems on events', stateName: 'listWebhooks' },
