...
import {
  EFFECTIVELY_UNSPECIFIED_LICENSES,
  STAGE_NAME_TO_DISPLAY,
  STAGE_NAME_TO_ID,
...
export default function ComponentOverviewTile(props) {
  ...
  const reviewStatus = () => {
    ...
    if (obligations.length === 0) {
      return licenseLegalData.effectiveLicenses.length === 0 ||
        licenseLegalData.effectiveLicenses.every(
          (license) => EFFECTIVELY_UNSPECIFIED_LICENSES.indexOf(license) !== -1
        )
        ? 'Unreviewed'
        : 'Complete';
    }
  ...
  const lastUpdatedObligation =
    obligations.length === 0
      ...
      : obligations.reduce((prev, current) =>
          (prev.lastUpdatedAt || 0) > (current.lastUpdatedAt || 0)
            ? prev
            : current
        );
  ...
  const lastUpdated = (() => {
    ...
    let lastUpdatedAt = 0;
    if (
      lastUpdatedObligation &&
      lastUpdatedObligation.lastUpdatedAt > lastUpdatedAt
    ) {
      lastUpdatedByUsername = lastUpdatedObligation.lastUpdatedByUsername;
      lastUpdatedAt = lastUpdatedObligation.lastUpdatedAt;
    }
    if (
      lastUpdatedAttribution &&
      lastUpdatedAttribution.lastUpdatedAt > lastUpdatedAt
    ) {
    ...
    if (
      ...
      lastUpdatedByUsername =
        licenseLegalData.componentCopyrightLastUpdatedByUsername;
    ...
    if (
      ...
      lastUpdatedByUsername =
        licenseLegalData.componentNoticesLastUpdatedByUsername;
    ...
    if (
      ...
      lastUpdatedByUsername =
        licenseLegalData.componentLicensesLastUpdatedByUsername;
      lastUpdatedAt = licenseLegalData.componentLicensesLastUpdatedAt;
    }
    const lastUpdatedAtTimeAgo = timeAgo(lastUpdatedAt);
    return {
      lastUpdatedByUsername:
        lastUpdatedByUsername === undefined ? 'N/A' : lastUpdatedByUsername,
      lastUpdatedAt:
        lastUpdatedByUsername === undefined
          ? 'Never'
          : lastUpdatedAtTimeAgo.age + ' ' + lastUpdatedAtTimeAgo.qualifier,
    };
  })();
    ...
    >
      {stageScan.scanId ? (
        <a href={getStageScanHref(stageScan)}>
          {STAGE_NAME_TO_DISPLAY[stageScan.stageName]}{' '}
          {terseAgo(stageScan.scanDate)}
        </a>
      ) : (
        <span className="no-stage-scan">
          {STAGE_NAME_TO_DISPLAY[stageScan.stageName]}
        </span>
      )}
    </span>
          ...
          <div className="nx-grid-col">
            <dl className="nx-read-only">
              <div className="license-component-overview__review-status">
                ...
                <dd
                  id="component-overview-tile-review-status"
              ...
              <div className="license-component-overview__last-modified">
                ...
                <dd
                  id="component-overview-tile-last-modified"
                  className="nx-read-only__data"
                >
              ...
              <div className="license-component-overview__modified-by">
                ...
                <dd
                  id="component-overview-tile-modified-by"
                  className="nx-read-only__data"
                >
          ...
          <div className="nx-grid-col">
            <dl className="nx-read-only">
              <div className="license-component-overview__review-progress">
                ...
                <dd
                  id="component-overview-tile-review-progress"
                  className="nx-read-only__data"
                >
              ...
              <div className="license-component-overview__fulfilled">
                ...
                <dd
                  id="component-overview-tile-fulfilled"
                  className="nx-read-only__data"
                >
              ...
              <div className="license-component-overview__flagged">
                ...
                <dd
                  id="component-overview-tile-flagged"
                  className="nx-read-only__data"
                >
              ...
              <div className="license-component-overview__not-applicable">
                ...
                <dd
                  id="component-overview-tile-not-applicable"
                  className="nx-read-only__data"
                >
          ...
          <div className="nx-grid-col">
            <dl className="nx-read-only">
              <div className="license-component-overview__licenses">
                ...
                <dd
                  id="component-overview-tile-licenses"
                  className="nx-read-only__data license-names"
                >
                  {licenseNames.join(', ')}
                </dd>
              </div>
              <div className="license-component-overview__highest-threat">
                ...
                <dd
                  id="component-overview-tile-highest-license-threat-group"
                  className="nx-read-only__data"
                >
              ...
              <div className="license-component-overview__stages">
                ...
                <dd
                  id="component-overview-tile-stages"
                  className="nx-read-only__data"
                >
                  {component.stageScans
                    ? component.stageScans.map(createStageScan)
                    : 'N/A'}
                </dd>
              </div>
            </dl>
