...
public class SourceControlDispatcherGitlabTest
    extends BaseSourceControlDispatcherTest
{
  @Rule
  public final GitApiRule gitlab = new GitApiRule(SourceControlProvider.GITLAB);

  private static final ImmutableMap<Object, Object> SUCCESS = ImmutableMap.builder()
      .put("url", "http://example/com")
      .put("author",
          ImmutableMap.builder().put("username", "foo").build()
      ).build();

  private static final String API_URL = "/api/v4/projects/owner%2Frepo/statuses/commitHash";
