 ...
 */
@IqH2Test
class IqH2ApiComponentSearchResourceTest
{
  private IqTestContext ctx;

  private HttpRequest restRequest() {
    return ctx.restRequest().path(PublicApiPaths.COMPONENT_SEARCH_RESOURCE_PATH);
  }

  @Test
  void testGetCveAffectedComponents_ValidRequest_ReturnsResults() throws Exception {
    Application app = ctx.tempEntity().newApplication("Test App", "testapp", Organization.ROOT_ORGANIZATION_ID);
  ...
  @Test
  void testGetCveAffectedComponents_MissingCveId_ReturnsBadRequest() throws Exception {
    HttpResponse response = restRequest()
        .path("/cveAffectedComponents")
        .query("pageNumber", "1")
        .query("pageSize", "10")
  ...
  @Test
  void testGetCveAffectedComponents_InvalidSortOrder_ReturnsBadRequest() throws Exception {
    HttpResponse response = restRequest()
        .path("/cveAffectedComponents")
        .query("cveId", "CVE-2025-55182")
  ...
  @Test
  void testGetCveAffectedComponents_InvalidSortBy_ReturnsBadRequest() throws Exception {
    HttpResponse response = restRequest()
        .path("/cveAffectedComponents")
        .query("cveId", "CVE-2025-55182")
  ...
  @Test
  void testExportComponentSearchReport_ValidRequest_ReturnsCsv() throws Exception {
    Application app = ctx.tempEntity().newApplication("Test App", "testapp", Organization.ROOT_ORGANIZATION_ID);
  ...
  @Test
  void testExportComponentSearchReport_EmptyResults_ReturnsCsvWithHeaderOnly() throws Exception {
    ...
    ctx.hdsRespondWith(new AffectedComponentList(List.of(), null, null))
        .atUri("/rest/vulnerability/affected?refId=CVE-2025-99999")
        .withoutLicense();

    ctx.hdsRespondWith("{\"vulnerabilities\":{}}")
  ...
  @Test
  void testExportComponentSearchReport_NoCveId_DefaultsToReact2Shell() throws Exception {
    Application app = ctx.tempEntity().newApplication("Test App", "testapp", Organization.ROOT_ORGANIZATION_ID);
  ...
  @Test
  void testGetCveAffectedComponents_InvalidPageNumber_ReturnsBadRequest() throws Exception {
    HttpResponse response = restRequest()
        .path("/cveAffectedComponents")
        .query("cveId", "CVE-2025-55182")
        .query("pageNumber", "0")
  ...
  @Test
  void testGetCveAffectedComponents_NegativePageNumber_ReturnsBadRequest() throws Exception {
    HttpResponse response = restRequest()
        .path("/cveAffectedComponents")
        .query("cveId", "CVE-2025-55182")
        .query("pageNumber", "-1")
  ...
  @Test
  void testGetCveAffectedComponents_ZeroPageSize_ReturnsBadRequest() throws Exception {
    HttpResponse response = restRequest()
        .path("/cveAffectedComponents")
        .query("cveId", "CVE-2025-55182")
        .query("pageSize", "0")
  ...
  @Test
  void testGetCveAffectedComponents_PageSizeExceedsMax_ReturnsBadRequest() throws Exception {
    HttpResponse response = restRequest()
        .path("/cveAffectedComponents")
        .query("cveId", "CVE-2025-55182")
        .query("pageSize", "1001")
  ...
  private void setupHdsMocksForStandardSearch() {
    ...
    String vulnDataJson = """
        ...
        """;
    ctx.hdsRespondWith(vulnDataJson)
        .atUri("/rest/vulnerability/details/json")
        .withoutLicense();
    ...
    ctx.hdsRespondWith(List.of(fixedVersions))
