...
public class UserTokensConfigurationTest
    extends AbstractFunctionalTest
{
  private final SystemConfigMenu systemConfigMenu = MainHeader.systemConfigMenu();

  private final UserTokensConfigurationPage configPage = new UserTokensConfigurationPage();
  ...
  public void testUserTokensConfiguration() {
    ...
    waitUntilUrl(UserTokensConfigurationPage.url());
  ...
  public void testCancelButton() {
    refreshOrOpen(UserTokensConfigurationPage.url());
    waitUntilUrl(UserTokensConfigurationPage.url());
