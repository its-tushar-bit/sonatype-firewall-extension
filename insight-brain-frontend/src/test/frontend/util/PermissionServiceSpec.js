...
describe('PermissionService.js', function () {
  ...
  describe('isAuthorized', function () {
    it('Single Perm, Allowed', inject(function (
      PermissionService,
      CLMContextLocations,
      $httpBackend
    ) {
      $httpBackend
        .expectPUT(CLMContextLocations.getPermissionTestUrl(true), ['ADMIN'])
        .respond(['ADMIN']);
      PermissionService.isAuthorized(['ADMIN'], true).then(
        successSpy,
        errorSpy
      );
      $httpBackend.flush();
    ...
    it('Single Perm, Disallowed', inject(function (
      PermissionService,
      CLMContextLocations,
      $httpBackend
    ) {
    ...
    it('Multiple Perms, Allowed', inject(function (
      PermissionService,
      CLMContextLocations,
      $httpBackend
    ) {
      ...
      PermissionService.isAuthorized(['ADMIN', 'ADMIN2'], true).then(
        successSpy,
        errorSpy
      );
      $httpBackend.flush();
    ...
    it('Multiple Perms, Disallowed', inject(function (
      PermissionService,
      CLMContextLocations,
      $httpBackend
    ) {
    ...
    it('Server Error', inject(function (
      PermissionService,
      CLMContextLocations,
      $httpBackend
    ) {
