...
(function() {
  ...
  reportTrendingModule.directive('header', function() {
    return {
      scope: {
        for: '=',
        generatedBy: '=',
      ...
      template: '<div class="row-fluid header" id="header">' +
          '      <div class="span8">' +
          '        <h1><span id="title">{{for}}</span><br />' +
          '        Value Tracking Report</h1>' +
          '      </div>' +
          '      <div class="span4">' +
          '      <table>' +
          '        <tr>' +
          ...
          '        <tr>' +
          '          <th>Generated On</th>' +
          '          <td>{{format(generatedDate)}}</td>' +
          '        </tr>' +
          '        <tr>' +
          '          <th>Period Covered</th>' +
          '          <td>{{format(startDate)}} - {{format(endDate)}}</td>' +
          '        </tr>' +
          '      </table>' +
          '      </div>' +
          '    </div>',
