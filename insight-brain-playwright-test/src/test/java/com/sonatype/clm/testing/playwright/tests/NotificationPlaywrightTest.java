    ...
    extends AbstractIqUiTest
{
  ...
  public void testNotificationMenu() {
    ...
    notificationAssertions.shouldShowItemAge(0, NOTIFICATION_1_AGE_TEXT);
    notificationAssertions.shouldShowItemSummary(0, NOTIFICATION_1_SUMMARY);
    notificationAssertions.shouldShowItemAge(1, NOTIFICATION_2_AGE_TEXT);
    notificationAssertions.shouldShowItemSummary(1, NOTIFICATION_2_SUMMARY);
