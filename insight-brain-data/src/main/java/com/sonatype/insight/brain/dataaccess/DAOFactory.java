...
public interface DAOFactory
{
  ...
  ScanHealthConfigDAO createScanHealthConfigDAO();
  ...
  InnerSourceCleanupPendingDAO createInnerSourceCleanupPendingDAO();
  ...
  HostedRepositoryComponentDAO createHostedRepositoryComponentDAO();
  ...
  ContinuousMonitoringHostedRepoItemDAO createContinuousMonitoringHostedRepoItemDAO();
