...
(function () {
    ...
    policyApp = angular.module('policyApp', ['InsightAngularCommon', 'Labels', 'Policy', 'LicenseGroup', 'NotificationManagement', 'ngSanitize'], ['$routeProvider', function ($routeProvider) {
