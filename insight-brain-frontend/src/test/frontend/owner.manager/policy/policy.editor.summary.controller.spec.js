...
import { mapStateToThis } from 'MainRoot/owner.manager/policy/policy.editor.summary.controller';
...
describe('policy.editor.summary.controller', function () {
  let vm;
  let scope;
  ...
  beforeEach(inject(function (_$rootScope_, $controller) {
    ...
    vm = $controller('PolicyEditorSummaryController', {
      $scope: scope,
    });
  }));
  ...
  describe('mapStateToThis', () => {
    it('sets loading and loadError', () => {
      spyOn(policySelectors, 'selectLoading').and.returnValue(true);
      spyOn(policySelectors, 'selectLoadError').and.returnValue(null);
      spyOn(policySelectors, 'selectIsOrgOwner').and.returnValue(true);
      spyOn(policySelectors, 'selectCurrentPolicy').and.returnValue('policy');
      ...
      expect(output.isOrgOwner).toBe(true);
      expect(output.dirtyPolicy).toBe('policy');
