    ...
    extends AbstractComponentH2AuthzTest
{
  ...
  public void testGetArtifactoryConnection_Authorized() {
    ...
    assertThrows(NotFoundException.class, () -> artifactoryConnectionService
        .getArtifactoryConnection(OwnerType.ORGANIZATION, org.getId(), "doesNotExist"));
  }
  ...
  public void testAddArtifactoryConnection_Unauthenticated() {
    assertThrows(UnauthenticatedException.class, this::testAddArtifactoryConnection);
  }

  @Test
  public void testAddArtifactoryConnection_Unauthorized() {
    login();
    assertThrows(UnauthorizedException.class, this::testAddArtifactoryConnection);
  }
  ...
  public void testUpdateArtifactoryConnection_Unauthenticated() {
    assertThrows(UnauthenticatedException.class, this::testUpdateArtifactoryConnection);
  }

  @Test
  public void testUpdateArtifactoryConnection_Unauthorized() {
    login();
    assertThrows(UnauthorizedException.class, this::testUpdateArtifactoryConnection);
  }
  ...
  public void testDeleteArtifactoryConnection_Unauthenticated() {
    assertThrows(UnauthenticatedException.class, this::testDeleteArtifactoryConnection);
  }

  @Test
  public void testDeleteArtifactoryConnection_Unauthorized() {
    login();
    assertThrows(UnauthorizedException.class, this::testDeleteArtifactoryConnection);
  }
  ...
  public void testTestArtifactoryConnection_Unauthenticated() {
    assertThrows(UnauthenticatedException.class, this::testTestArtifactoryConnection);
  }

  @Test
  public void testTestArtifactoryConnection_Unauthorized() {
    login();
    assertThrows(UnauthorizedException.class, this::testTestArtifactoryConnection);
  }
  ...
  public void testUpdateOwnerArtifactoryConnectionStatus_Unauthenticated() {
    assertThrows(UnauthenticatedException.class, () -> artifactoryConnectionService
        .updateOwnerArtifactoryConnectionStatus(OwnerType.APPLICATION, app.getId(), null));
  }

  @Test
  public void testUpdateOwnerArtifactoryConnectionStatus_Unauthorized() {
    login();
    assertThrows(UnauthorizedException.class, () -> artifactoryConnectionService
        .updateOwnerArtifactoryConnectionStatus(OwnerType.APPLICATION, app.getId(), null));
  }
  ...
  public void testUpdateOwnerArtifactoryConnectionStatus_Authorized() {
    grantWritePermission(app.getId());
    assertThrows(BadRequestException.class, () -> artifactoryConnectionService
        .updateOwnerArtifactoryConnectionStatus(OwnerType.APPLICATION, app.getId(), null));
  }
