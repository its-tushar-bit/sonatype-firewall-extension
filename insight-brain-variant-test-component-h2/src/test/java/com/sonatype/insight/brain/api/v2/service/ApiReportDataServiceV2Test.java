    ...
    extends AbstractComponentH2Test
{
  ...
  @BeforeAll
  static void startHdsMockServer() throws Exception {
    hdsMockServer.start();
  }

  @AfterAll
  static void stopHdsMockServer() {
    hdsMockServer.stop();
  }
  ...
  public void testGetRawData_ErrorReport() throws Exception {
    ...
    assertThatExceptionOfType(BadRequestException.class)
        .isThrownBy(() -> reportDataService.getRawData(app.getPublicId(), scanId));
  }
  ...
  public void testGetDataForPrioritization_emptyReportThrows() throws Exception {
    makeEmptyReport();
    assertThatExceptionOfType(BadRequestException.class)
        .isThrownBy(() -> reportDataService.getDataForPrioritization(app.getPublicId(), scanId));
  }
  ...
  public void testGetPolicyViolationsData_OnlyPageProvided() throws Exception {
    ...
    populatePolicyThreats("report-1", "policythreats.json");
    assertThatExceptionOfType(BadRequestException.class)
        .isThrownBy(() -> reportDataService.getPolicyViolationsData(app.getPublicId(), scanId, false, 1, null));
  }
  ...
  public void testGetPolicyViolationsData_OnlyPageSizeProvided() throws Exception {
    ...
    populatePolicyThreats("report-1", "policythreats.json");
    assertThatExceptionOfType(BadRequestException.class)
        .isThrownBy(() -> reportDataService.getPolicyViolationsData(app.getPublicId(), scanId, false, null, 10));
  }
  ...
  public void testGetPolicyViolationsData_PageZero() throws Exception {
    ...
    populatePolicyThreats("report-1", "policythreats.json");
    assertThatExceptionOfType(BadRequestException.class)
        .isThrownBy(() -> reportDataService.getPolicyViolationsData(app.getPublicId(), scanId, false, 0, 10));
  }
  ...
  public void testGetDependencyTree_NotFound() throws Exception {
    assertThatExceptionOfType(NotFoundException.class)
        .isThrownBy(() -> reportDataService.getDependencyTreeNoAuth(app, "2304948571222"));
  }
  ...
  public void testGetDataNoAuth_Hrc_NotFound() throws Exception {
    ...
    assertThatExceptionOfType(NotFoundException.class)
        .isThrownBy(() -> reportDataService.getDataNoAuth(hrc, "no-such-scan"));
  }
  ...
  public void testGetPolicyViolationsDataNoAuth_Hrc_NotFound() throws Exception {
    ...
    HostedRepositoryComponent hrc = tempEntity.newHostedRepositoryComponent(repository);
    assertThatExceptionOfType(NotFoundException.class)
        .isThrownBy(() -> reportDataService.getPolicyViolationsDataNoAuth(hrc, "no-such-scan", false));
  }
  ...
  public void testGetDependencyTreeNoAuth_Hrc_NotFound() throws Exception {
    ...
    HostedRepositoryComponent hrc = tempEntity.newHostedRepositoryComponent(repository);
    assertThatExceptionOfType(NotFoundException.class)
        .isThrownBy(() -> reportDataService.getDependencyTreeNoAuth(hrc, "no-such-scan"));
  }
}
