...
public class ConfigurationProperty
{
  ...
  public static final ConfigurationProperty[] PROPERTIES = new ConfigurationProperty[]{
      ...
      new ConfigurationProperty(SystemConfigurationProperty.ID_TOKEN_COOKIE_EXPIRATION_TIME_SECONDS, Integer.class,
          (p, s) -> NumberUtils.toInt(s, 10),
          (p, o) -> ConfigurationUtils.idTokenCookieExpirationToString(o)),
