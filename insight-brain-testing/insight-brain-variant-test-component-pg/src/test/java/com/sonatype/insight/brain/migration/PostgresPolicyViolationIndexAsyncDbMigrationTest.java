...
/**
 * PostgreSQL-backed async DB migration component tests relocated from {@code PolicyViolationIndexAsyncDbMigrationTest}
 * and {@code PostgresPolicyViolationIndexAsyncDbMigrationTest} (CLM-45235). The H2 coverage stays in the origin
 * {@code PolicyViolationIndexAsyncDbMigrationTest}.
 */
@ComponentPgTest
