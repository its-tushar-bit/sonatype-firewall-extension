...
class RootOrgManagementPage
extends BasePage {
  static url = "assets/index.html#/management/view/organization/ROOT_ORGANIZATION_ID"

  static at = { title == 'IQ Server - Organization Management'}
