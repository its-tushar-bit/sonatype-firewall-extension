...
describe('orgsAndPoliciesApplicationCategoriesActions', () => {
  ...
  describe('loadApplicableCategories', () => {
    it('loads applicable categories successfully', (done) => {
      ...
      store.dispatch(actions.loadApplicableCategories()).then(() => {
        ...
        expect(appCategoryOwners[0]).toEqual(jasmine.objectContaining({ parent: false }));
        expect(appCategoryOwners[1]).toEqual(jasmine.objectContaining({ parent: true }));
  ...
  describe('loadCategoryEditor', () => {
    ...
    beforeEach(() => {
      spyOn(routerSelectors, 'selectRouterCurrentParams').and.returnValue({ categoryId });
  ...
  describe('removeApplicationCategory', () => {
    ...
    beforeEach(() => {
      spyOn(selectors, 'selectCurrentCategory').and.returnValue(currentCategoryData);
    });
