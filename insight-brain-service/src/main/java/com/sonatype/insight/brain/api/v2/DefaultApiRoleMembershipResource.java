...
public class DefaultApiRoleMembershipResource implements ApiRoleMembershipResource
{
  ...
  @Inject
  public DefaultApiRoleMembershipResource(MembershipMappingService membershipMappingService) {
