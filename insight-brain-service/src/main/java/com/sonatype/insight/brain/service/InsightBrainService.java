...
import com.sonatype.insight.brain.application.ApplicationProfilePolicyResource;
...
import com.sonatype.insight.brain.saas.IDEComponentInfoResource;
    ...
    extends SisuService<InsightConfig>
{
    ...
    {              
        ...
        env.addResource( ApplicationProfilePolicyResource.class );
        ...
        env.addResource( CIComponentInfoResource.class );
        env.addResource( IDEComponentInfoResource.class );
