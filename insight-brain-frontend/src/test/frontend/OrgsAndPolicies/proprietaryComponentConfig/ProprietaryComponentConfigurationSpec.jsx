...
describe('ProprietaryComponentConfiguration', () => {
  ...
  beforeEach(() => {
    selectProprietaryLoadingSpy = spyOn(proprietarySelectors, 'selectIsLoading').and.returnValue(false);
    selectProprietaryLoadErrorSpy = spyOn(proprietarySelectors, 'selectLoadError').and.returnValue(null);
    ...
    saveProprietaryConfigSpy = spyOn(actions, 'saveProprietaryConfig').and.callThrough();
    setMatcherValueSpy = spyOn(actions, 'setMatcherValue').and.callThrough();
    addMatcherSpy = spyOn(actions, 'addMatcher').and.callThrough();
    removeMatcherSpy = spyOn(actions, 'removeMatcher').and.callThrough();
  ...
  it('renders loading indicator', () => {
    selectProprietaryLoadingSpy.and.returnValue(true);
    renderComponent();
  ...
  it('shows error message on error', () => {
    selectProprietaryLoadErrorSpy.and.returnValue('Error');
    renderComponent();
...
describe('ProprietaryComponentConfiguration inheritance test', () => {
  ...
  it('renders inherited list correct on initialize', () => {
    ...
    expect(localList).toHaveClassName('local-proprietary-component-matchers');
    expect(inheritedList.parentElement).toHaveClassName('inherited-proprietary-component-matchers');
