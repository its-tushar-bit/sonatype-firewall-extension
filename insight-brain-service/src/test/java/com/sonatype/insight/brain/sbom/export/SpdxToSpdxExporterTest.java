    ...
    extends AbstractSbomExporterTest
{
  ...
  @Before
  public void before() {
    spdxExporter = new SpdxToSpdxExporter(mockInsightWork, thirdPartyFileCoordinateDAO, thirdPartyCoordinateSecurityDAO,
        thirdPartyCoordinateLicenseDAO, vulnerabilityExploitabilityExchangeDAO, baseUrl, idUtils, versionService);
  ...
  private Map<String, Object> mockOriginalThirdPartyScan() {
    ...
    tempEntity.newThirdPartyCoordinateSecurity(databind, "CVE-2022-42003",
        ...
        " CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H", "HIGH", "CWE-502", "", "", "", "SBOM");
