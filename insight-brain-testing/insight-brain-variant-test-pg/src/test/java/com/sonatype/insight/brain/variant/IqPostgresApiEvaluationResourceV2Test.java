 ...
 */
@IqPostgresTest
class IqPostgresApiEvaluationResourceV2Test
{
  ...
  private HttpRequest restRequest(String applicationId) {
    return ctx.restRequest().path(APPLICATION_EVALUATION_PATH_V2, applicationId);
  }
  ...
  void setupApplication() {
    ...
    sourceControlEventDAO = ctx.lookup(SourceControlEventDAO.class);
    org = ctx.tempEntity().newOrganization();
    app = ctx.tempEntity().newApplication(org.getId());
  }

  @Test
  void testEvaluateComponents_invalidComponentIdentifier_noCoordinates() throws Exception {
    String jsonRequest =
  ...
  @Test
  void testEvaluateComponents_invalidComponentIdentifier_noExtension() throws Exception {
  ...
  @Test
  void testEvaluateComponents_invalidPackageUrl() throws Exception {
    ApiComponentEvaluationRequestDTOV2 request = new ApiComponentEvaluationRequestDTOV2();
  ...
  @Test
  void testEvaluateComponents_validation_nullComponentIdentifierAndNullPackageUrl() throws Exception {
    ApiComponentEvaluationRequestDTOV2 request = new ApiComponentEvaluationRequestDTOV2();
    ApiComponentDTOV2 component = new ApiComponentDTOV2();
    component.hash = "h1";
    request.components.add(component);
  ...
  @Test
  void testEvaluateComponents_validation_nullHashAndNullPackageUrl() throws Exception {
    ApiComponentEvaluationRequestDTOV2 request = new ApiComponentEvaluationRequestDTOV2();
    ApiComponentDTOV2 component = new ApiComponentDTOV2();
  ...
  @Test
  void testEvaluateComponents_validation_nullComponentIdentifierAndNullHash() throws Exception {
    ApiComponentEvaluationRequestDTOV2 request = new ApiComponentEvaluationRequestDTOV2();
    ApiComponentDTOV2 component = new ApiComponentDTOV2();
  ...
  @Test
  void testEvaluateComponents_validation_nullComponentIdentifierAndNullPackageUrlAndNullHash() throws Exception {
    ApiComponentEvaluationRequestDTOV2 request = new ApiComponentEvaluationRequestDTOV2();
    ApiComponentDTOV2 component = new ApiComponentDTOV2();
    request.components.add(component);
  ...
  @Test
  void testEvaluateComponents_nullComponents() throws Exception {
    ApiComponentEvaluationRequestDTOV2 request = new ApiComponentEvaluationRequestDTOV2();
  ...
  @Test
  void testEvaluateComponents_emptyComponents() throws Exception {
    ApiComponentEvaluationRequestDTOV2 request = new ApiComponentEvaluationRequestDTOV2();
  ...
  @Test
  void testEvaluateComponents_HdsError() throws Exception {
    ApiComponentEvaluationRequestDTOV2 request = new ApiComponentEvaluationRequestDTOV2();
  ...
  @Test
  void testEvaluateComponents_matchByComponentIdentifier() throws Exception {
    ComponentIdentifier componentIdentifier = ComponentIdentifier.createMavenCoordinates("g1", "a1", "v1", "", "e1");
  ...
  @Test
  void testEvaluateComponents_matchByPackageUrl() throws Exception {
  ...
  @Test
  void testEvaluateComponents_multipleMatchByHash() throws Exception {
    Map<String, Policy> policies = componentEvaluationV2Helper.createPolicies(org, app);
    ApiComponentEvaluationRequestDTOV2 request = new ApiComponentEvaluationRequestDTOV2();
  ...
  @Test
  void testEvaluateComponents_withClaimedComponent() throws Exception {
    Map<String, Policy> policies = componentEvaluationV2Helper.createPolicies(org, app);
    ApiComponentEvaluationRequestDTOV2 request = new ApiComponentEvaluationRequestDTOV2();
    ...
    ctx.tempEntity().newClaimedComponent("h2", componentIdentifier2);
  ...
  @Test
  void testEvaluateComponents_withClaimedComponentEmptyVsNullClassifier() throws Exception {
    ApiComponentEvaluationRequestDTOV2 request = new ApiComponentEvaluationRequestDTOV2();
    ...
    ComponentIdentifier expectedComponentIdentifier1 = ComponentIdentifier.createMavenCoordinates("g1", "a1", "v1", "",
        "e1");
    ctx.tempEntity().newClaimedComponent("h1", expectedComponentIdentifier1);
    ComponentIdentifier expectedComponentIdentifier2 = ComponentIdentifier.createMavenCoordinates("g2", "a2", "v2", "",
        "e2");
    ctx.tempEntity().newClaimedComponent("h2", expectedComponentIdentifier2);
  ...
  @Test
  void testEvaluateComponents_withClaimedComponentMissingExtension() throws Exception {
    ApiComponentEvaluationRequestDTOV2 request = new ApiComponentEvaluationRequestDTOV2();
  ...
  private void mockHDSInternalServiceError() {
    ctx.hdsRespondWith("Internal Error")
        .andStatus(500)
  ...
  @Test
  void testGetApplicationEvaluationStatus() throws Exception {
    createScanFile(app.getId(), SCAN_ID);
    ctx.tempEntity().newPolicyEvaluation(app.getId(), Stage.ID_BUILD, SCAN_ID);
    HttpResponse response = ctx.restRequest()
        .path(APPLICATION_EVALUATION_PATH_V2, ApiEvaluationResourceV2.PROMOTE_SCAN_PATH)
    ...
    response = ctx.restRequest().path(apiApplicationEvaluationStatusDTOV2.statusUrl).get();
  ...
  @Test
  void testEvaluateSourceControl_NoScanTarget() throws Exception {
  ...
  @Test
  void testEvaluateSourceControl_WithScanTarget() throws Exception {
    // given an application
    Application app = ctx.tempEntity().newApplicationWithParent();
  ...
  private void mockComponentDetails(final ComponentEvaluationDataList componentEvaluationDataList) {
    ctx.hdsRespondWith(componentEvaluationDataList)
        .atUri(ApiComponentDetailsServiceV2.HDS_COMPONENT_DETAILS_PATH
            .replace("{purpose: evaluation|integration}", ApiComponentDetailsServiceV2.PURPOSE_EVALUATION));
  }
      ...
      final ApiComponentEvaluationTicketDTOV2 evaluationResult) throws Exception
  {
    ...
    HttpRequest request = ctx.restRequest().path(evaluationResult.resultsUrl);
  ...
  // Copied from AbstractBaseIntegrationTest.createScanFile (not exposed on IqTestContext).
  private void createScanFile(String applicationId, String scanId) {
    ScanHelper.createDummyScanFile(ctx.insightWork(), applicationId, scanId);
  }
}
