...
/**
 * PostgreSQL-backed tests relocated from {@link ProprietaryComponentNamePatternMigratorTest} (CLM-45228).
 */
@PostgresTest
public class ProprietaryComponentNamePatternMigratorPgTest
