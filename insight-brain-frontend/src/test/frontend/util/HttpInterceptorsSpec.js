...
describe('HttpInterceptors.js', function () {
  var scope, modalSuccess, modalFailure, modalConfig;
  ...
  it('Validate that a failed request is in the queue', inject(function (
    $q,
    $http,
    $httpBackend,
  ...
  it('Validate that window.sessionExpired is called if a 401 happens when $rootScope.username is already defined', inject(function (
    $rootScope,
    $http,
    $httpBackend,
    UnauthenticatedRequestQueueService,
  ...
  it('Validate that the login modal is told to show SAML SSO when the WWW-Authenticate header is set to SAML', inject(function (
    $rootScope,
    $http,
    $httpBackend
  ) {
  ...
  it('Validate that the login modal is told to not show SAML SSO without the WWW-Authenticate header', inject(function (
    $rootScope,
    $http,
    $httpBackend
  ) {
  ...
  it('Validate that the login modal is told the identity provider name when the X-SAML-IdP is set to it', inject(function (
    $rootScope,
    $http,
    $httpBackend
  ) {
  ...
  it('Validate that failed requests are retried and cleared out of the queue after the modal promise fires success', inject(function (
    $q,
    $http,
    $httpBackend,
    UnauthenticatedRequestQueueService
  ...
  it('does not retry requests that have a waitForLogin property set to false nor add them to the queue', inject(function (
    $q,
    $http,
    $httpBackend,
    UnauthenticatedRequestQueueService
