...
public class SearchTestHelper
{
  ...
  public static class ComponentInfo
  {
    ...
    public ComponentInfo(final String hash, final ComponentIdentifier componentIdentifier,
      ...
      this.policyViolationInfos = policyViolationInfos == null ?
          Collections.<PolicyViolationInfo>emptyList() : policyViolationInfos;
    }
  }
  ...
  public Map<String, List<ComponentInfo>> createTestComponentInfoForTwoApps(String appPublicId1, String appPublicId2) {
    ...
    app1ComponentInfos.add(new ComponentInfo("2143b68270b82576110f",
        ...
        app1SimpleJsonPolicyViolationInfos));
    ...
    app2ComponentInfos.add(new ComponentInfo("2143b68270b82576110f",
        ComponentIdentifier.createNugetCoordinates("simplejson", "0.38.0"),
        app2SimpleJsonPolicyViolationInfos));
  ...
  public void createScanForApp(String appId, String stageId, List<ComponentInfo> componentInfos)
      throws Exception {
    ...
    for (ComponentInfo componentInfo : componentInfos) {
      ...
      for (PolicyViolationInfo policyViolationInfo : componentInfo.policyViolationInfos) {
        ...
        tempEntity.newPolicyViolation(policyEvaluation, policy,
            componentInfo.componentIdentifier, componentInfo.hash, policyViolationInfo.reason);
      }
    }
  }
}
