...
describe('FirewallSecurityTab', () => {
  ...
  beforeEach(() => {
    spyFirewallPolicyViolationsTile = spyOn(FirewallPolicyViolationsTile, 'default').and.callFake(() => (
      <div>FirewallPolicyViolationsTile</div>
    ));
    spyVulnerabilitiesTableTile = spyOn(VulnerabilitiesTableTile, 'default').and.callFake(() => (
      <div>VulnerabilitiesTableTile</div>
    ));
    spyOn(vulnerabilitiesSelector, 'selectVulnerabilitiesSortedSlice').and.callFake(() => {
      return originalSelectVulnerabilitiesSortedSlice(minState);
    });

    spyOn(firewallPolicyViolationsSelectors, 'selectSecurityPolicyViolations').and.callFake(() => {
    ...
    expect(spyVulnerabilitiesTableTile.prototype.constructor).toHaveBeenCalledWith(
      {
        ...
        loadComponentDetails: jasmine.any(Function),
        loadVulnerabilities: jasmine.any(Function),
        toggleVulnerabilityPopoverWithEffects: jasmine.any(Function),
      }, // params
      {} // state
    );
  });
