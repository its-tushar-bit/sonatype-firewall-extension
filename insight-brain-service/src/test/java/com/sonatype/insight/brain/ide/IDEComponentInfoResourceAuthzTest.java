    ...
    extends AbstractResourceAuthzTest
{
  ...
  public void testGetComponentDetailsList() throws Exception {
    ...
    String url = getRestUrl(IDEComponentInfoResource.SERVICE_PATH + "/list/{applicationPublicId}", app.getPublicId())
  ...
  public void testGetComponentDetails() throws Exception {
    ...
    String url = getRestUrl(IDEComponentInfoResource.SERVICE_PATH + "/{applicationPublicId}", app.getPublicId())
        + "?groupId=" + groupId + "&artifactId=" + artifactId + "&version=" + version;
    testAuthzGet(url);
  }
  ...
  public void testGetSelectableLicenses() throws Exception {
    ...
    String url = getRestUrl(IDEComponentInfoResource.SERVICE_PATH + "/selectableLicenses/{applicationPublicId}",
        app.getPublicId())
        + "?groupId=" + groupId + "&artifactId=" + artifactId + "&version=" + version;
    testAuthzGet(url);
  }
  ...
  public void testGetLicenses() throws Exception {
    ...
    String url = getRestUrl(IDEComponentInfoResource.SERVICE_PATH + "/licenses/{applicationPublicId}",
        app.getPublicId())
        + "?groupId=" + groupId + "&artifactId=" + artifactId + "&version=" + version;
    testAuthzGet(url);
  }
