...
export default function AdvancedSearchHelp(props) {
  ...
  const helpDiv = (
    <div id="advanced-search-help-container">
      ...
      {helpRow('applicationName:nexus* AND itemType:APPLICATION',
          'Search by application name focused on application documents')}
      {helpRow('applicationName:nexus* AND itemType:SECURITY_VULNERABILITY',
      ...
      {helpRow('itemType:SECURITY_VULNERABILITY AND componentFormat:(a-name OR npm) AND' +
