    ...
    extends AbstractIqUiTest
{
  ...
  /**
   * Inherited policy with actions override: when {@code policyActionsOverrideAllowed=true}
   * on the root policy, a child org can select "Override parent actions", set a Warn action, and
   * click Update. The override save (not a full policy save) persists after page refresh.
   */
  @Test
