...
@IqH2Test
class IqH2ProprietaryConfigResourceTest
{
  private IqTestContext ctx;

  @Test
  void testUpsertProprietaryConfig() throws Exception {
    Organization org = ctx.tempEntity().newOrganization("ProprietaryConfigResourceTest");
  ...
  @Test
  void testGetProprietaryConfigHierarchy() throws Exception {
    Organization org = ctx.tempEntity().newOrganization("ProprietaryConfigResourceTest");
    ProprietaryConfig orgConfig = ctx.tempEntity()
    ...
    ProprietaryConfig appConfig = ctx.tempEntity()
  ...
  @Test
  void testAddFilePathRegexToProprietaryConfig() throws Exception {
    Organization org = ctx.tempEntity().newOrganization("ProprietaryConfigResourceTest");
    ctx.tempEntity().newProprietaryConfig(org.getId(), null, Collections.singletonList("regex1"));
