    ...
    extends AbstractComponentTest
{
  ...
  private void assertPolicySummary(PolicySummaryDTO actual, int totalNew, int totalFixed, int currentUnresolved) {
