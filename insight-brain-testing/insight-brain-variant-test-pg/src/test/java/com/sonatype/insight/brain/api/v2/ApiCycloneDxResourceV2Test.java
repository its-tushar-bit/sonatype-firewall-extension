 ...
 * {@code GET_BY_REPORT_PATH}/{@code GET_BY_STAGE_PATH_WITH_VERSION}/{@code GET_BY_REPORT_PATH_WITH_VERSION}
 * constants, and resolves report fixtures via {@code getClass().getSimpleName()} — so the class keeps the
 * original simple name and package (see convert-resource-test-to-variant skill, Step 3).
 */
@IqPostgresTest
class ApiCycloneDxResourceV2Test
{
  ...
  @Test
  void testGetLatest_With_Version_1_1_Xml() throws Exception {
  ...
  @Test
  void testGetLatest_With_Version_1_2_Xml() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetLatest_With_Version_1_3_Xml() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetLatest_With_Version_14_Xml() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetLatest_With_Version_15_Xml() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetLatest_With_Version_16_Xml() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetLatest_With_Version_11_Json() throws Exception {
    HttpResponse response =
        getHttpRequestLatest(ApiCycloneDxResourceV2.GET_BY_STAGE_PATH_WITH_VERSION, Version.VERSION_11,
  ...
  @Test
  void testGetLatest_With_Version_12_Json() throws Exception {
    HttpResponse response =
        getHttpRequestLatest(ApiCycloneDxResourceV2.GET_BY_STAGE_PATH_WITH_VERSION, Version.VERSION_12,
            MediaType.APPLICATION_JSON).get();
  ...
  @Test
  void testGetLatest_With_Version_13_Json() throws Exception {
    HttpResponse response =
        getHttpRequestLatest(ApiCycloneDxResourceV2.GET_BY_STAGE_PATH_WITH_VERSION, Version.VERSION_13,
            MediaType.APPLICATION_JSON).get();
  ...
  @Test
  void testGetLatest_With_Version_14_Json() throws Exception {
    HttpResponse response =
        getHttpRequestLatest(ApiCycloneDxResourceV2.GET_BY_STAGE_PATH_WITH_VERSION, Version.VERSION_14,
            MediaType.APPLICATION_JSON).get();
  ...
  @Test
  void testGetLatest_With_Version_15_Json() throws Exception {
    HttpResponse response =
        getHttpRequestLatest(ApiCycloneDxResourceV2.GET_BY_STAGE_PATH_WITH_VERSION, Version.VERSION_15,
            MediaType.APPLICATION_JSON).get();
  ...
  @Test
  void testGetLatest_With_Version_16_Json() throws Exception {
    HttpResponse response =
        getHttpRequestLatest(ApiCycloneDxResourceV2.GET_BY_STAGE_PATH_WITH_VERSION, Version.VERSION_16,
            MediaType.APPLICATION_JSON).get();
  ...
  @Test
  void testGetByReportId_With_Version_1_1_Xml() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetByReportId_With_Version_1_2_Xml() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetByReportId_With_Version_1_3_Xml() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetByReportId_With_Version_1_4_Xml() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetByReportId_With_Version_1_5_Xml() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetByReportId_With_Version_1_6_Xml() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetByReportId_Maven_With_Version_1_2_Xml() throws Exception {
  ...
  @Test
  void testGetByReportId_Maven_With_Version_1_2_Json() throws Exception {
    String sourceReportDir = "/" + getClass().getSimpleName() + "-mavenComponent/report";
    HttpResponse response =
        getHttpRequestByReportId(
            ApiCycloneDxResourceV2.GET_BY_REPORT_PATH_WITH_VERSION,
  ...
  @Test
  void testGetByReportId_Empty_Xml() throws Exception {
  ...
  @Test
  void testGetByReportId_Empty_Json() throws Exception {
    String sourceReportDir = "/" + getClass().getSimpleName() + "-empty/report";
    HttpResponse response =
        getHttpRequestByReportId(
            ApiCycloneDxResourceV2.GET_BY_REPORT_PATH_WITH_VERSION,
  ...
  @Test
  void testGetByReportId_With_Version_11() throws Exception {
    HttpResponse response =
        getHttpRequestByReportId(ApiCycloneDxResourceV2.GET_BY_REPORT_PATH_WITH_VERSION, Version.VERSION_11,
            MediaType.APPLICATION_JSON).get();
    assertThat(response.getStatusCode()).isEqualTo(406);
  ...
  @Test
  void testGetByReportId_With_Version_12_Json() throws Exception {
    HttpResponse response =
        getHttpRequestByReportId(ApiCycloneDxResourceV2.GET_BY_REPORT_PATH_WITH_VERSION, Version.VERSION_12,
            MediaType.APPLICATION_JSON).get();
    assertValidResponse(response, Version.VERSION_12, MediaType.APPLICATION_JSON);
  ...
  @Test
  void testGetByReportId_With_Version_13_Json() throws Exception {
    HttpResponse response =
        getHttpRequestByReportId(ApiCycloneDxResourceV2.GET_BY_REPORT_PATH_WITH_VERSION, Version.VERSION_13,
            MediaType.APPLICATION_JSON).get();
    assertValidResponse(response, Version.VERSION_13, MediaType.APPLICATION_JSON);
  ...
  @Test
  void testGetByReportId_With_Version_14_Json() throws Exception {
    HttpResponse response =
        getHttpRequestByReportId(ApiCycloneDxResourceV2.GET_BY_REPORT_PATH_WITH_VERSION, Version.VERSION_14,
            MediaType.APPLICATION_JSON).get();
    assertValidResponse(response, Version.VERSION_14, MediaType.APPLICATION_JSON);
  ...
  @Test
  void testGetByReportId_With_Version_15_Json() throws Exception {
    HttpResponse response =
        getHttpRequestByReportId(ApiCycloneDxResourceV2.GET_BY_REPORT_PATH_WITH_VERSION, Version.VERSION_15,
            MediaType.APPLICATION_JSON).get();
    assertValidResponse(response, Version.VERSION_15, MediaType.APPLICATION_JSON);
  ...
  @Test
  void testGetByReportId_With_Version_16_Json() throws Exception {
    HttpResponse response =
        getHttpRequestByReportId(ApiCycloneDxResourceV2.GET_BY_REPORT_PATH_WITH_VERSION, Version.VERSION_16,
            MediaType.APPLICATION_JSON).get();
    assertValidResponse(response, Version.VERSION_16, MediaType.APPLICATION_JSON);
  ...
  @Test
  void testGetLatest_Invalid_AcceptType() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetLatest_With_Version_1_1_Invalid_AcceptType() throws Exception {
    HttpResponse response =
        getHttpRequestLatest(ApiCycloneDxResourceV2.GET_BY_STAGE_PATH_WITH_VERSION, Version.VERSION_11,
  ...
  @Test
  void testGetLatest_With_Version_1_2_Invalid_AcceptType() throws Exception {
    HttpResponse response =
        getHttpRequestLatest(ApiCycloneDxResourceV2.GET_BY_STAGE_PATH_WITH_VERSION, Version.VERSION_12,
            MediaType.APPLICATION_ATOM_XML).get();
    assertThat(response.getStatusCode()).isEqualTo(406);
  ...
  @Test
  void testGetLatest_With_Version_1_3_Invalid_AcceptType() throws Exception {
    HttpResponse response =
        getHttpRequestLatest(ApiCycloneDxResourceV2.GET_BY_STAGE_PATH_WITH_VERSION, Version.VERSION_13,
            MediaType.APPLICATION_ATOM_XML).get();
    assertThat(response.getStatusCode()).isEqualTo(406);
  ...
  @Test
  void testGetLatest_With_Version_1_4_Invalid_AcceptType() throws Exception {
    HttpResponse response =
        getHttpRequestLatest(ApiCycloneDxResourceV2.GET_BY_STAGE_PATH_WITH_VERSION, Version.VERSION_14,
            MediaType.APPLICATION_ATOM_XML).get();
    assertThat(response.getStatusCode()).isEqualTo(406);
  ...
  @Test
  void testGetLatest_With_Version_1_5_Invalid_AcceptType() throws Exception {
    HttpResponse response =
        getHttpRequestLatest(ApiCycloneDxResourceV2.GET_BY_STAGE_PATH_WITH_VERSION, Version.VERSION_15,
            MediaType.APPLICATION_ATOM_XML).get();
    assertThat(response.getStatusCode()).isEqualTo(406);
  ...
  @Test
  void testGetLatest_With_Version_1_6_Invalid_AcceptType() throws Exception {
    HttpResponse response =
        getHttpRequestLatest(ApiCycloneDxResourceV2.GET_BY_STAGE_PATH_WITH_VERSION, Version.VERSION_16,
            MediaType.APPLICATION_ATOM_XML).get();
    assertThat(response.getStatusCode()).isEqualTo(406);
  ...
  @Test
  void testGetByReportId_Invalid_AcceptType() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetByReportId_With_Version_1_1_Invalid_AcceptType() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetByReportId_With_Version_1_2_Invalid_AcceptType() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetByReportId_With_Version_1_3_Invalid_AcceptType() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetByReportId_With_Version_1_4_Invalid_AcceptType() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetByReportId_With_Version_1_5_Invalid_AcceptType() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetByReportId_With_Version_1_6_Invalid_AcceptType() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetByReportId_With_Invalid_Version() throws Exception {
    HttpResponse response =
  ...
  @Test
  void testGetLatest_With_Invalid_Version() throws Exception {
    HttpResponse response =
