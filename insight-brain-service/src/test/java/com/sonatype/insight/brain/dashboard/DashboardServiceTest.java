    ...
    extends AbstractComponentTest
{
  ...
  public void testGetPolicySummary_FilterByApplication() throws Exception {
    ...
    dto = dashboardService.getPolicySummary(Sets.newHashSet(app1.getId(), app2.getId()), null, null, null,
        null);
    assertPolicySummary(dto, 6, 0, 3, 3);
  ...
  public void testGetPolicySummary_FilterByPolicyThreatLevel() throws Exception {
    ...
    assertPolicySummary(dto, 4, 0, 3, 1);
    assertPolicySummaryWeek(dto, 0, 3, 0, 0, 3);
  }
  ...
  public void testGetPolicySummary_InitialData() throws Exception {
    ...
    PolicySummaryDTO dto = dashboardService.getPolicySummary(null, null, null, null, null);
    assertPolicySummary(dto, 6, 0, 2, 4);
    assertPolicySummaryWeek(dto, 0, 1, 0, 0, 1);
    assertPolicySummaryWeek(dto, 1, 1, 0, 1, 0);
    assertPolicySummaryWeek(dto, 2, 0, 1, 0, -1);
    assertPolicySummaryWeek(dto, 3, 0, -1, 1, 0);
    for (int iWeek = 4; iWeek < DashboardService.POLICY_SUMMARY_WEEKS - 1; iWeek++) {
      assertPolicySummaryWeek(dto, iWeek, 0, 0, 0, 0);
    }
    assertPolicySummaryWeek(dto, DashboardService.POLICY_SUMMARY_WEEKS - 1, 3, 0, 0, 3);
  }
  ...
  private void assertPolicySummary(PolicySummaryDTO actual, int totalNew, int totalWaived, int totalFixed, int currentUnresolved) {
  ...
  private void assertPolicySummaryWeek(PolicySummaryDTO actual, int week, int newCount, int waivedCount, int fixedCount,
                                       int unresolvedCount)
  {
