...
public class ThreatDropdownSelector
{
  private static final String ROOT = ".iq-threat-dropdown-selector";

  public static final int IQ_NUM_THREAT_LEVELS = 11;

  public static SelenideElement root() {
    return $(ROOT);
  }

  public static SelenideElement selectedThreatLabel() {
    return $(createSelector(ROOT, ".nx-dropdown__toggle-label"));
  }

  public static SelenideElement dropdownButton() {
  ...
  public static ElementsCollection threatLevelListItems() {
    return $$(createSelector(ROOT, ".nx-dropdown-menu .nx-dropdown-button"));
  }

  public static SelenideElement threatLevelListItem(int num) {
    return $(createSelector(ROOT, ".nx-dropdown-menu .nx-dropdown-button", nthChild(num + 1)));
  }
}
