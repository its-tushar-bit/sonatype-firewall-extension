...
import { selectEnterpriseReportingLicenseError } from 'MainRoot/productFeatures/productFeaturesSelectors';
...
function mapStateToProps(state) {
  ...
  return {
    ...
    licenseError: selectEnterpriseReportingLicenseError(state),
  };
}
