 ...
 * the default {@code ctx.restRequest()} authenticates as ADMIN (see
...
public class ApiPolicyContextOwnersResourceTest
{
  ...
  public void getTopOrgs_aiDeveloperLicenseWithoutGuideSearch_returns200() throws Exception {
    ...
    ctx.tempEntity().newOrganization("Zeta-aidev-org");
  ...
  public void getTopOrgs_withEvaluateApplicationPermission_returnsOrgs() throws Exception {
    ctx.tempEntity().newOrganization("Zeta-permission-org");
    User user = createUserWithPermissions(Permission.EVALUATE_APPLICATION);
  ...
  public void getTopOrgs_withNoPermission_returnsEmptyList() throws Exception {
    ctx.tempEntity().newOrganization("Zeta-nopermission-org");
  ...
  public void getTopOrgs_withLimit_capsResults() throws Exception {
    ctx.tempEntity().newOrganization("Zeta-limit-A");
    ctx.tempEntity().newOrganization("Zeta-limit-B");
    ctx.tempEntity().newOrganization("Zeta-limit-C");
    User user = createUserWithPermissions(Permission.EVALUATE_APPLICATION);
  ...
  public void search_withQuery_returnsMatching() throws Exception {
    Organization org = ctx.tempEntity().newOrganization("Zeta-search-Corp");
    ctx.tempEntity().newApplication("Zeta-search-Portal", "zeta-search-portal", org.getId());
  ...
  public void search_typeOrgOnly_returnsOnlyOrgs() throws Exception {
    Organization org = ctx.tempEntity().newOrganization("Zeta-typeorg-Corp");
    ctx.tempEntity().newApplication("Zeta-typeorg-Portal", "zeta-typeorg-portal", org.getId());
    User user = createUserWithPermissions(Permission.EVALUATE_APPLICATION, Permission.EVALUATE_COMPONENT);
  ...
  public void search_typeAppOnly_returnsOnlyApps() throws Exception {
    ...
    Organization org = ctx.tempEntity().newOrganization("Zeta-typeapponly-Corp");
    ctx.tempEntity().newApplication("Zeta-typeapponly-App", "zeta-typeapponly-app", org.getId());
    User user = createUserWithPermissions(Permission.EVALUATE_APPLICATION, Permission.EVALUATE_COMPONENT);
  ...
  public void getOrgApps_withEvaluateComponentPermission_returnsApps() throws Exception {
    Organization org = ctx.tempEntity().newOrganization("Zeta-orgapps-Corp");
    ctx.tempEntity().newApplication("Zeta-orgapps-A", "zeta-orgapps-a", org.getId());
    ctx.tempEntity().newApplication("Zeta-orgapps-B", "zeta-orgapps-b", org.getId());
    User user = createUserWithPermissions(Permission.EVALUATE_APPLICATION, Permission.EVALUATE_COMPONENT);
  ...
  public void getOrgApps_orgExistsButNoEvaluateAppPermission_returns404() throws Exception {
    ...
    Organization org = ctx.tempEntity().newOrganization("Zeta-hidden-Corp");
    ctx.tempEntity().newApplication("Zeta-hidden-App", "zeta-hidden-app", org.getId());
  ...
  public void resolveOwner_existingOrg_withPermission_returnsOrgSummary() throws Exception {
    Organization org = ctx.tempEntity().newOrganization("Zeta-resolve-Org");
    User user = createUserWithPermissions(Permission.EVALUATE_APPLICATION);
  ...
  public void resolveOwner_existingOrg_withoutEvaluateAppPermission_returns404() throws Exception {
    ...
    Organization org = ctx.tempEntity().newOrganization("Zeta-resolvenone-Org");
  ...
  public void resolveOwner_existingApp_byInternalId_withPermission_returnsAppSummary() throws Exception {
    Organization org = ctx.tempEntity().newOrganization("Zeta-resolveapp-Parent");
    Application app = ctx.tempEntity().newApplication("Zeta-resolveapp-App", "zeta-resolveapp-app", org.getId());
  ...
  public void resolveOwner_existingApp_byPublicId_returnsAppSummary() throws Exception {
    Organization org = ctx.tempEntity().newOrganization("Zeta-resolveapppublic-Parent");
    Application app =
        ctx.tempEntity().newApplication("Zeta-resolveapppublic-App", "zeta-resolveapppublic", org.getId());
    User user = createUserWithPermissions(Permission.EVALUATE_COMPONENT);
  ...
  public void resolveOwner_existingApp_withoutEvaluateComponentPermission_returns404() throws Exception {
    Organization org = ctx.tempEntity().newOrganization("Zeta-resolveappnone-Parent");
    Application app = ctx.tempEntity().newApplication("Zeta-resolveappnone-App", "zeta-resolveappnone", org.getId());
  ...
  public void getTopOrgs_includesAppCount() throws Exception {
    Organization org = ctx.tempEntity().newOrganization("Zeta-appcount-Org");
    ctx.tempEntity().newApplication("Zeta-appcount-1", "zeta-appcount-1", org.getId());
    ctx.tempEntity().newApplication("Zeta-appcount-2", "zeta-appcount-2", org.getId());
    User user = createUserWithPermissions(Permission.EVALUATE_APPLICATION, Permission.EVALUATE_COMPONENT);
  ...
  public void getTopOrgs_orgWithNoApps_appCountIsZero() throws Exception {
    ctx.tempEntity().newOrganization("Zeta-empty-Org");
    User user = createUserWithPermissions(Permission.EVALUATE_APPLICATION, Permission.EVALUATE_COMPONENT);
  ...
  public void resolveOwner_ancestorPath_excludesRootOrganizationAndTarget() throws Exception {
    ...
    Organization parent = ctx.tempEntity().newOrganization("Zeta-ancestor-Parent");
    Organization child = ctx.tempEntity().newOrganization("Zeta-ancestor-Child", parent);
    User user = createUserWithPermissions(Permission.EVALUATE_APPLICATION);
  ...
  public void getTopOrgs_sortedCaseInsensitive() throws Exception {
    ctx.tempEntity().newOrganization("Zeta-sort-beta");
    ctx.tempEntity().newOrganization("Zeta-sort-Alpha");
    ctx.tempEntity().newOrganization("Zeta-sort-Gamma");
    User user = createUserWithPermissions(Permission.EVALUATE_APPLICATION);
  ...
  public void getTopOrgs_appCountRespectsEvaluateComponentPermission() throws Exception {
    ...
    // appCount must be 1.
    Organization org = ctx.tempEntity().newOrganization("Zeta-partial-Org");
    Application permittedApp =
        ctx.tempEntity().newApplication("Zeta-partial-A", "zeta-partial-a", org.getId());
    ctx.tempEntity().newApplication("Zeta-partial-B", "zeta-partial-b", org.getId());

    User user = ctx.tempEntity().newUser();
    Role appEvalRole = ctx.tempEntity().newRole(false, Permission.EVALUATE_APPLICATION);
    ctx.tempEntity().newMembershipMapping(Organization.ROOT_ORGANIZATION_ID, appEvalRole.getId(), user.getUsername());
    // EVALUATE_COMPONENT scoped only to permittedApp — user cannot evaluate against the other app.
    ctx.tempEntity()
        .newMembershipMapping(permittedApp.getId(), Role.COMPONENT_EVALUATOR_ROLE_ID, user.getUsername());
  ...
  public void search_orgsExceedingLimit_setsOrgsTruncatedTrue() throws Exception {
    for (int i = 1; i <= 12; i++) {
      ctx.tempEntity().newOrganization("Zeta-trunc-Org-" + i);
    }
    User user = createUserWithPermissions(Permission.EVALUATE_APPLICATION);
  ...
  public void search_appsExceedingLimit_setsAppsTruncatedTrue() throws Exception {
    Organization org = ctx.tempEntity().newOrganization("Zeta-trunc-App-Corp");
    for (int i = 1; i <= 12; i++) {
      ctx.tempEntity().newApplication("Zeta-trunc-App-" + i, "zeta-trunc-app-" + i, org.getId());
    }
    User user = createUserWithPermissions(Permission.EVALUATE_APPLICATION, Permission.EVALUATE_COMPONENT);
  ...
  public void search_orgWithUnicodeName_matchesSubstring() throws Exception {
    ...
    ctx.tempEntity().newOrganization("Zeta-Uber-Cafe");
    ctx.tempEntity().newOrganization("Zeta-Muenchen-Org");
    User user = createUserWithPermissions(Permission.EVALUATE_APPLICATION);

    HttpResponse umlautResponse = ctx.restRequest()
        .auth(user)
        .path(SEARCH_PATH)
        .query("query", "Uber")
        .query("type", "org")
    ...
    HttpResponse munichResponse = ctx.restRequest()
        .auth(user)
        .path(SEARCH_PATH)
  ...
  public void getTopOrgs_multiOrg_batchAppCountReturnsCorrectPerOrg() throws Exception {
    ...
    Organization orgA = ctx.tempEntity().newOrganization("Zeta-batch-Alpha");
    Organization orgB = ctx.tempEntity().newOrganization("Zeta-batch-Bravo");
    Organization orgC = ctx.tempEntity().newOrganization("Zeta-batch-Charlie");
    ctx.tempEntity().newApplication("Zeta-batch-A1", "zeta-batch-a1", orgA.getId());
    ctx.tempEntity().newApplication("Zeta-batch-A2", "zeta-batch-a2", orgA.getId());
    ctx.tempEntity().newApplication("Zeta-batch-A3", "zeta-batch-a3", orgA.getId());
    ctx.tempEntity().newApplication("Zeta-batch-B1", "zeta-batch-b1", orgB.getId());
