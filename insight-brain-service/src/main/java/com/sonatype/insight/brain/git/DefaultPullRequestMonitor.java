...
public class DefaultPullRequestMonitor
    implements InsightJob, PullRequestMonitor
{
  private static final Logger log = LoggerFactory.getLogger(DefaultPullRequestMonitor.class);
  ...
  @Inject
  public DefaultPullRequestMonitor(
  ...
  public void schedulePullRequestMonitor() {
    ...
    taskScheduler.schedulePeriodicTask(DefaultPullRequestMonitor.class, TASK_NAME,
