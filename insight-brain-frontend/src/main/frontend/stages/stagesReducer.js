...
import { FETCH_STAGE_TYPES_REQUESTED, FETCH_STAGE_TYPES_FULFILLED, FETCH_STAGE_TYPES_FAILED, validPurposes }
  from './stagesActions';
...
const getShortName = ({ stageTypeId, stageName }) => stageTypeId === 'stage-release' ? 'Stage' : stageName,
    addShortName = stageType => Object.freeze({
      ...stageType,
