...
describe('testConfiguration', () => {
  ...
  function checkResults(parentList, expectedListItems) {
    expectedListItems.forEach(({ expectedIconClass, expectedText, expectedMessage }, i) => {
      ...
      expect(icon).toHaveClassName(expectedIconClass);
  ...
  describe('initial test configuration', () => {
    ...
    it('test configuration results should be rendered when button pressed', async (done) => {
      renderComponent();
  ...
  describe('success', () => {
    ...
    it('test configuration results should be ok when backend is configured with ssh inherited', async (done) => {
    ...
    it('test configuration results should be ok when backend is configured without ssh', async (done) => {
      renderComponent();
  ...
  describe('failure', () => {
    it('test configuration results should be rendered with error messages when button pressed', async (done) => {
  ...
  describe('error', () => {
    it('error message should be rendered instead of results', async (done) => {
